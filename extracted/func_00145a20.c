void func_00145a20() {
    ...
    func_001456a8();  // 1456a8                                // 0x00145a34: jal 0x1456a8
    func_001456a8();  // 1456a8                                // 0x00145a44: jal 0x1456a8
    a1 = 3;                                                     // 0x00145a48: addiu $a1, $zero, 3
    *(uint32_t*)((s0) + 0x168) = v0;                            // 0x00145a4c: sw $v0, 0x168($s0)
    func_001456a8();  // 1456a8                                // 0x00145a54: jal 0x1456a8
    ...
    func_001456a8();  // 1456a8                                // 0x00145a70: jal 0x1456a8
    a1 = 1;                                                     // 0x00145a74: addiu $a1, $zero, 1
    *(uint32_t*)((s0) + 0x16c) = v0;                            // 0x00145a78: sw $v0, 0x16c($s0)
    func_001456a8();  // 1456a8                                // 0x00145a80: jal 0x1456a8
...
label_0x145a90:
    ...
    func_001456a8();  // 1456a8                                // 0x00145a9c: jal 0x1456a8
    a1 = 1;                                                     // 0x00145aa0: addiu $a1, $zero, 1
    *(uint32_t*)((s0) + 0x174) = v0;                            // 0x00145aa4: sw $v0, 0x174($s0)
    func_001456a8();  // 1456a8                                // 0x00145aac: jal 0x1456a8
    a1 = 3;                                                     // 0x00145ab0: addiu $a1, $zero, 3
    *(uint32_t*)((s0) + 0x178) = v0;                            // 0x00145ab4: sw $v0, 0x178($s0)
label_0x145ab8:
    func_00145e00();  // 145e00                                // 0x00145ab8: jal 0x145e00
    func_00145ae8();  // 145ae8                                // 0x00145ac0: jal 0x145ae8
    ...
    func_00145818();  // 145818                                // 0x00145b6c: jal 0x145818
...
label_0x145b88:
    func_00145598();  // 145598                                // 0x00145b88: jal 0x145598
    /* nop */                                                   // 0x00145b8c: nop 
    func_001456a8();  // 1456a8                                // 0x00145b94: jal 0x1456a8
    ...
    func_00145818();  // 145818                                // 0x00145bb8: jal 0x145818
    goto label_0x145bdc;                                        // 0x00145bc0: b 0x145bdc
label_0x145bc8:
    func_00145598();  // 145598                                // 0x00145bc8: jal 0x145598
    a1 = 0x20;                                                  // 0x00145bcc: addiu $a1, $zero, 0x20
    func_00145818();  // 145818                                // 0x00145bd0: jal 0x145818
label_0x145bdc:
    func_00145478();  // 145478                                // 0x00145bdc: jal 0x145478
