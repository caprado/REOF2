...
label_0x1dda5c:
    ...
    *(uint8_t*)((gp) + -0x6200) = 0;                            // 0x001dda6c: sb $zero, -0x6200($gp)
    func_00107b68();  // 0x107ab8                                // 0x001dda70: jal 0x107ab8
...
label_0x1dda94:
    ...
    func_0010b2a0();  // 0x10b0e8                                // 0x001ddabc: jal 0x10b0e8
