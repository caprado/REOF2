void func_0015e178() {
    ...
    func_001756f8();  // 0x175660                                // 0x0015e190: jal 0x175660
    ...
    func_00178e78();  // 0x178db0                                // 0x0015e1bc: jal 0x178db0
    /* nop */                                                   // 0x0015e1c0: nop 
    if (s1 == 0) goto label_0x15e218;                           // 0x0015e1c8: beqz $s1, 0x15e218
    v0 = -1;                                                    // 0x0015e1cc: addiu $v0, $zero, -1
    func_001790b8();  // 0x178fc8                                // 0x0015e1d4: jal 0x178fc8
    ...
    /* nop */                                                   // 0x0015e1e8: nop 
label_0x15e1ec:
    func_00178ec8();  // 0x178e78                                // 0x0015e1ec: jal 0x178e78
    goto label_0x15e218;                                        // 0x0015e1f4: b 0x15e218
    v0 = -1;                                                    // 0x0015e1f8: addiu $v0, $zero, -1
    /* nop */                                                   // 0x0015e1fc: nop 
label_0x15e200:
    func_0015e260();  // 0x15e230                                // 0x0015e200: jal 0x15e230
    func_00178ec8();  // 0x178e78                                // 0x0015e20c: jal 0x178e78
label_0x15e218:
