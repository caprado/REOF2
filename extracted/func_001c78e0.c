void func_001c78e0() {
    ...
    func_001c7780();  // 0x1c7770                                // 0x001c7904: jal 0x1c7770
    ...
    func_00107b68();  // 0x107ab8                                // 0x001c792c: jal 0x107ab8
    ...
    func_001c7670();  // 0x1c75b0                                // 0x001c793c: jal 0x1c75b0
    a2 = 0x20;                                                  // 0x001c7940: addiu $a2, $zero, 0x20
    func_001c7790();  // 0x1c7780                                // 0x001c7948: jal 0x1c7780
