...
label_0x1a9ed4:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001a9ee8: jal 0x10a4d8
...
label_0x1a9ef8:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001a9f14: jal 0x10a4d8
...
label_0x1a9f24:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001a9f30: jal 0x10a4d8
...
label_0x1a9f5c:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001a9f70: jal 0x10a4d8
...
label_0x1a9f80:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001a9f98: jal 0x10a4d8
...
label_0x1aa004:
    func_001d3c20();  // 1d3c20                                // 0x001aa004: jal 0x1d3c20
...
label_0x1aa034:
    ...
    func_001aee20();  // 1aee20                                // 0x001aa03c: jal 0x1aee20
    func_001d3a30();  // 1d3a30                                // 0x001aa048: jal 0x1d3a30
...
label_0x1aa060:
    ...
    /* nop */                                                   // 0x001aa068: nop 
    func_0018db10();  // 18db10                                // 0x001aa06c: jal 0x18db10
    /* nop */                                                   // 0x001aa070: nop 
    ...
    func_001d71b0();  // 1d71b0                                // 0x001aa098: jal 0x1d71b0
    ...
    func_001d61c0();  // 1d61c0                                // 0x001aa0cc: jal 0x1d61c0
    a0 = a0 + v0;                                               // 0x001aa0d0: addu $a0, $a0, $v0
    func_0018db10();  // 18db10                                // 0x001aa0d4: jal 0x18db10
    /* nop */                                                   // 0x001aa0d8: nop 
    ...
    *(uint32_t*)((gp) + -0x60f4) = v1;                          // 0x001aa0f8: sw $v1, -0x60f4($gp)
    ...
    func_0018da10();  // 18da10                                // 0x001aa128: jal 0x18da10
...
label_0x1aa144:
    ...
    func_001d7340();  // 1d7340                                // 0x001aa164: jal 0x1d7340
    ...
    func_001d61c0();  // 1d61c0                                // 0x001aa1b4: jal 0x1d61c0
