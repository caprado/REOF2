void func_001d81c0() {
    ...
    *(uint32_t*)((s1) + 0x818) = v0;                            // 0x001d8270: sw $v0, 0x818($s1)
    ...
    func_001d4f30();  // 0x1d4db0                                // 0x001d828c: jal 0x1d4db0
    a3 = 3;                                                     // 0x001d8290: addiu $a3, $zero, 3
    goto label_0x1d82b0;                                        // 0x001d8294: b 0x1d82b0
label_0x1d829c:
    func_001aa6d0();  // 0x1aa480                                // 0x001d82a4: jal 0x1aa480
