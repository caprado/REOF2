void func_001015a0() {
    ...
    func_00116508();  // 116508                                // 0x001015d8: jal 0x116508
    a0 = &str_0021feb8;  // "call cdread cmd\n"                 // 0x001015dc: addiu $a0, $a0, -0x148
label_0x1015e0:
    func_001005b0();  // 1005b0                                // 0x001015e0: jal 0x1005b0
    ...
    func_00116d40();  // 116d40                                // 0x00101604: jal 0x116d40
...
label_0x101654:
    ...
    func_001174d8();  // 1174d8                                // 0x00101660: jal 0x1174d8
    ...
    func_00116508();  // 116508                                // 0x00101680: jal 0x116508
...
label_0x1016c8:
    ...
    func_00116c90();  // 116c90                                // 0x001016d8: jal 0x116c90
    ...
    func_001176a8();  // 1176a8                                // 0x00101708: jal 0x1176a8
...
label_0x101738:
    ...
    /* nop */                                                   // 0x00101740: nop 
    func_001013a8();  // 1013a8                                // 0x00101744: jal 0x1013a8
...
label_0x101754:
    ...
    func_00116508();  // 116508                                // 0x0010175c: jal 0x116508
