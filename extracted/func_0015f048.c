void func_0015f048() {
    ...
    func_0015fc80();  // 15fc80                                // 0x0015f054: jal 0x15fc80
...
label_0x15f080:
    ...
    /* nop */                                                   // 0x0015f084: nop 
    func_001627b8();  // 1627b8                                // 0x0015f08c: jal 0x1627b8
    *(uint32_t*)((s0) + 0x74) = 0;                              // 0x0015f094: sw $zero, 0x74($s0)
    ...
    func_0015fc80();  // 15fc80                                // 0x0015f0cc: jal 0x15fc80
    ...
    func_00163410();  // 163410                                // 0x0015f0e0: jal 0x163410
...
label_0x15f100:
    func_0015e638();  // 15e638                                // 0x0015f100: jal 0x15e638
    /* nop */                                                   // 0x0015f104: nop 
    ...
    func_00175248();  // 175248                                // 0x0015f128: jal 0x175248
    ...
    func_00164070();  // 164070                                // 0x0015f140: jal 0x164070
    goto label_0x15f15c;                                        // 0x0015f148: b 0x15f15c
label_0x15f150:
    func_00164070();  // 164070                                // 0x0015f150: jal 0x164070
label_0x15f15c:
    func_00171d88();  // 171d88                                // 0x0015f15c: jal 0x171d88
    /* beqzl $v0, 0x15f1a4 */                                   // 0x0015f164: beqzl $v0, 0x15f1a4
    a0 = s0 + 0x1ec;                                            // 0x0015f168: addiu $a0, $s0, 0x1ec
    func_0015e7b0();  // 15e7b0                                // 0x0015f16c: jal 0x15e7b0
...
label_0x15f198:
    func_00163410();  // 163410                                // 0x0015f198: jal 0x163410
    /* nop */                                                   // 0x0015f19c: nop 
    a0 = s0 + 0x1ec;                                            // 0x0015f1a0: addiu $a0, $s0, 0x1ec
    func_00162d38();  // 162d38                                // 0x0015f1a4: jal 0x162d38
