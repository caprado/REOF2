void func_001342b0() {
    ...
    func_0012c408();  // 0x12c3f0                                // 0x001342e4: jal 0x12c3f0
    ...
    func_0012d480();  // 0x12d468                                // 0x001342f4: jal 0x12d468
    a0 = *(int32_t*)((s6) + 4);                                 // 0x001342f8: lw $a0, 4($s6)
    func_001261b8();  // 0x1261a0                                // 0x001342fc: jal 0x1261a0
...
label_0x134370:
    ...
    func_00140598();  // 0x1404a0                                // 0x00134388: jal 0x1404a0
    ...
    func_00107d30();  // 0x107c70                                // 0x001343a4: jal 0x107c70
...
label_0x1343ec:
    ...
    func_001261d0();  // 0x1261b8                                // 0x001343f8: jal 0x1261b8
...
label_0x13443c:
    func_0012c408();  // 0x12c3f0                                // 0x0013443c: jal 0x12c3f0
    ...
    func_0012c3c0();  // 0x12c3a8                                // 0x0013445c: jal 0x12c3a8
    a0 = *(int32_t*)((s6) + 0xc);                               // 0x00134464: lw $a0, 0xc($s6)
    func_0012c3d8();  // 0x12c3c0                                // 0x00134468: jal 0x12c3c0
    a0 = *(int32_t*)((s6) + 0xc);                               // 0x00134470: lw $a0, 0xc($s6)
    func_0013e920();  // 0x13e918                                // 0x00134474: jal 0x13e918
