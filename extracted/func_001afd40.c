void func_001afd40() {
    ...
    func_001d3d20();  // 0x1d3cb0                                // 0x001afd4c: jal 0x1d3cb0
    ...
    /* nop */                                                   // 0x001afd60: nop 
    func_0018d530();  // 0x18d4c0                                // 0x001afd64: jal 0x18d4c0
    /* nop */                                                   // 0x001afd68: nop 
label_0x1afd70:
    func_001ba310();  // 0x1ba2a0                                // 0x001afd70: jal 0x1ba2a0
    a0 = 1;                                                     // 0x001afd74: addiu $a0, $zero, 1
    a0 = 4;                                                     // 0x001afd78: addiu $a0, $zero, 4
    func_001aeb00();  // 0x1aea70                                // 0x001afd7c: jal 0x1aea70
    a1 = 5;                                                     // 0x001afd80: addiu $a1, $zero, 5
    a0 = 0x63;                                                  // 0x001afd84: addiu $a0, $zero, 0x63
    func_001aefe0();  // 0x1aefd0                                // 0x001afd88: jal 0x1aefd0
    a1 = 1 << 16;                                               // 0x001afd8c: lui $a1, 1
    a0 = 0x6c;                                                  // 0x001afd90: addiu $a0, $zero, 0x6c
    func_001aefe0();  // 0x1aefd0                                // 0x001afd94: jal 0x1aefd0
    a0 = 1;                                                     // 0x001afd9c: addiu $a0, $zero, 1
    func_0019d450();  // 0x19d440                                // 0x001afda0: jal 0x19d440
    a1 = sp + 0x2c;                                             // 0x001afda4: addiu $a1, $sp, 0x2c
    a1 = local_2c;                                              // 0x001afda8: lw $a1, 0x2c($sp)
    func_001aefe0();  // 0x1aefd0                                // 0x001afdac: jal 0x1aefd0
    a0 = 4;                                                     // 0x001afdb0: addiu $a0, $zero, 4
    a0 = 0x22 << 16;                                            // 0x001afdb4: lui $a0, 0x22
    func_001ab530();  // 0x1ab230                                // 0x001afdb8: jal 0x1ab230
