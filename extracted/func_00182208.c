void func_00182208() {
    ...
    func_0010ab20();  // 0x10a990                                // 0x00182218: jal 0x10a990
    if (v0 == 0) goto label_0x18224c;                           // 0x00182220: beqz $v0, 0x18224c
    func_0010b4b0();  // 0x10b460                                // 0x00182228: jal 0x10b460
    a1 = 0x2f;                                                  // 0x0018222c: addiu $a1, $zero, 0x2f
    func_0010af38();  // 0x10ae00                                // 0x00182230: jal 0x10ae00
...
label_0x18224c:
    func_0010af38();  // 0x10ae00                                // 0x0018224c: jal 0x10ae00
