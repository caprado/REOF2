...
label_0x1110c0:
    ...
    func_00111f90();  // 111f90                                // 0x001110cc: jal 0x111f90
    /* nop */                                                   // 0x001110d0: nop 
    func_00111a58();  // 111a58                                // 0x001110dc: jal 0x111a58
    /* nop */                                                   // 0x001110e0: nop 
    s0 = 0xffff << 16;                                          // 0x001110e8: lui $s0, 0xffff
    func_00111a58();  // 111a58                                // 0x001110f4: jal 0x111a58
    s0 = s1 & s0;                                               // 0x001110f8: and $s0, $s1, $s0
    func_00111f90();  // 111f90                                // 0x00111108: jal 0x111f90
    a1 = 0 | 0x83e0;                                            // 0x00111110: ori $a1, $zero, 0x83e0
    if (s0 >= 0) goto label_0x11112c;                           // 0x00111118: bgez $s0, 0x11112c
    /* nop */                                                   // 0x0011111c: nop 
    func_00111998();  // 111998                                // 0x00111124: jal 0x111998
    /* nop */                                                   // 0x00111128: nop 
label_0x11112c:
    func_00111998();  // 111998                                // 0x00111134: jal 0x111998
    /* nop */                                                   // 0x00111138: nop 
    func_00112118();  // 112118                                // 0x00111140: jal 0x112118
    /* nop */                                                   // 0x00111144: nop 
