...
label_0x170f2c:
    ...
    *(uint32_t*)((s0) + 0x10) = v1;                             // 0x00170f38: sw $v1, 0x10($s0)
    /* nop */                                                   // 0x00170f3c: nop 
label_0x170f40:
    func_001706b0();  // 0x170660                                // 0x00170f44: jal 0x170660
    func_001706b0();  // 0x170660                                // 0x00170f54: jal 0x170660
...
label_0x171024:
    ...
    func_00170718();  // 0x1706b0                                // 0x00171058: jal 0x1706b0
...
label_0x171098:
    ...
    func_00170780();  // 0x170718                                // 0x001710e0: jal 0x170718
