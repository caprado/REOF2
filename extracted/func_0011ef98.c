...
label_0x11efd8:
    func_0011d378();  // 0x11d320                                // 0x0011efd8: jal 0x11d320
...
label_0x11eff4:
    ...
    /* nop */                                                   // 0x0011f000: nop 
    func_0011d390();  // 0x11d378                                // 0x0011f004: jal 0x11d378
    /* nop */                                                   // 0x0011f008: nop 
label_0x11f00c:
...
label_0x11f018:
    func_0011e5e8();  // 0x11e5a0                                // 0x0011f018: jal 0x11e5a0
    /* nop */                                                   // 0x0011f01c: nop 
    ...
    *(uint32_t*)((s0) + 4) = 0;                                 // 0x0011f038: sw $zero, 4($s0)
    ...
    func_0011d390();  // 0x11d378                                // 0x0011f044: jal 0x11d378
    /* nop */                                                   // 0x0011f048: nop 
...
label_0x11f054:
    ...
    *(uint32_t*)((s0) + 4) = s1;                                // 0x0011f060: sw $s1, 4($s0)
    func_0011ed40();  // 0x11ecc0                                // 0x0011f06c: jal 0x11ecc0
    func_0011e888();  // 0x11e838                                // 0x0011f074: jal 0x11e838
    if (s3 == 0) goto label_0x11f090;                           // 0x0011f07c: beqz $s3, 0x11f090
    v0 = s0 << 4;                                               // 0x0011f080: sll $v0, $s0, 4
    func_0011d390();  // 0x11d378                                // 0x0011f084: jal 0x11d378
    /* nop */                                                   // 0x0011f088: nop 
