void func_00168c48() {
    ...
    *(uint32_t*)(s2) = 0;                                       // 0x00168c80: sw $zero, 0($s2)
    ...
    func_00168d28();  // 0x168d00                                // 0x00168c8c: jal 0x168d00
    /* nop */                                                   // 0x00168c90: nop 
    ...
    func_00168d28();  // 0x168d00                                // 0x00168ca4: jal 0x168d00
    ...
    func_00168db0();  // 0x168d58                                // 0x00168cbc: jal 0x168d58
    if (v0 == 0) goto label_0x168ce4;                           // 0x00168ccc: beqz $v0, 0x168ce4
    func_00168e28();  // 0x168db0                                // 0x00168cd4: jal 0x168db0
    /* nop */                                                   // 0x00168cd8: nop 
