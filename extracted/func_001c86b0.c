...
label_0x1c8708:
    ...
    *(uint32_t*)(s2) = v0;                                      // 0x001c871c: sw $v0, 0($s2)
    ...
    func_001c7790();  // 0x1c7780                                // 0x001c8724: jal 0x1c7780
