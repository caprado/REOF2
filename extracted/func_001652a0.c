void func_001652a0() {
    ...
    func_00165de8();  // 165de8                                // 0x00165300: jal 0x165de8
    ...
    func_001653a8();  // 1653a8                                // 0x00165328: jal 0x1653a8
    if (v0 == 0) goto label_0x165390;                           // 0x00165330: beqz $v0, 0x165390
    func_001321b8();  // 1321b8                                // 0x00165338: jal 0x1321b8
    /* nop */                                                   // 0x0016533c: nop 
    func_00132168();  // 132168                                // 0x00165344: jal 0x132168
    *(uint32_t*)((s1) + 0x10) = v0;                             // 0x00165348: sw $v0, 0x10($s1)
    func_00132208();  // 132208                                // 0x00165350: jal 0x132208
