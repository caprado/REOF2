void func_0013af28() {
    ...
    func_0013c4a8();  // 13c4a8                                // 0x0013af44: jal 0x13c4a8
    ...
    func_0013bb40();  // 13bb40                                // 0x0013af64: jal 0x13bb40
    /* nop */                                                   // 0x0013af68: nop 
    func_00137ec8();  // 137ec8                                // 0x0013af6c: jal 0x137ec8
    a0 = 0x4200;                                                // 0x0013af70: addiu $a0, $zero, 0x4200
    func_001381d8();  // 1381d8                                // 0x0013af78: jal 0x1381d8
    a1 = 1;                                                     // 0x0013af7c: addiu $a1, $zero, 1
    a0 = 0x4201;                                                // 0x0013af80: addiu $a0, $zero, 0x4201
    func_00137ec8();  // 137ec8                                // 0x0013af84: jal 0x137ec8
    a0 = 0x4300;                                                // 0x0013af8c: addiu $a0, $zero, 0x4300
    if (s0 < 0) goto label_0x13afb4;                            // 0x0013af90: bltz $s0, 0x13afb4
    func_00137ec8();  // 137ec8                                // 0x0013af98: jal 0x137ec8
    /* nop */                                                   // 0x0013af9c: nop 
    func_00138240();  // 138240                                // 0x0013afa0: jal 0x138240
    func_00137ec8();  // 137ec8                                // 0x0013afa8: jal 0x137ec8
