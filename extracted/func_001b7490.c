void func_001b7490() {
    ...
    a0 = 0x30 << 16;                                            // 0x001b7490: lui $a0, 0x30
    a0 = a0 + 0x7d90;                                           // 0x001b7498: addiu $a0, $a0, 0x7d90
    return func_00107d30();  // Tail call                        // 0x001b749c: j 0x107c70
    a2 = 0x200;                                                 // 0x001b74a0: addiu $a2, $zero, 0x200
    /* nop */                                                   // 0x001b74a4: nop 
    /* nop */                                                   // 0x001b74a8: nop 
    /* nop */                                                   // 0x001b74ac: nop 
    sp = sp + -0x50;                                            // 0x001b74b0: addiu $sp, $sp, -0x50
    v0 = -1;                                                    // 0x001b74b4: addiu $v0, $zero, -1
    /* FPU: dpa.w.ph $ac0, $sp, $s3 */                          // 0x001b74bc: dpa.w.ph $ac0, $sp, $s3
    /* FPU: addu.qb $zero, $sp, $s1 */                          // 0x001b74c4: addu.qb $zero, $sp, $s1
    a0 = *(int8_t*)((gp) + -0x7cd4);                            // 0x001b74cc: lb $a0, -0x7cd4($gp)
    if (a0 == v0) goto label_0x1b751c;                          // 0x001b74d0: beq $a0, $v0, 0x1b751c
    /* nop */                                                   // 0x001b74d4: nop 
    func_001a8fc0();  // 0x1a8e70                                // 0x001b74d8: jal 0x1a8e70
    /* nop */                                                   // 0x001b74dc: nop 
    ...
    *(uint8_t*)((gp) + -0x7cd4) = v0;                           // 0x001b7500: sb $v0, -0x7cd4($gp)
    ...
    func_00107d30();  // 0x107c70                                // 0x001b7508: jal 0x107c70
...
label_0x1b751c:
    ...
    /* nop */                                                   // 0x001b7528: nop 
    func_001a8fc0();  // 0x1a8e70                                // 0x001b752c: jal 0x1a8e70
    /* nop */                                                   // 0x001b7530: nop 
...
label_0x1b7584:
    func_001b7a60();  // 0x1b7a50                                // 0x001b7584: jal 0x1b7a50
    /* nop */                                                   // 0x001b7588: nop 
...
label_0x1b7670:
    ...
    func_001b7a60();  // 0x1b7a50                                // 0x001b767c: jal 0x1b7a50
    /* nop */                                                   // 0x001b7680: nop 
    if (v0 != 0) goto label_0x1b769c;                           // 0x001b7684: bnez $v0, 0x1b769c
    /* nop */                                                   // 0x001b7688: nop 
    func_001af400();  // 0x1af3a0                                // 0x001b768c: jal 0x1af3a0
    /* nop */                                                   // 0x001b7690: nop 
    func_001bb890();  // 0x1bb740                                // 0x001b7694: jal 0x1bb740
    /* nop */                                                   // 0x001b7698: nop 
label_0x1b769c:
    /* FPU: ld.b $w0, -0x4e($zero) */                           // 0x001b76a4: ld.b $w0, -0x4e($zero)
    /* FPU: aver_u.h $w0, $w0, $w17 */                          // 0x001b76a8: aver_u.h $w0, $w0, $w17
    /* FPU: xori.b $w0, $w0, 0xb0 */                            // 0x001b76ac: xori.b $w0, $w0, 0xb0
