void func_001674ec() {
    ...
    func_001698d0();  // 1698d0                                // 0x00167540: jal 0x1698d0
    a1 = a1 | 0x401;                                            // 0x00167544: ori $a1, $a1, 0x401
    goto label_0x1675c4;                                        // 0x00167548: b 0x1675c4
    func_00169b88();  // 169b88                                // 0x00167550: jal 0x169b88
...
label_0x167584:
    ...
    *(uint32_t*)((s0) + 0x28) = v0;                             // 0x0016759c: sw $v0, 0x28($s0)
    func_001698d0();  // 1698d0                                // 0x001675a0: jal 0x1698d0
    /* nop */                                                   // 0x001675a4: nop 
label_0x1675ac:
    v0 = 1;                                                     // 0x001675ac: addiu $v0, $zero, 1
    func_00169ba0();  // 169ba0                                // 0x001675b4: jal 0x169ba0
