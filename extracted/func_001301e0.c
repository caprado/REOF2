void func_001301e0() {
    ...
    func_00130408();  // 0x1303a0                                // 0x001301ec: jal 0x1303a0
    func_001413a8();  // 0x141390                                // 0x001301f4: jal 0x141390
    /* nop */                                                   // 0x001301f8: nop 
...
label_0x13020c:
    *(uint8_t*)((s0) + 0x41) = 0;                               // 0x0013020c: sb $zero, 0x41($s0)
    ...
    func_00130458();  // 0x130408                                // 0x0013022c: jal 0x130408
    func_00130220();  // 0x1301e0                                // 0x00130234: jal 0x1301e0
    v0 = *(int8_t*)((s0) + 0x45);                               // 0x0013023c: lb $v0, 0x45($s0)
    /* beqzl $v0, 0x130260 */                                   // 0x00130240: beqzl $v0, 0x130260
label_0x130248:
    func_00129d80();  // 0x129ce0                                // 0x00130248: jal 0x129ce0
    /* nop */                                                   // 0x0013024c: nop 
