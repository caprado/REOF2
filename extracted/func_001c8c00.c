void func_001c8c00() {
    ...
    sp = sp + -0x10;                                            // 0x001c8c00: addiu $sp, $sp, -0x10
    at = 0x31 << 16;                                            // 0x001c8c04: lui $at, 0x31
    g_00316a80 = 0;  // Global at 0x00316a80                    // 0x001c8c0c: sb $zero, 0x6a80($at)
    at = 0x31 << 16;                                            // 0x001c8c10: lui $at, 0x31
    g_00316a88 = 0;  // Global at 0x00316a88                    // 0x001c8c14: sw $zero, 0x6a88($at)
