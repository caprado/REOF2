void func_00169058() {
    ...
    func_001790b8();  // 0x178fc8                                // 0x00169074: jal 0x178fc8
    ...
    func_00179400();  // 0x1793b0                                // 0x00169098: jal 0x1793b0
    /* nop */                                                   // 0x0016909c: nop 
...
label_0x1690b4:
    ...
    *(uint32_t*)((s1) + 8) = v1;                                // 0x001690cc: sw $v1, 8($s1)
    ...
    func_00179860();  // 0x1797f8                                // 0x001690dc: jal 0x1797f8
