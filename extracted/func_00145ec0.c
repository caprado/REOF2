void func_00145ec0() {
    ...
    *(uint32_t*)((s0) + 0x86c) = v1;                            // 0x00145ee0: sw $v1, 0x86c($s0)
    ...
    func_001456a8();  // 1456a8                                // 0x00145ee8: jal 0x1456a8
    *(uint32_t*)((s0) + 0x864) = v0;                            // 0x00145eec: sw $v0, 0x864($s0)
    func_001456a8();  // 1456a8                                // 0x00145ef4: jal 0x1456a8
    a1 = 5;                                                     // 0x00145ef8: addiu $a1, $zero, 5
    func_001456a8();  // 1456a8                                // 0x00145f00: jal 0x1456a8
    a1 = 6;                                                     // 0x00145f04: addiu $a1, $zero, 6
    func_001456a8();  // 1456a8                                // 0x00145f0c: jal 0x1456a8
    a1 = 1;                                                     // 0x00145f10: addiu $a1, $zero, 1
    func_001456a8();  // 1456a8                                // 0x00145f18: jal 0x1456a8
    a1 = 6;                                                     // 0x00145f1c: addiu $a1, $zero, 6
    func_001456a8();  // 1456a8                                // 0x00145f24: jal 0x1456a8
    a1 = 6;                                                     // 0x00145f28: addiu $a1, $zero, 6
    func_001456a8();  // 1456a8                                // 0x00145f30: jal 0x1456a8
    a1 = 1;                                                     // 0x00145f34: addiu $a1, $zero, 1
    *(uint32_t*)((s0) + 0x1bc) = v0;                            // 0x00145f38: sw $v0, 0x1bc($s0)
    func_001456a8();  // 1456a8                                // 0x00145f40: jal 0x1456a8
    ...
    *(uint32_t*)((s0) + 0x1c0) = v0;                            // 0x00145f48: sw $v0, 0x1c0($s0)
    ...
    func_001456a8();  // 1456a8                                // 0x00145f70: jal 0x1456a8
    if (v0 == 0) goto label_0x145f9c;                           // 0x00145f78: beqz $v0, 0x145f9c
    *(uint32_t*)((s0) + 0x858) = v0;                            // 0x00145f7c: sw $v0, 0x858($s0)
    func_00144f18();  // 144f18                                // 0x00145f80: jal 0x144f18
    func_00144ee8();  // 144ee8                                // 0x00145f8c: jal 0x144ee8
    a1 = 0x5000 << 16;                                          // 0x00145f90: lui $a1, 0x5000
    func_00144f18();  // 144f18                                // 0x00145f94: jal 0x144f18
label_0x145f9c:
    func_001456a8();  // 1456a8                                // 0x00145fa0: jal 0x1456a8
    ...
    *(uint32_t*)((s0) + 0x85c) = v0;                            // 0x00145fac: sw $v0, 0x85c($s0)
    func_00144f18();  // 144f18                                // 0x00145fb0: jal 0x144f18
    func_00144ee8();  // 144ee8                                // 0x00145fbc: jal 0x144ee8
    a1 = 0x5800 << 16;                                          // 0x00145fc0: lui $a1, 0x5800
    func_00144f18();  // 144f18                                // 0x00145fc4: jal 0x144f18
label_0x145fcc:
    func_001456a8();  // 1456a8                                // 0x00145fd0: jal 0x1456a8
    a1 = 1;                                                     // 0x00145fd4: addiu $a1, $zero, 1
    if (v0 == 0) goto label_0x145fec;                           // 0x00145fd8: beqz $v0, 0x145fec
    a1 = 0x22 << 16;                                            // 0x00145fdc: lui $a1, 0x22
    func_00148530();  // 148530                                // 0x00145fe4: jal 0x148530
    a1 = &str_002267a8;  // "load_chroma_non_intra_quantizer_matrix == 1" // 0x00145fe8: addiu $a1, $a1, 0x67a8
label_0x145fec:
    func_001456a8();  // 1456a8                                // 0x00145ff0: jal 0x1456a8
