void func_00137ddc() {
    ...
    func_00116598();  // 0x116508                                // 0x00137de8: jal 0x116508
    ...
    func_00116598();  // 0x116508                                // 0x00137dfc: jal 0x116508
    ...
    func_00116598();  // 0x116508                                // 0x00137e14: jal 0x116508
    ...
    func_00116598();  // 0x116508                                // 0x00137e2c: jal 0x116508
    ...
    func_00116598();  // 0x116508                                // 0x00137e4c: jal 0x116508
    /* nop */                                                   // 0x00137e50: nop 
...
label_0x137e58:
    ...
    func_00116598();  // 0x116508                                // 0x00137e70: jal 0x116508
    a0 = &str_00224f08;  // " Read Status(DVD=2/HST=1) = %d\n"  // 0x00137e74: addiu $a0, $a0, 0x4f08
label_0x137e78:
    func_00137dd8();  // 0x137d88                                // 0x00137e78: jal 0x137d88
    /* nop */                                                   // 0x00137e7c: nop 
    a0 = 0x22 << 16;                                            // 0x00137e80: lui $a0, 0x22
    func_00116598();  // 0x116508                                // 0x00137e88: jal 0x116508
