/** @category io/filesystem @status complete @author caprado */
void func_001a8dd0() {
    ...
    func_0010ac68();  // 10ac68                                // 0x001a8dec: jal 0x10ac68
label_0x1a8df4:
    a0 = sp + 0x30;                                             // 0x001a8df4: addiu $a0, $sp, 0x30
    func_00128d88();  // 128d88                                // 0x001a8df8: jal 0x128d88
    /* nop */                                                   // 0x001a8e04: nop 
    if (v0 == 0) goto label_0x1a8df4;                           // 0x001a8e08: beqz $v0, 0x1a8df4
    /* nop */                                                   // 0x001a8e0c: nop 
    func_001298c8();  // 1298c8                                // 0x001a8e10: jal 0x1298c8
    func_00129460();  // 129460                                // 0x001a8e20: jal 0x129460
label_0x1a8e28:
    func_00129a08();  // 129a08                                // 0x001a8e28: jal 0x129a08
    v1 = 3;                                                     // 0x001a8e30: addiu $v1, $zero, 3
    /* nop */                                                   // 0x001a8e34: nop 
    /* nop */                                                   // 0x001a8e38: nop 
    if (v0 != v1) goto label_0x1a8e28;                          // 0x001a8e3c: bne $v0, $v1, 0x1a8e28
    /* nop */                                                   // 0x001a8e40: nop 
    func_00129010();  // 129010                                // 0x001a8e44: jal 0x129010
