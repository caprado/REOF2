...
label_0x162290:
    ...
    func_0015fc80();  // 15fc80                                // 0x0016229c: jal 0x15fc80
...
label_0x1622c8:
    func_001627b8();  // 1627b8                                // 0x001622c8: jal 0x1627b8
    /* nop */                                                   // 0x001622cc: nop 
    func_0015ef30();  // 15ef30                                // 0x001622d4: jal 0x15ef30
    a1 = *(int32_t*)((s0) + 0x12c);                             // 0x001622d8: lw $a1, 0x12c($s0)
    func_0015f270();  // 15f270                                // 0x001622dc: jal 0x15f270
    func_0013cbd0();  // 13cbd0                                // 0x001622e4: jal 0x13cbd0
...
label_0x162308:
    ...
    func_0015fc80();  // 15fc80                                // 0x00162334: jal 0x15fc80
...
label_0x162360:
    ...
    func_0015fc80();  // 15fc80                                // 0x0016238c: jal 0x15fc80
...
label_0x1623d8:
    func_0013cc38();  // 13cc38                                // 0x001623d8: jal 0x13cc38
    a0 = *(int32_t*)((s0) + 0x4c);                              // 0x001623dc: lw $a0, 0x4c($s0)
    func_001621d0();  // 1621d0                                // 0x001623e4: jal 0x1621d0
    func_00162320();  // 162320                                // 0x001623f0: jal 0x162320
    ...
    func_0015fc80();  // 15fc80                                // 0x0016241c: jal 0x15fc80
...
label_0x162448:
    func_00162320();  // 162320                                // 0x00162448: jal 0x162320
    /* nop */                                                   // 0x0016244c: nop 
...
label_0x162468:
    ...
    func_0015fc80();  // 15fc80                                // 0x00162474: jal 0x15fc80
...
label_0x1624a0:
    ...
    func_0015fc80();  // 15fc80                                // 0x001624e4: jal 0x15fc80
    ...
    func_00163410();  // 163410                                // 0x00162508: jal 0x163410
