void func_0013bb40() {
    ...
    *(uint8_t*)(s1) = 0;                                        // 0x0013bb60: sb $zero, 0($s1)
    ...
    func_0010ac68();  // 10ac68                                // 0x0013bb70: jal 0x10ac68
    a1 = a1 + 0x45b0;                                           // 0x0013bb74: addiu $a1, $a1, 0x45b0
label_0x13bb78:
    func_0013bae8();  // 13bae8                                // 0x0013bb78: jal 0x13bae8
    ...
    func_0010a860();  // 10a860                                // 0x0013bb98: jal 0x10a860
    func_0010ae00();  // 10ae00                                // 0x0013bba0: jal 0x10ae00
    ...
    func_0010a860();  // 10a860                                // 0x0013bbe4: jal 0x10a860
    a1 = a1 + 0x59d0;                                           // 0x0013bbe8: addiu $a1, $a1, 0x59d0
label_0x13bbec:
label_0x13bbf0:
    func_0010a860();  // 10a860                                // 0x0013bbf0: jal 0x10a860
    func_0010ae00();  // 10ae00                                // 0x0013bbf8: jal 0x10ae00
