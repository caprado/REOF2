void func_001c64f0() {
    ...
    func_001c1980();  // 1c1980                                // 0x001c6510: jal 0x1c1980
    /* nop */                                                   // 0x001c6514: nop 
    func_001b4fd0();  // 1b4fd0                                // 0x001c651c: jal 0x1b4fd0
    ...
    func_001b5090();  // 1b5090                                // 0x001c653c: jal 0x1b5090
...
label_0x1c654c:
    func_001b5090();  // 1b5090                                // 0x001c654c: jal 0x1b5090
...
label_0x1c6574:
    func_001b5050();  // 1b5050                                // 0x001c6574: jal 0x1b5050
    a0 = v0 | 0x8080;                                           // 0x001c6578: ori $a0, $v0, 0x8080
    a0 = *(int32_t*)((s1) + 0x10);                              // 0x001c657c: lw $a0, 0x10($s1)
label_0x1c6580:
    func_001b5090();  // 1b5090                                // 0x001c6580: jal 0x1b5090
    /* nop */                                                   // 0x001c6584: nop 
    ...
    func_001b5090();  // 1b5090                                // 0x001c6594: jal 0x1b5090
...
label_0x1c65cc:
    func_001b5090();  // 1b5090                                // 0x001c65cc: jal 0x1b5090
    /* nop */                                                   // 0x001c65d0: nop 
label_0x1c65d4:
