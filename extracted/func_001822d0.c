void func_001822d0() {
    ...
    func_0010a990();  // 10a990                                // 0x001822e0: jal 0x10a990
    if (v0 == 0) goto label_0x182328;                           // 0x001822e8: beqz $v0, 0x182328
    func_0010b460();  // 10b460                                // 0x001822f0: jal 0x10b460
    ...
    func_0010b460();  // 10b460                                // 0x0018230c: jal 0x10b460
    a1 = 0x2f;                                                  // 0x00182310: addiu $a1, $zero, 0x2f
    a1 = v0 + 1;                                                // 0x00182314: addiu $a1, $v0, 1
    func_0010ac68();  // 10ac68                                // 0x00182318: jal 0x10ac68
...
label_0x182328:
    ...
    func_0010ac68();  // 10ac68                                // 0x0018233c: jal 0x10ac68
    a1 = 0x23 << 16;                                            // 0x00182344: lui $a1, 0x23
label_0x182348:
    func_0010ab20();  // 10ab20                                // 0x0018234c: jal 0x10ab20
    ...
    func_0010ab20();  // 10ab20                                // 0x00182360: jal 0x10ab20
