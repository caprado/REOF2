...
label_0x16949c:
    func_001695d8();  // 1695d8                                // 0x0016949c: jal 0x1695d8
    /* nop */                                                   // 0x001694a0: nop 
    *(uint32_t*)((s0) + 0x10) = v0;                             // 0x001694a8: sw $v0, 0x10($s0)
    func_00179128();  // 179128                                // 0x001694b0: jal 0x179128
