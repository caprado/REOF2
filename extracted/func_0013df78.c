void func_0013df78() {
    ...
    func_00140b98();  // 0x140b48                                // 0x0013dfc4: jal 0x140b48
    s0 = s0 + -0x5b78;                                          // 0x0013dfc8: addiu $s0, $s0, -0x5b78
    func_001410d8();  // 0x140f40                                // 0x0013dfcc: jal 0x140f40
    s1 = s3 + 0x7a74;                                           // 0x0013dfd0: addiu $s1, $s3, 0x7a74
    func_001390a8();  // 0x138fb8                                // 0x0013dfd4: jal 0x138fb8
    s4 = 0x21 << 16;                                            // 0x0013dfd8: lui $s4, 0x21
    func_0013e280();  // 0x13e258                                // 0x0013dfdc: jal 0x13e258
    s2 = 0x20 << 16;                                            // 0x0013dfe0: lui $s2, 0x20
    func_0013db00();  // 0x13d808                                // 0x0013dfe4: jal 0x13d808
    /* nop */                                                   // 0x0013dfe8: nop 
    func_00107d30();  // 0x107c70                                // 0x0013dff4: jal 0x107c70
    ...
    func_0011b5e0();  // 0x11b570                                // 0x0013e01c: jal 0x11b570
    ...
    func_00116598();  // 0x116508                                // 0x0013e034: jal 0x116508
...
label_0x13e060:
    ...
    func_00116598();  // 0x116508                                // 0x0013e070: jal 0x116508
    ...
    func_00138dd0();  // 0x138c38                                // 0x0013e0a0: jal 0x138c38
    ...
    func_00116598();  // 0x116508                                // 0x0013e0b4: jal 0x116508
...
label_0x13e0e0:
    ...
    func_00138e48();  // 0x138e38                                // 0x0013e0f4: jal 0x138e38
    ...
    func_00138e58();  // 0x138e48                                // 0x0013e10c: jal 0x138e48
    ...
    func_0011b5e0();  // 0x11b570                                // 0x0013e144: jal 0x11b570
    ...
    func_00116598();  // 0x116508                                // 0x0013e15c: jal 0x116508
...
label_0x13e188:
    ...
    func_00116598();  // 0x116508                                // 0x0013e190: jal 0x116508
...
label_0x13e1a8:
    ...
    func_00139228();  // 0x139120                                // 0x0013e1e0: jal 0x139120
