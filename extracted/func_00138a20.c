void func_00138a20() {
    ...
    /* nop */                                                   // 0x00138a2c: nop 
    func_001178e0();  // 1178e0                                // 0x00138a34: jal 0x1178e0
    ReferThreadStatus();  // 0x1141d0                           // 0x00138a3c: jal 0x1141d0
    /* nop */                                                   // 0x00138a40: nop 
    a0 = sp + 0x20;                                             // 0x00138a44: addiu $a0, $sp, 0x20
    func_001178e0();  // 1178e0                                // 0x00138a48: jal 0x1178e0
    ...
    func_00117978();  // 117978                                // 0x00138a78: jal 0x117978
    ...
    func_00117d90();  // 117d90                                // 0x00138a90: jal 0x117d90
