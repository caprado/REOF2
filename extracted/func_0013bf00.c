void func_0013bf00() {
    ...
    func_00107d30();  // 0x107c70                                // 0x0013bf28: jal 0x107c70
    func_0013bc58();  // 0x13bb40                                // 0x0013bf34: jal 0x13bb40
    func_00137fb0();  // 0x137ec8                                // 0x0013bf3c: jal 0x137ec8
    a0 = 0x6000;                                                // 0x0013bf40: addiu $a0, $zero, 0x6000
    a1 = 1;                                                     // 0x0013bf44: addiu $a1, $zero, 1
    func_00138240();  // 0x1381d8                                // 0x0013bf48: jal 0x1381d8
    a0 = 0x6001;                                                // 0x0013bf50: addiu $a0, $zero, 0x6001
    func_00137fb0();  // 0x137ec8                                // 0x0013bf54: jal 0x137ec8
    a0 = 0x6100;                                                // 0x0013bf5c: addiu $a0, $zero, 0x6100
    if (s2 < 0) goto label_0x13c044;                            // 0x0013bf60: bltz $s2, 0x13c044
    func_00137fb0();  // 0x137ec8                                // 0x0013bf68: jal 0x137ec8
    /* nop */                                                   // 0x0013bf6c: nop 
    func_00138160();  // 0x1380a8                                // 0x0013bf78: jal 0x1380a8
    a2 = 2;                                                     // 0x0013bf7c: addiu $a2, $zero, 2
    a0 = 0x6101;                                                // 0x0013bf80: addiu $a0, $zero, 0x6101
    func_00137fb0();  // 0x137ec8                                // 0x0013bf84: jal 0x137ec8
    a0 = 0x6200;                                                // 0x0013bf8c: addiu $a0, $zero, 0x6200
    if (s1 < 0) goto label_0x13c044;                            // 0x0013bf90: bltz $s1, 0x13c044
    func_00137fb0();  // 0x137ec8                                // 0x0013bf98: jal 0x137ec8
    /* nop */                                                   // 0x0013bf9c: nop 
    func_00138160();  // 0x1380a8                                // 0x0013bfa8: jal 0x1380a8
    func_00137fb0();  // 0x137ec8                                // 0x0013bfb8: jal 0x137ec8
    ...
    func_00137fb0();  // 0x137ec8                                // 0x0013bfd8: jal 0x137ec8
    /* nop */                                                   // 0x0013bfdc: nop 
    func_00138310();  // 0x138298                                // 0x0013bfec: jal 0x138298
    a0 = 0x6301;                                                // 0x0013bff4: addiu $a0, $zero, 0x6301
    func_00137fb0();  // 0x137ec8                                // 0x0013bff8: jal 0x137ec8
    if (s0 >= 0) goto label_0x13c028;                           // 0x0013c000: bgez $s0, 0x13c028
    a0 = 0x6500;                                                // 0x0013c004: addiu $a0, $zero, 0x6500
    func_00137fb0();  // 0x137ec8                                // 0x0013c008: jal 0x137ec8
    /* nop */                                                   // 0x0013c00c: nop 
    func_00138298();  // 0x138240                                // 0x0013c010: jal 0x138240
    func_00137fb0();  // 0x137ec8                                // 0x0013c018: jal 0x137ec8
    a0 = 0x6501;                                                // 0x0013c01c: addiu $a0, $zero, 0x6501
    goto label_0x13c044;                                        // 0x0013c020: b 0x13c044
label_0x13c028:
    func_00137fb0();  // 0x137ec8                                // 0x0013c028: jal 0x137ec8
    a0 = 0x6400;                                                // 0x0013c02c: addiu $a0, $zero, 0x6400
    func_00138298();  // 0x138240                                // 0x0013c030: jal 0x138240
    func_00137fb0();  // 0x137ec8                                // 0x0013c038: jal 0x137ec8
