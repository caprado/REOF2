void func_00168098() {
    ...
    func_00168238();  // 0x168150                                // 0x001680b8: jal 0x168150
...
label_0x1680f8:
    ...
    *(uint32_t*)((s0) + 4) = v0;                                // 0x00168108: sw $v0, 4($s0)
    func_00168388();  // 0x1682d0                                // 0x0016810c: jal 0x1682d0
    func_001684e0();  // 0x1683d8                                // 0x0016811c: jal 0x1683d8
    func_00168c08();  // 0x168a80                                // 0x0016812c: jal 0x168a80
