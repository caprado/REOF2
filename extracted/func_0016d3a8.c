void func_0016d3a8() {
    ...
    func_001591a0();  // 1591a0                                // 0x0016d3fc: jal 0x1591a0
    a2 = 1;                                                     // 0x0016d408: addiu $a2, $zero, 1
    func_0013fca8();  // 13fca8                                // 0x0016d40c: jal 0x13fca8
    func_001591e0();  // 1591e0                                // 0x0016d41c: jal 0x1591e0
    a2 = 1;                                                     // 0x0016d42c: addiu $a2, $zero, 1
    func_0013fca8();  // 13fca8                                // 0x0016d430: jal 0x13fca8
    s0 = v0 - s2;                                               // 0x0016d438: subu $s0, $v0, $s2
    a3 = 0xff00 << 16;                                          // 0x0016d43c: lui $a3, 0xff00
    func_0016d308();  // 16d308                                // 0x0016d44c: jal 0x16d308
    a3 = a3 | 0xf04;                                            // 0x0016d450: ori $a3, $a3, 0xf04
    func_0016d288();  // 16d288                                // 0x0016d45c: jal 0x16d288
    a2 = s3 + 0x94c;                                            // 0x0016d46c: addiu $a2, $s3, 0x94c
    if (s1 != 0) goto label_0x16d530;                           // 0x0016d470: bnez $s1, 0x16d530
    func_001591b8();  // 1591b8                                // 0x0016d478: jal 0x1591b8
    /* nop */                                                   // 0x0016d47c: nop 
    func_00158ea8();  // 158ea8                                // 0x0016d484: jal 0x158ea8
    ...
    func_001698d0();  // 1698d0                                // 0x0016d4a4: jal 0x1698d0
    /* nop */                                                   // 0x0016d4a8: nop 
...
label_0x16d4dc:
    ...
    func_0016d560();  // 16d560                                // 0x0016d4e0: jal 0x16d560
    if (fp == 0) goto label_0x16d530;                           // 0x0016d4f0: beqz $fp, 0x16d530
    a3 = *(int32_t*)((s3) + 0xe4);                              // 0x0016d4f8: lw $a3, 0xe4($s3)
    func_0016d7e0();  // 16d7e0                                // 0x0016d4fc: jal 0x16d7e0
    a2 = local_0;                                               // 0x0016d500: lw $a2, 0($sp)
    func_0016dcf8();  // 16dcf8                                // 0x0016d508: jal 0x16dcf8
    func_0016dda0();  // 16dda0                                // 0x0016d514: jal 0x16dda0
    func_0016def0();  // 16def0                                // 0x0016d528: jal 0x16def0
label_0x16d530:
label_0x16d534:
