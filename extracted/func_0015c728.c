void func_0015c728() {
    ...
    func_00174ff8();  // 174ff8                                // 0x0015c758: jal 0x174ff8
    a1 = 1;                                                     // 0x0015c764: addiu $a1, $zero, 1
    func_00174ff8();  // 174ff8                                // 0x0015c768: jal 0x174ff8
    a2 = 1;                                                     // 0x0015c76c: addiu $a2, $zero, 1
    func_00174ff8();  // 174ff8                                // 0x0015c778: jal 0x174ff8
    a2 = 4;                                                     // 0x0015c784: addiu $a2, $zero, 4
    func_00174ff8();  // 174ff8                                // 0x0015c788: jal 0x174ff8
    ...
    func_00111f90();  // 111f90                                // 0x0015c7a0: jal 0x111f90
    a0 = a0 << 3;                                               // 0x0015c7a4: sll $a0, $a0, 3
    a1 = 0 | 0xff80;                                            // 0x0015c7a8: ori $a1, $zero, 0xff80
    func_00111998();  // 111998                                // 0x0015c7b0: jal 0x111998
    func_00112048();  // 112048                                // 0x0015c7bc: jal 0x112048
    func_00111f90();  // 111f90                                // 0x0015c7cc: jal 0x111f90
    func_00111f40();  // 111f40                                // 0x0015c7dc: jal 0x111f40
    ...
    func_00174ff8();  // 174ff8                                // 0x0015c7f4: jal 0x174ff8
    func_00174ff8();  // 174ff8                                // 0x0015c804: jal 0x174ff8
    a1 = 0x2c;                                                  // 0x0015c808: addiu $a1, $zero, 0x2c
    func_00174ff8();  // 174ff8                                // 0x0015c814: jal 0x174ff8
    a1 = 0x2a;                                                  // 0x0015c818: addiu $a1, $zero, 0x2a
    a1 = 0xf;                                                   // 0x0015c820: addiu $a1, $zero, 0xf
    func_00174ff8();  // 174ff8                                // 0x0015c824: jal 0x174ff8
    a2 = 2;                                                     // 0x0015c828: addiu $a2, $zero, 2
    a1 = 0x33;                                                  // 0x0015c830: addiu $a1, $zero, 0x33
    func_00174ff8();  // 174ff8                                // 0x0015c834: jal 0x174ff8
    a1 = 0xe;                                                   // 0x0015c840: addiu $a1, $zero, 0xe
    func_00174ff8();  // 174ff8                                // 0x0015c844: jal 0x174ff8
    a1 = 0x1c;                                                  // 0x0015c850: addiu $a1, $zero, 0x1c
    func_00174ff8();  // 174ff8                                // 0x0015c854: jal 0x174ff8
    ...
    func_001737e8();  // 1737e8                                // 0x0015c8a0: jal 0x1737e8
...
label_0x15c8c8:
    func_00169980();  // 169980                                // 0x0015c8c8: jal 0x169980
    /* nop */                                                   // 0x0015c8cc: nop 
    if (v0 == 0) goto label_0x15c8f8;                           // 0x0015c8d0: beqz $v0, 0x15c8f8
    /* nop */                                                   // 0x0015c8d4: nop 
    func_0015e7b0();  // 15e7b0                                // 0x0015c8d8: jal 0x15e7b0
...
label_0x15c8e8:
    func_00163410();  // 163410                                // 0x0015c8e8: jal 0x163410
    /* nop */                                                   // 0x0015c8ec: nop 
    goto label_0x15c904;                                        // 0x0015c8f0: b 0x15c904
    v0 = -1;                                                    // 0x0015c8f4: addiu $v0, $zero, -1
label_0x15c8f8:
    func_0015c580();  // 15c580                                // 0x0015c8f8: jal 0x15c580
label_0x15c904:
