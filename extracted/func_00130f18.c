void func_00130f18() {
    ...
    func_0013aab0();  // 13aab0                                // 0x00130f38: jal 0x13aab0
    ...
    /* nop */                                                   // 0x00130f54: nop 
label_0x130f58:
    func_0013aab0();  // 13aab0                                // 0x00130f60: jal 0x13aab0
    ...
    func_00136740();  // 136740                                // 0x00131018: jal 0x136740
    ...
    func_001350b8();  // 1350b8                                // 0x00131030: jal 0x1350b8
    func_001353f0();  // 1353f0                                // 0x00131038: jal 0x1353f0
    if (s1 == 0) goto label_0x1310b8;                           // 0x00131040: beqz $s1, 0x1310b8
    func_0013c6a8();  // 13c6a8                                // 0x00131048: jal 0x13c6a8
    a0 = *(int32_t*)((s1) + 4);                                 // 0x0013104c: lw $a0, 4($s1)
    func_0013c6d8();  // 13c6d8                                // 0x00131050: jal 0x13c6d8
    ...
    func_0013abc0();  // 13abc0                                // 0x00131064: jal 0x13abc0
    goto label_0x131084;                                        // 0x0013106c: b 0x131084
    v0 = *(int32_t*)((s1) + 0xc);                               // 0x00131070: lw $v0, 0xc($s1)
    /* nop */                                                   // 0x00131074: nop 
label_0x131078:
    func_0013abc0();  // 13abc0                                // 0x00131078: jal 0x13abc0
    /* nop */                                                   // 0x0013107c: nop 
...
label_0x1310a0:
    ...
    /* nop */                                                   // 0x001310b4: nop 
label_0x1310b8:
    func_0013c6a8();  // 13c6a8                                // 0x001310b8: jal 0x13c6a8
    /* nop */                                                   // 0x001310bc: nop 
    func_0013c6d8();  // 13c6d8                                // 0x001310c0: jal 0x13c6d8
    func_0013abc0();  // 13abc0                                // 0x001310c8: jal 0x13abc0
