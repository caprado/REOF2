...
label_0x193844:
    ...
    *(float*)((v1) + 0x104) = FPU_F0;  // Store float           // 0x0019385c: swc1 $f0, 0x104($v1)
    ...
    func_00193810();  // 193810                                // 0x001938b8: jal 0x193810
...
label_0x1938c0:
    ...
    func_00193810();  // 193810                                // 0x001938d4: jal 0x193810
