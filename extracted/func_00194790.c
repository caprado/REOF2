...
label_0x1947bc:
    ...
    func_001899f8();  // 1899f8                                // 0x001947c8: jal 0x1899f8
    ...
    func_00198870();  // 198870                                // 0x00194818: jal 0x198870
    ...
    func_001988b0();  // 1988b0                                // 0x00194840: jal 0x1988b0
    a0 = *(int16_t*)(s1);                                       // 0x00194844: lh $a0, 0($s1)
    a0 = *(int16_t*)((s1) + 2);                                 // 0x00194848: lh $a0, 2($s1)
    func_001988d0();  // 1988d0                                // 0x00194850: jal 0x1988d0
...
label_0x1948d4:
    ...
    func_00198870();  // 198870                                // 0x001948f0: jal 0x198870
    ...
    func_001988b0();  // 1988b0                                // 0x00194918: jal 0x1988b0
    a0 = *(int16_t*)((s1) + 4);                                 // 0x0019491c: lh $a0, 4($s1)
    a0 = *(int16_t*)((s1) + 6);                                 // 0x00194920: lh $a0, 6($s1)
    func_001988d0();  // 1988d0                                // 0x00194928: jal 0x1988d0
...
label_0x1949ac:
    ...
    func_00198870();  // 198870                                // 0x001949c8: jal 0x198870
    ...
    func_001988b0();  // 1988b0                                // 0x001949f0: jal 0x1988b0
    a0 = *(int16_t*)((s1) + 8);                                 // 0x001949f4: lh $a0, 8($s1)
    a0 = *(int16_t*)((s1) + 0xa);                               // 0x001949f8: lh $a0, 0xa($s1)
    func_001988d0();  // 1988d0                                // 0x00194a00: jal 0x1988d0
...
label_0x194a84:
    ...
    func_00193e90();  // 193e90                                // 0x00194a98: jal 0x193e90
