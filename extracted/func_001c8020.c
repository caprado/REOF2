void func_001c8020() {
    ...
    func_001c7770();  // 1c7770                                // 0x001c8030: jal 0x1c7770
    ...
    func_00107c70();  // 107c70                                // 0x001c806c: jal 0x107c70
    ...
    func_0010ac68();  // 10ac68                                // 0x001c80c4: jal 0x10ac68
    ...
    func_001c75b0();  // 1c75b0                                // 0x001c80fc: jal 0x1c75b0
    g_003169a8 = v0;  // Global at 0x003169a8                   // 0x001c8100: sh $v0, 0x30c($s0)
    func_001c7780();  // 1c7780                                // 0x001c8108: jal 0x1c7780
