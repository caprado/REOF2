void func_001773a0() {
    ...
    func_00177710();  // 177710                                // 0x001773c4: jal 0x177710
    func_001774c0();  // 1774c0                                // 0x001773d0: jal 0x1774c0
...
label_0x1773e0:
    ...
    func_00177710();  // 177710                                // 0x001773ec: jal 0x177710
    func_001775b0();  // 1775b0                                // 0x001773f8: jal 0x1775b0
    a1 = 6;                                                     // 0x00177404: addiu $a1, $zero, 6
    func_00175120();  // 175120                                // 0x00177408: jal 0x175120
...
label_0x177418:
    ...
    func_00177710();  // 177710                                // 0x00177424: jal 0x177710
    func_00177650();  // 177650                                // 0x00177430: jal 0x177650
    a1 = 5;                                                     // 0x0017743c: addiu $a1, $zero, 5
    func_00175120();  // 175120                                // 0x00177440: jal 0x175120
...
label_0x177450:
    ...
    func_00177710();  // 177710                                // 0x0017745c: jal 0x177710
    func_001776f0();  // 1776f0                                // 0x00177468: jal 0x1776f0
    a1 = 6;                                                     // 0x00177474: addiu $a1, $zero, 6
    func_00175120();  // 175120                                // 0x00177478: jal 0x175120
    a1 = 5;                                                     // 0x00177484: addiu $a1, $zero, 5
    func_00175120();  // 175120                                // 0x00177488: jal 0x175120
