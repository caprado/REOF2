void func_0019ceb0() {
    ...
    func_001a0760();  // 1a0760                                // 0x0019cef4: jal 0x1a0760
...
label_0x19cf04:
    ...
    func_001a0760();  // 1a0760                                // 0x0019cf30: jal 0x1a0760
...
label_0x19cf90:
    ...
    *(uint8_t*)((s0) + 0x34) = v0;                              // 0x0019cfa0: sb $v0, 0x34($s0)
    func_0019d7e0();  // 19d7e0                                // 0x0019cfa4: jal 0x19d7e0
    a0 = *(int16_t*)((s0) + 0x1a);                              // 0x0019cfa8: lh $a0, 0x1a($s0)
    *(uint16_t*)((s0) + 0x16) = v0;                             // 0x0019cfac: sh $v0, 0x16($s0)
    func_0019d7e0();  // 19d7e0                                // 0x0019cfb0: jal 0x19d7e0
    ...
    *(uint8_t*)((s0) + 0x37) = 0;                               // 0x0019cfd0: sb $zero, 0x37($s0)
    func_0019d9f0();  // 19d9f0                                // 0x0019cfd4: jal 0x19d9f0
    ...
    *(uint16_t*)((s0) + 0x12) = v0;                             // 0x0019cfe4: sh $v0, 0x12($s0)
    ...
    func_0019d830();  // 19d830                                // 0x0019cff4: jal 0x19d830
