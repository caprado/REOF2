...
label_0x1a9840:
    ...
    /* nop */                                                   // 0x001a9848: nop 
    func_001af5c0();  // 0x1af560                                // 0x001a984c: jal 0x1af560
    /* nop */                                                   // 0x001a9850: nop 
label_0x1a9854:
    a0 = *(int32_t*)((gp) + -0x63e4);                           // 0x001a9854: lw $a0, -0x63e4($gp)
label_0x1a9858:
    func_00129a38();  // 0x129a08                                // 0x001a9858: jal 0x129a08
    /* nop */                                                   // 0x001a985c: nop 
    v1 = 3;                                                     // 0x001a9860: addiu $v1, $zero, 3
    if (v0 != v1) goto label_0x1a9840;                          // 0x001a9864: bne $v0, $v1, 0x1a9840
    /* nop */                                                   // 0x001a9868: nop 
    func_001290c8();  // 0x129010                                // 0x001a986c: jal 0x129010
