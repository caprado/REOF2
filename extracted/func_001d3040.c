...
label_0x1d3064:
    func_001d3040();  // 0x1d2ff0                                // 0x001d3068: jal 0x1d2ff0
    a1 = 4;                                                     // 0x001d306c: addiu $a1, $zero, 4
    a0 = t1 + 4;                                                // 0x001d3070: addiu $a0, $t1, 4
    func_001d3040();  // 0x1d2ff0                                // 0x001d3074: jal 0x1d2ff0
    t1 = t0 + v0;                                               // 0x001d3078: addu $t1, $t0, $v0
    t0 = t0 + v0;                                               // 0x001d307c: addu $t0, $t0, $v0
    func_001d2ff0();  // 0x1d2fa0                                // 0x001d3088: jal 0x1d2fa0
    a2 = 5;                                                     // 0x001d308c: addiu $a2, $zero, 5
    func_001d2ff0();  // 0x1d2fa0                                // 0x001d3094: jal 0x1d2fa0
