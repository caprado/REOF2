...
label_0x15b7f0:
    func_00112048();  // 0x111f90                                // 0x0015b7f0: jal 0x111f90
    /* nop */                                                   // 0x0015b7f4: nop 
    func_00112048();  // 0x111f90                                // 0x0015b7fc: jal 0x111f90
    func_00111ce0();  // 0x111a58                                // 0x0015b808: jal 0x111a58
    func_00112048();  // 0x111f90                                // 0x0015b814: jal 0x111f90
    func_00111e20();  // 0x111ce0                                // 0x0015b820: jal 0x111ce0
    a1 = 0 | 0xff80;                                            // 0x0015b828: ori $a1, $zero, 0xff80
    func_001119f0();  // 0x111998                                // 0x0015b830: jal 0x111998
    func_00121e00();  // 0x121be8                                // 0x0015b838: jal 0x121be8
    func_001120e8();  // 0x112048                                // 0x0015b840: jal 0x112048
label_0x15b848:
