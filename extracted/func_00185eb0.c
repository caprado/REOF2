void func_00185eb0() {
    ...
    func_00184048();  // 0x183fa0                                // 0x00185ecc: jal 0x183fa0
    ...
    func_001840a8();  // 0x184048                                // 0x00185eec: jal 0x184048
    ...
    func_00184770();  // 0x184320                                // 0x00185f10: jal 0x184320
    ...
    func_0010ae00();  // 0x10ac68                                // 0x00185f54: jal 0x10ac68
    a1 = 0x23 << 16;                                            // 0x00185f5c: lui $a1, 0x23
    func_0010a990();  // 0x10a860                                // 0x00185f64: jal 0x10a860
    a1 = a1 + -0x6030;                                          // 0x00185f68: addiu $a1, $a1, -0x6030
    a3 = -1;                                                    // 0x00185f78: addiu $a3, $zero, -1
    func_00186728();  // 0x186208                                // 0x00185f80: jal 0x186208
...
label_0x186008:
    ...
    func_00182d68();  // 0x182c38                                // 0x00186010: jal 0x182c38
...
label_0x18603c:
    func_00182bd0();  // 0x182b88                                // 0x00186048: jal 0x182b88
...
label_0x186078:
    func_00182a70();  // 0x1829e0                                // 0x00186078: jal 0x1829e0
    if (v0 == 0) goto label_0x186098;                           // 0x00186080: beqz $v0, 0x186098
    /* nop */                                                   // 0x00186084: nop 
    func_00186eb8();  // 0x186e48                                // 0x00186088: jal 0x186e48
