void func_0012a028() {
    ...
    func_0012c308();  // 12c308                                // 0x0012a074: jal 0x12c308
    g_00202a1c = 0;  // Global at 0x00202a1c                    // 0x0012a078: sw $zero, 0($s0)
    func_001280d0();  // 1280d0                                // 0x0012a07c: jal 0x1280d0
    /* nop */                                                   // 0x0012a080: nop 
    func_0012fdc0();  // 12fdc0                                // 0x0012a084: jal 0x12fdc0
    /* nop */                                                   // 0x0012a088: nop 
    func_0013d2d8();  // 13d2d8                                // 0x0012a08c: jal 0x13d2d8
    /* nop */                                                   // 0x0012a090: nop 
    func_001261a0();  // 1261a0                                // 0x0012a094: jal 0x1261a0
    /* nop */                                                   // 0x0012a098: nop 
    a0 = 2;                                                     // 0x0012a09c: addiu $a0, $zero, 2
    func_001418a0();  // 1418a0                                // 0x0012a0a0: jal 0x1418a0
    ...
    func_001418a0();  // 1418a0                                // 0x0012a0b0: jal 0x1418a0
    ...
    func_001418a0();  // 1418a0                                // 0x0012a0c0: jal 0x1418a0
    a0 = 5;                                                     // 0x0012a0c4: addiu $a0, $zero, 5
    func_00141df8();  // 141df8                                // 0x0012a0c8: jal 0x141df8
    /* nop */                                                   // 0x0012a0cc: nop 
    func_0012c638();  // 12c638                                // 0x0012a0d0: jal 0x12c638
    /* nop */                                                   // 0x0012a0d4: nop 
    func_00127d30();  // 127d30                                // 0x0012a0d8: jal 0x127d30
    /* nop */                                                   // 0x0012a0dc: nop 
    func_0013efd0();  // 13efd0                                // 0x0012a0e0: jal 0x13efd0
    /* nop */                                                   // 0x0012a0e4: nop 
    func_0013f518();  // 13f518                                // 0x0012a0e8: jal 0x13f518
    /* nop */                                                   // 0x0012a0ec: nop 
    func_0013fd30();  // 13fd30                                // 0x0012a0f0: jal 0x13fd30
    /* nop */                                                   // 0x0012a0f4: nop 
    func_001261b8();  // 1261b8                                // 0x0012a0f8: jal 0x1261b8
    /* nop */                                                   // 0x0012a0fc: nop 
