void func_001d7340() {
    ...
    *(uint8_t*)(v0) = a1;                                       // 0x001d742c: sb $a1, 0($v0)
    ...
    func_001b2780();  // 1b2780                                // 0x001d744c: jal 0x1b2780
