...
label_0x104f78:
    ...
    *(uint32_t*)((s0) + 0x54) = v1;                             // 0x00104fe8: sw $v1, 0x54($s0)
    ...
    func_001055a8();  // 0x105518                                // 0x00104ff8: jal 0x105518
    ...
    func_001051d0();  // 0x1050b8                                // 0x0010501c: jal 0x1050b8
label_0x105028:
    ...
    func_00105bd8();  // 0x1058e0                                // 0x0010505c: jal 0x1058e0
    ...
    *(uint32_t*)((s0) + 0x30) = 0;                              // 0x00105074: sw $zero, 0x30($s0)
    func_00105bd8();  // 0x1058e0                                // 0x00105078: jal 0x1058e0
...
label_0x105084:
    ...
    *(uint16_t*)((s0) + 0xc) = 0;                               // 0x0010508c: sh $zero, 0xc($s0)
    func_00105bd8();  // 0x1058e0                                // 0x00105090: jal 0x1058e0
