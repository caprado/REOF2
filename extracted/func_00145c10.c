void func_00145c10() {
    ...
    *(uint32_t*)((s0) + 0x188) = v0;                            // 0x00145c58: sw $v0, 0x188($s0)
    ...
    func_00145818();  // 0x1456a8                                // 0x00145c90: jal 0x1456a8
...
label_0x145cac:
    ...
    *(uint32_t*)((s0) + 0x198) = v0;                            // 0x00145cd8: sw $v0, 0x198($s0)
    ...
    func_00145818();  // 0x1456a8                                // 0x00145d10: jal 0x1456a8
    ...
    func_00145818();  // 0x1456a8                                // 0x00145d40: jal 0x1456a8
