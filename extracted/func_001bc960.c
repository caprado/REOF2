void func_001bc960() {
    ...
    *(uint32_t*)((gp) + -0x7c50) = v0;                          // 0x001bc974: sw $v0, -0x7c50($gp)
    func_0011c0a0();  // 11c0a0                                // 0x001bc978: jal 0x11c0a0
    *(uint32_t*)((gp) + -0x632c) = 0;                           // 0x001bc97c: sw $zero, -0x632c($gp)
    ...
    func_001bca60();  // 1bca60                                // 0x001bc994: jal 0x1bca60
...
label_0x1bc9a4:
    ...
    func_001bca60();  // 1bca60                                // 0x001bc9b0: jal 0x1bca60
    ...
    func_001bca60();  // 1bca60                                // 0x001bc9cc: jal 0x1bca60
    ...
    func_0011af08();  // 11af08                                // 0x001bca18: jal 0x11af08
    ...
    *(uint32_t*)((gp) + -0x7c50) = v0;                          // 0x001bca24: sw $v0, -0x7c50($gp)
    ...
    func_0011af08();  // 11af08                                // 0x001bca3c: jal 0x11af08
    func_001bcd00();  // 1bcd00                                // 0x001bca44: jal 0x1bcd00
    /* nop */                                                   // 0x001bca48: nop 
label_0x1bca4c:
