...
label_0x11ddc4:
    func_0011d378();  // 0x11d320                                // 0x0011ddc4: jal 0x11d320
    /* nop */                                                   // 0x0011ddc8: nop 
    ...
    func_00114e28();  // 0x114dc0                                // 0x0011dde4: jal 0x114dc0
    a0 = 0xb;                                                   // 0x0011dde8: addiu $a0, $zero, 0xb
    func_0011dc10();  // 0x11dc00                                // 0x0011ddec: jal 0x11dc00
    a0 = 0xc00;                                                 // 0x0011ddf0: addiu $a0, $zero, 0xc00
    func_0011dc00();  // 0x11dbf0                                // 0x0011ddf4: jal 0x11dbf0
...
label_0x11de00:
    ...
    func_0011d390();  // 0x11d378                                // 0x0011de0c: jal 0x11d378
    /* nop */                                                   // 0x0011de10: nop 
label_0x11de14:
label_0x11de18:
