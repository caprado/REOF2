void func_0016b070() {
    ...
    func_00167960();  // 167960                                // 0x0016b094: jal 0x167960
    a1 = *(int32_t*)((s1) + 0x18);                              // 0x0016b098: lw $a1, 0x18($s1)
    a1 = *(int32_t*)((s1) + 0x14);                              // 0x0016b0a0: lw $a1, 0x14($s1)
    func_00167960();  // 167960                                // 0x0016b0a4: jal 0x167960
    ...
    func_0016a2f8();  // 16a2f8                                // 0x0016b0dc: jal 0x16a2f8
...
label_0x16b100:
    ...
    func_00167208();  // 167208                                // 0x0016b110: jal 0x167208
