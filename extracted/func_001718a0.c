void func_001718a0() {
    ...
    func_00107b68();  // 0x107ab8                                // 0x0017190c: jal 0x107ab8
    a1 = s2 + s1;                                               // 0x00171918: addu $a1, $s2, $s1
    func_00107b68();  // 0x107ab8                                // 0x0017191c: jal 0x107ab8
    a2 = s0 - s1;                                               // 0x00171920: subu $a2, $s0, $s1
    a0 = s6 + s0;                                               // 0x00171924: addu $a0, $s6, $s0
    a0 = a0 - s1;                                               // 0x00171928: subu $a0, $a0, $s1
    func_00107b68();  // 0x107ab8                                // 0x00171930: jal 0x107ab8
    ...
    func_00107b68();  // 0x107ab8                                // 0x0017194c: jal 0x107ab8
    func_00107b68();  // 0x107ab8                                // 0x0017195c: jal 0x107ab8
    ...
    func_00107b68();  // 0x107ab8                                // 0x00171970: jal 0x107ab8
    goto label_0x17199c;                                        // 0x00171978: b 0x17199c
label_0x171980:
    func_00107b68();  // 0x107ab8                                // 0x00171980: jal 0x107ab8
    func_00107b68();  // 0x107ab8                                // 0x00171990: jal 0x107ab8
