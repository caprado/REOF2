void func_00111160() {
    ...
    func_00111f40();  // 111f40                                // 0x0011117c: jal 0x111f40
    /* nop */                                                   // 0x00111180: nop 
    a1 = 0 | 0xf7c0;                                            // 0x00111188: ori $a1, $zero, 0xf7c0
    if (v0 < 0) goto label_0x111260;                            // 0x00111190: bltz $v0, 0x111260
    func_00111a58();  // 111a58                                // 0x00111198: jal 0x111a58
    /* nop */                                                   // 0x0011119c: nop 
    func_00112170();  // 112170                                // 0x001111a4: jal 0x112170
    /* nop */                                                   // 0x001111a8: nop 
...
label_0x1111d0:
    ...
    /* nop */                                                   // 0x001111d4: nop 
    func_00111998();  // 111998                                // 0x001111e0: jal 0x111998
    /* nop */                                                   // 0x001111e4: nop 
label_0x1111e8:
    func_001119f0();  // 1119f0                                // 0x001111f0: jal 0x1119f0
    /* nop */                                                   // 0x001111f4: nop 
    func_00111f40();  // 111f40                                // 0x00111208: jal 0x111f40
    /* nop */                                                   // 0x0011120c: nop 
    if (v0 >= 0) goto label_0x111248;                           // 0x00111218: bgez $v0, 0x111248
    /* nop */                                                   // 0x0011121c: nop 
    func_001119f0();  // 1119f0                                // 0x00111224: jal 0x1119f0
    /* nop */                                                   // 0x00111228: nop 
    func_00112170();  // 112170                                // 0x00111230: jal 0x112170
    /* nop */                                                   // 0x00111234: nop 
    goto label_0x11125c;                                        // 0x00111240: b 0x11125c
label_0x111248:
    func_00112170();  // 112170                                // 0x00111248: jal 0x112170
    /* nop */                                                   // 0x0011124c: nop 
label_0x11125c:
label_0x111260:
