void func_00137300() {
    ...
    func_00137ec8();  // 137ec8                                // 0x00137308: jal 0x137ec8
    a0 = 0x1300;                                                // 0x0013730c: addiu $a0, $zero, 0x1300
    func_00100d98();  // 100d98                                // 0x00137310: jal 0x100d98
...
label_0x1373b0:
    func_001372d0();  // 1372d0                                // 0x001373b0: jal 0x1372d0
    ...
    func_00116508();  // 116508                                // 0x001373c4: jal 0x116508
