void func_001d06b0() {
    ...
    func_00107d30();  // 0x107c70                                // 0x001d06c8: jal 0x107c70
    ...
    *(uint8_t*)((gp) + -0x626c) = 0;                            // 0x001d06ec: sb $zero, -0x626c($gp)
    func_00107d30();  // 0x107c70                                // 0x001d06f0: jal 0x107c70
    ...
    *(uint8_t*)((gp) + -0x627c) = 0;                            // 0x001d0710: sb $zero, -0x627c($gp)
    func_00107d30();  // 0x107c70                                // 0x001d0714: jal 0x107c70
    ...
    *(uint32_t*)((gp) + -0x6284) = 0;                           // 0x001d0754: sw $zero, -0x6284($gp)
    func_00107d30();  // 0x107c70                                // 0x001d0758: jal 0x107c70
    *(uint32_t*)((gp) + -0x6288) = 0;                           // 0x001d075c: sw $zero, -0x6288($gp)
    ...
    func_00107d30();  // 0x107c70                                // 0x001d076c: jal 0x107c70
    ...
    *(uint32_t*)((gp) + -0x629c) = 0;                           // 0x001d079c: sw $zero, -0x629c($gp)
    func_00107d30();  // 0x107c70                                // 0x001d07a0: jal 0x107c70
