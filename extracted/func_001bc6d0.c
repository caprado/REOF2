void func_001bc6d0() {
    ...
    func_001b2010();  // 1b2010                                // 0x001bc6d8: jal 0x1b2010
    /* nop */                                                   // 0x001bc6dc: nop 
    func_001b2080();  // 1b2080                                // 0x001bc6e0: jal 0x1b2080
    /* nop */                                                   // 0x001bc6e4: nop 
    func_001aeef0();  // 1aeef0                                // 0x001bc6e8: jal 0x1aeef0
    func_001ae950();  // 1ae950                                // 0x001bc6f0: jal 0x1ae950
    a0 = 0x1c << 16;                                            // 0x001bc6f8: lui $a0, 0x1c
    a1 = 0xa;                                                   // 0x001bc6fc: addiu $a1, $zero, 0xa
    func_001b76c0();  // 1b76c0                                // 0x001bc700: jal 0x1b76c0
    a0 = a0 + -0x4f60;                                          // 0x001bc704: addiu $a0, $a0, -0x4f60
    a0 = 0x1c << 16;                                            // 0x001bc708: lui $a0, 0x1c
    a1 = 0xb;                                                   // 0x001bc70c: addiu $a1, $zero, 0xb
    func_001b76c0();  // 1b76c0                                // 0x001bc710: jal 0x1b76c0
    a0 = a0 + -0x5410;                                          // 0x001bc714: addiu $a0, $a0, -0x5410
    at = 0x31 << 16;                                            // 0x001bc718: lui $at, 0x31
    func_001dac50();  // 1dac50                                // 0x001bc71c: jal 0x1dac50
    g_003137a0 = 0;  // Global at 0x003137a0                    // 0x001bc720: sb $zero, 0x37a0($at)
    func_001d8e00();  // 1d8e00                                // 0x001bc724: jal 0x1d8e00
    /* nop */                                                   // 0x001bc728: nop 
    func_001b3830();  // 1b3830                                // 0x001bc72c: jal 0x1b3830
    /* nop */                                                   // 0x001bc730: nop 
