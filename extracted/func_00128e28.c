void func_00128e28() {
    ...
    func_00129ad8();  // 129ad8                                // 0x00128e54: jal 0x129ad8
...
label_0x128e70:
    ...
    *(uint32_t*)((s1) + 0x34) = v1;                             // 0x00128e78: sw $v1, 0x34($s1)
    func_00129c30();  // 129c30                                // 0x00128e7c: jal 0x129c30
    ...
    *(uint32_t*)((s1) + 0x3c) = a0;                             // 0x00128ea8: sw $a0, 0x3c($s1)
    func_001301a8();  // 1301a8                                // 0x00128eac: jal 0x1301a8
    a0 = *(int32_t*)((s1) + 4);                                 // 0x00128eb0: lw $a0, 4($s1)
    func_00130278();  // 130278                                // 0x00128eb4: jal 0x130278
    ...
    func_00130220();  // 130220                                // 0x00128ec8: jal 0x130220
