void func_0018d680() {
    ...
    func_0010ac68();  // 10ac68                                // 0x0018d6a8: jal 0x10ac68
    ...
    func_0010a860();  // 10a860                                // 0x0018d6c4: jal 0x10a860
    a0 = sp + 0x40;                                             // 0x0018d6c8: addiu $a0, $sp, 0x40
    func_0010ca50();  // 10ca50                                // 0x0018d6cc: jal 0x10ca50
    a1 = 0x23 << 16;                                            // 0x0018d6d4: lui $a1, 0x23
    a0 = sp + 0x40;                                             // 0x0018d6d8: addiu $a0, $sp, 0x40
    func_0010a860();  // 10a860                                // 0x0018d6dc: jal 0x10a860
    a1 = a1 + -0x5bd0;                                          // 0x0018d6e0: addiu $a1, $a1, -0x5bd0
    func_0018d5c0();  // 18d5c0                                // 0x0018d6e4: jal 0x18d5c0
    a0 = sp + 0x40;                                             // 0x0018d6e8: addiu $a0, $sp, 0x40
    func_001ab180();  // 1ab180                                // 0x0018d6ec: jal 0x1ab180
    /* nop */                                                   // 0x0018d6f0: nop 
    a0 = sp + 0x40;                                             // 0x0018d6f4: addiu $a0, $sp, 0x40
    func_00118730();  // 118730                                // 0x0018d6f8: jal 0x118730
    a1 = 1;                                                     // 0x0018d6fc: addiu $a1, $zero, 1
    if (s0 >= 0) goto label_0x18d71c;                           // 0x0018d704: bgez $s0, 0x18d71c
    func_001ab1d0();  // 1ab1d0                                // 0x0018d70c: jal 0x1ab1d0
    /* nop */                                                   // 0x0018d710: nop 
    goto label_0x18d73c;                                        // 0x0018d714: b 0x18d73c
label_0x18d71c:
    func_00118d70();  // 118d70                                // 0x0018d720: jal 0x118d70
    func_001189b8();  // 1189b8                                // 0x0018d728: jal 0x1189b8
    func_001ab1d0();  // 1ab1d0                                // 0x0018d730: jal 0x1ab1d0
    /* nop */                                                   // 0x0018d734: nop 
