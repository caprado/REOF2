void func_0015ec60() {
    ...
    func_0015e348();  // 0x15e338                                // 0x0015ec8c: jal 0x15e338
    ...
    func_0015c918();  // 0x15c888                                // 0x0015eca0: jal 0x15c888
    /* nop */                                                   // 0x0015eca4: nop 
...
label_0x15ecc8:
    func_00163030();  // 0x162f80                                // 0x0015ecc8: jal 0x162f80
    func_0015dd08();  // 0x15dce0                                // 0x0015ecd0: jal 0x15dce0
    func_001616e8();  // 0x1616b8                                // 0x0015ecd8: jal 0x1616b8
    func_00161698();  // 0x161638                                // 0x0015ece0: jal 0x161638
...
label_0x15ed08:
    func_001616b8();  // 0x161698                                // 0x0015ed08: jal 0x161698
label_0x15ed10:
    func_0015ed78();  // 0x15ed68                                // 0x0015ed10: jal 0x15ed68
    func_0015eb48();  // 0x15eb08                                // 0x0015ed18: jal 0x15eb08
    func_0015f1d0();  // 0x15f0b0                                // 0x0015ed24: jal 0x15f0b0
    a1 = *(int8_t*)((s0) + 0x72);                               // 0x0015ed28: lb $a1, 0x72($s0)
    func_00162d98();  // 0x162d38                                // 0x0015ed30: jal 0x162d38
    a1 = 1;                                                     // 0x0015ed34: addiu $a1, $zero, 1
    func_00162c08();  // 0x162bb0                                // 0x0015ed38: jal 0x162bb0
