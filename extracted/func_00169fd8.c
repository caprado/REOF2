void func_00169fd8() {
    ...
    *(uint32_t*)(s4) = 0;                                       // 0x0016a010: sw $zero, 0($s4)
    ...
    func_00169940();  // 0x1698d0                                // 0x0016a048: jal 0x1698d0
...
label_0x16a0a8:
    ...
    /* nop */                                                   // 0x0016a0ac: nop 
    func_00167af8();  // 0x167ab0                                // 0x0016a0b0: jal 0x167ab0
...
label_0x16a0c4:
    ...
    func_0016a258();  // 0x16a178                                // 0x0016a0d8: jal 0x16a178
...
label_0x16a0e8:
    ...
    func_00169940();  // 0x1698d0                                // 0x0016a0fc: jal 0x1698d0
    ...
    func_0016a480();  // 0x16a320                                // 0x0016a120: jal 0x16a320
