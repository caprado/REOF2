void func_0016e808() {
    ...
    func_0016e950();  // 0x16e8e0                                // 0x0016e838: jal 0x16e8e0
    s5 = v0 + 0x8c;                                             // 0x0016e83c: addiu $s5, $v0, 0x8c
    a2 = 1;                                                     // 0x0016e844: addiu $a2, $zero, 1
    func_0013fcc0();  // 0x13fca8                                // 0x0016e848: jal 0x13fca8
    func_00158ea8();  // 0x158df0                                // 0x0016e858: jal 0x158df0
    a2 = 1;                                                     // 0x0016e868: addiu $a2, $zero, 1
    func_0013fcc0();  // 0x13fca8                                // 0x0016e86c: jal 0x13fca8
    s1 = v0 - s4;                                               // 0x0016e874: subu $s1, $v0, $s4
    a3 = 0xff00 << 16;                                          // 0x0016e878: lui $a3, 0xff00
    func_0016d3a8();  // 0x16d308                                // 0x0016e888: jal 0x16d308
    a3 = a3 | 0xf07;                                            // 0x0016e88c: ori $a3, $a3, 0xf07
    func_0016d2a8();  // 0x16d288                                // 0x0016e898: jal 0x16d288
    if (s0 != 0) goto label_0x16e8bc;                           // 0x0016e8a8: bnez $s0, 0x16e8bc
    a1 = 1;                                                     // 0x0016e8ac: addiu $a1, $zero, 1
    func_00173650();  // 0x1735e8                                // 0x0016e8b0: jal 0x1735e8
