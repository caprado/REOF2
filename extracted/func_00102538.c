void func_00102538() {
    ...
    func_001022b8();  // 1022b8                                // 0x00102564: jal 0x1022b8
...
label_0x1025a8:
    ...
    func_00102328();  // 102328                                // 0x001025b4: jal 0x102328
    ...
    *(uint32_t*)((s2) + 0x200) = v0;                            // 0x001025f4: sw $v0, 0x200($s2)
    ...
    func_00102328();  // 102328                                // 0x00102604: jal 0x102328
    *(uint32_t*)((s2) + 0x204) = v0;                            // 0x00102608: sw $v0, 0x204($s2)
    ...
    func_00102328();  // 102328                                // 0x00102618: jal 0x102328
    *(uint32_t*)((s2) + 0x208) = v0;                            // 0x0010261c: sw $v0, 0x208($s2)
    ...
    func_00102328();  // 102328                                // 0x0010262c: jal 0x102328
    *(uint32_t*)((s2) + 0x20c) = v0;                            // 0x00102630: sw $v0, 0x20c($s2)
    ...
    func_00102328();  // 102328                                // 0x00102640: jal 0x102328
    *(uint32_t*)((s2) + 0x210) = v0;                            // 0x00102644: sw $v0, 0x210($s2)
    ...
    func_00102328();  // 102328                                // 0x00102654: jal 0x102328
...
label_0x102668:
    ...
    func_00102328();  // 102328                                // 0x00102674: jal 0x102328
