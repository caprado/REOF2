...
label_0x146c00:
    ...
    func_00146920();  // 146920                                // 0x00146c18: jal 0x146920
    ...
    *(uint32_t*)((s1) + 0x98) = v0;                             // 0x00146c3c: sw $v0, 0x98($s1)
    func_00146920();  // 146920                                // 0x00146c40: jal 0x146920
    ...
    *(uint32_t*)((s1) + 0xd8) = v0;                             // 0x00146ca0: sw $v0, 0xd8($s1)
    ...
    func_001465c8();  // 1465c8                                // 0x00146ca8: jal 0x1465c8
    ...
    *(uint32_t*)((s2) + 0x10) = v0;                             // 0x00146cd8: sw $v0, 0x10($s2)
    ...
    func_00147460();  // 147460                                // 0x00146ce8: jal 0x147460
    goto label_0x146d04;                                        // 0x00146cf0: b 0x146d04
    v0 = *(int32_t*)((s2) + 0x10);                              // 0x00146cf4: lw $v0, 0x10($s2)
label_0x146cf8:
    func_00146668();  // 146668                                // 0x00146cf8: jal 0x146668
