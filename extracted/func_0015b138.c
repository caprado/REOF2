void func_0015b138() {
    ...
    func_0015b4c8();  // 15b4c8                                // 0x0015b140: jal 0x15b4c8
    /* nop */                                                   // 0x0015b144: nop 
    ...
    func_0015b1b8();  // 15b1b8                                // 0x0015b16c: jal 0x15b1b8
    /* nop */                                                   // 0x0015b170: nop 
    a1 = 0x3c4;                                                 // 0x0015b178: addiu $a1, $zero, 0x3c4
    if (s0 == 0) goto label_0x15b1a8;                           // 0x0015b17c: beqz $s0, 0x15b1a8
    func_0015b350();  // 15b350                                // 0x0015b184: jal 0x15b350
    /* nop */                                                   // 0x0015b188: nop 
    func_0015b208();  // 15b208                                // 0x0015b18c: jal 0x15b208
    func_0015b4e0();  // 15b4e0                                // 0x0015b198: jal 0x15b4e0
