...
label_0x1c60f0:
    ...
    *(uint32_t*)((s0) + 0x38) = a0;                             // 0x001c60fc: sw $a0, 0x38($s0)
    func_001afb40();  // 1afb40                                // 0x001c6100: jal 0x1afb40
    *(uint32_t*)((s0) + 0x10) = v0;                             // 0x001c6104: sw $v0, 0x10($s0)
    ...
    func_001af280();  // 1af280                                // 0x001c6110: jal 0x1af280
...
label_0x1c6124:
    ...
    /* nop */                                                   // 0x001c6130: nop 
    func_001c7460();  // 1c7460                                // 0x001c6134: jal 0x1c7460
    *(uint32_t*)((s0) + 0x2c) = 0;                              // 0x001c6138: sw $zero, 0x2c($s0)
    ...
    func_001af2f0();  // 1af2f0                                // 0x001c614c: jal 0x1af2f0
...
label_0x1c6154:
    *(uint32_t*)((s0) + 0x30) = 0;                              // 0x001c6154: sw $zero, 0x30($s0)
    ...
    func_001c2a50();  // 1c2a50                                // 0x001c6168: jal 0x1c2a50
...
label_0x1c61b4:
    ...
    /* nop */                                                   // 0x001c61c8: nop 
label_0x1c61cc:
    func_001c7470();  // 1c7470                                // 0x001c61cc: jal 0x1c7470
    /* nop */                                                   // 0x001c61d0: nop 
