void func_001daf80() {
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001dafbc: jal 0x10a4d8
    ...
    func_001d3390();  // 1d3390                                // 0x001dafd0: jal 0x1d3390
...
label_0x1db000:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001db00c: jal 0x10a4d8
    a1 = &str_00247a28;  // "%s/r%03d.sgl"                      // 0x001db010: addiu $a1, $a1, 0x7a28
    func_001a9b30();  // 1a9b30                                // 0x001db018: jal 0x1a9b30
