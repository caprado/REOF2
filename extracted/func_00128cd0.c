void func_00128cd0() {
    ...
    func_00127de8();  // 0x127d90                                // 0x00128cf0: jal 0x127d90
...
label_0x128d00:
    ...
    *(uint32_t*)((s0) + 0x34) = v0;                             // 0x00128d08: sw $v0, 0x34($s0)
    ...
    func_001301e0();  // 0x1301a8                                // 0x00128d18: jal 0x1301a8
    *(uint32_t*)((s0) + 0x14) = 0;                              // 0x00128d1c: sw $zero, 0x14($s0)
    func_00130280();  // 0x130278                                // 0x00128d20: jal 0x130278
