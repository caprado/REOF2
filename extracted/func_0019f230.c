void func_0019f230() {
    ...
    func_001ab180();  // 0x1aaf50                                // 0x0019f238: jal 0x1aaf50
    func_0019f230();  // 0x19f130                                // 0x0019f240: jal 0x19f130
    /* nop */                                                   // 0x0019f244: nop 
    if (v0 != 0) goto label_0x19f258;                           // 0x0019f248: bnez $v0, 0x19f258
    /* nop */                                                   // 0x0019f24c: nop 
    goto label_0x19f2c8;                                        // 0x0019f250: b 0x19f2c8
label_0x19f258:
    func_00112418();  // 0x1123b0                                // 0x0019f258: jal 0x1123b0
    /* nop */                                                   // 0x0019f25c: nop 
    func_00103188();  // 0x1030a8                                // 0x0019f260: jal 0x1030a8
    a0 = 1;                                                     // 0x0019f264: addiu $a0, $zero, 1
label_0x19f26c:
    func_001030a8();  // 0x103080                                // 0x0019f26c: jal 0x103080
    ...
    /* nop */                                                   // 0x0019f294: nop 
    func_0017feb0();  // 0x17fe30                                // 0x0019f298: jal 0x17fe30
    /* nop */                                                   // 0x0019f29c: nop 
    ...
    func_0018cd80();  // 0x18ccc0                                // 0x0019f2bc: jal 0x18ccc0
