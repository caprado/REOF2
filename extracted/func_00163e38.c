void func_00163e38() {
    ...
    func_00163f78();  // 163f78                                // 0x00163e54: jal 0x163f78
    ...
    func_00163f78();  // 163f78                                // 0x00163e70: jal 0x163f78
    goto label_0x163edc;                                        // 0x00163e78: b 0x163edc
label_0x163e80:
    v0 = 0x21 << 16;                                            // 0x00163e80: lui $v0, 0x21
    func_00163f88();  // 163f88                                // 0x00163e84: jal 0x163f88
    g_00215560 = s0;  // Global at 0x00215560                   // 0x00163e88: sw $s0, 0x5560($v0)
    func_001721f0();  // 1721f0                                // 0x00163e8c: jal 0x1721f0
    func_00163f88();  // 163f88                                // 0x00163e98: jal 0x163f88
    ...
    *(uint32_t*)((s0) + 0x68) = 0;                              // 0x00163eb0: sw $zero, 0x68($s0)
    /* nop */                                                   // 0x00163eb4: nop 
label_0x163eb8:
    func_00163938();  // 163938                                // 0x00163eb8: jal 0x163938
    *(uint32_t*)((s0) + 0x68) = s1;                             // 0x00163ebc: sw $s1, 0x68($s0)
label_0x163ec4:
    func_00163f78();  // 163f78                                // 0x00163ec4: jal 0x163f78
    func_00172160();  // 172160                                // 0x00163ecc: jal 0x172160
