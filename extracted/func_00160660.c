void func_00160660() {
    ...
    func_0015fcb0();  // 0x15fc80                                // 0x00160674: jal 0x15fc80
...
label_0x1606a0:
    func_0015f820();  // 0x15f7e0                                // 0x001606a0: jal 0x15f7e0
    /* nop */                                                   // 0x001606a4: nop 
    ...
    *(float*)((sp) + 0x20) = FPU_F20;  // Store float           // 0x001606d4: swc1 $f20, 0x20($sp)
    func_0015fcb0();  // 0x15fc80                                // 0x001606e4: jal 0x15fc80
...
label_0x160718:
    func_0015f820();  // 0x15f7e0                                // 0x00160718: jal 0x15f7e0
    /* nop */                                                   // 0x0016071c: nop 
    at = 0x447a << 16;                                          // 0x00160720: lui $at, 0x447a
    /* move to FPU: $at, $f12 */                                // 0x00160724: mtc1 $at, $f12
    func_001115a0();  // 0x111560                                // 0x0016072c: jal 0x111560
    /* FPU: mul.s $f12, $f20, $f12 */                           // 0x00160730: mul.s $f12, $f20, $f12
    a1 = 0 | 0xff80;                                            // 0x00160734: ori $a1, $zero, 0xff80
    func_001119f0();  // 0x111998                                // 0x0016073c: jal 0x111998
    func_001120e8();  // 0x112048                                // 0x00160748: jal 0x112048
    func_00112048();  // 0x111f90                                // 0x00160754: jal 0x111f90
    func_00111f90();  // 0x111f40                                // 0x00160760: jal 0x111f40
