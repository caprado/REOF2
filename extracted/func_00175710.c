void func_00175710() {
    ...
    func_00176680();  // 0x176670                                // 0x00175730: jal 0x176670
    a1 = 0x17 << 16;                                            // 0x00175738: lui $a1, 0x17
    a2 = 1;                                                     // 0x0017573c: addiu $a2, $zero, 1
    a1 = a1 + 0x61b8;                                           // 0x00175740: addiu $a1, $a1, 0x61b8
    func_00176680();  // 0x176670                                // 0x00175744: jal 0x176670
    func_00176680();  // 0x176670                                // 0x00175754: jal 0x176670
    ...
    func_00176680();  // 0x176670                                // 0x00175768: jal 0x176670
    func_00176680();  // 0x176670                                // 0x00175778: jal 0x176670
    a2 = 4;                                                     // 0x0017577c: addiu $a2, $zero, 4
    a1 = 0x17 << 16;                                            // 0x00175780: lui $a1, 0x17
    a2 = 5;                                                     // 0x00175784: addiu $a2, $zero, 5
    func_00176680();  // 0x176670                                // 0x0017578c: jal 0x176670
