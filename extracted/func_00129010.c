void func_00129010() {
    ...
    func_00128268();  // 0x1281b8                                // 0x00129034: jal 0x1281b8
    ...
    func_00129590();  // 0x1294a0                                // 0x00129050: jal 0x1294a0
...
label_0x12905c:
    ...
    *(uint8_t*)(s1) = 0;                                        // 0x00129064: sb $zero, 0($s1)
    func_00130278();  // 0x130220                                // 0x00129068: jal 0x130220
    *(uint32_t*)((s1) + 4) = 0;                                 // 0x0012906c: sw $zero, 4($s1)
    func_00130138();  // 0x1300e0                                // 0x00129070: jal 0x1300e0
label_0x129078:
    func_00107d30();  // 0x107c70                                // 0x00129080: jal 0x107c70
