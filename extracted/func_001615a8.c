void func_001615a8() {
    ...
    func_001615a8();  // 0x161580                                // 0x001615b8: jal 0x161580
    ...
    func_0013f658();  // 0x13f568                                // 0x001615cc: jal 0x13f568
    ...
    func_001634a8();  // 0x163410                                // 0x001615e0: jal 0x163410
    /* nop */                                                   // 0x001615e4: nop 
    func_0015cf98();  // 0x15ce90                                // 0x001615e8: jal 0x15ce90
label_0x1615f4:
