...
label_0x139bc0:
    ...
    func_00137590();  // 0x137528                                // 0x00139bdc: jal 0x137528
    /* nop */                                                   // 0x00139be0: nop 
label_0x139be4:
    ...
    /* nop */                                                   // 0x00139bf4: nop 
label_0x139bf8:
    func_00137b50();  // 0x137a40                                // 0x00139bf8: jal 0x137a40
    /* nop */                                                   // 0x00139bfc: nop 
    func_001394e8();  // 0x139458                                // 0x00139c00: jal 0x139458
    /* nop */                                                   // 0x00139c04: nop 
    func_00139ca8();  // 0x139c68                                // 0x00139c08: jal 0x139c68
    ...
    *(uint32_t*)((s0) + 0x14) = 0;                              // 0x00139c30: sw $zero, 0x14($s0)
    func_00116598();  // 0x116508                                // 0x00139c34: jal 0x116508
