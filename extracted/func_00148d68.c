void func_00148d68() {
    ...
    func_00145818();  // 0x1456a8                                // 0x00148d78: jal 0x1456a8
    func_00145818();  // 0x1456a8                                // 0x00148d84: jal 0x1456a8
    a1 = 1;                                                     // 0x00148d88: addiu $a1, $zero, 1
    if (v0 == 0) goto label_0x148db8;                           // 0x00148d8c: beqz $v0, 0x148db8
    func_00145818();  // 0x1456a8                                // 0x00148d94: jal 0x1456a8
    a1 = 8;                                                     // 0x00148d98: addiu $a1, $zero, 8
    func_00145818();  // 0x1456a8                                // 0x00148da0: jal 0x1456a8
    a1 = 8;                                                     // 0x00148da4: addiu $a1, $zero, 8
    func_00145818();  // 0x1456a8                                // 0x00148dac: jal 0x1456a8
    a1 = 8;                                                     // 0x00148db0: addiu $a1, $zero, 8
    *(uint32_t*)((s0) + 0x15c) = v0;                            // 0x00148db4: sw $v0, 0x15c($s0)
label_0x148db8:
    func_00145818();  // 0x1456a8                                // 0x00148dbc: jal 0x1456a8
    a1 = 0xe;                                                   // 0x00148dc0: addiu $a1, $zero, 0xe
    *(uint32_t*)((s0) + 0x160) = v0;                            // 0x00148dc4: sw $v0, 0x160($s0)
    func_00145818();  // 0x1456a8                                // 0x00148dcc: jal 0x1456a8
    a1 = 1;                                                     // 0x00148dd0: addiu $a1, $zero, 1
    func_00145818();  // 0x1456a8                                // 0x00148dd8: jal 0x1456a8
