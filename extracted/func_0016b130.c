void func_0016b130() {
    ...
    func_001752f8();  // 0x1752e8                                // 0x0016b148: jal 0x1752e8
    ...
    /* nop */                                                   // 0x0016b164: nop 
    func_00177938();  // 0x177908                                // 0x0016b168: jal 0x177908
    a1 = 6;                                                     // 0x0016b16c: addiu $a1, $zero, 6
    a1 = 6;                                                     // 0x0016b174: addiu $a1, $zero, 6
    if (v0 == 0) goto label_0x16b18c;                           // 0x0016b178: beqz $v0, 0x16b18c
    func_00175170();  // 0x175120                                // 0x0016b180: jal 0x175120
    /* nop */                                                   // 0x0016b184: nop 
label_0x16b18c:
    func_001752f8();  // 0x1752e8                                // 0x0016b18c: jal 0x1752e8
    ...
    func_00177938();  // 0x177908                                // 0x0016b1b0: jal 0x177908
