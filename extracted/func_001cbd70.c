void func_001cbd70() {
    ...
    func_001cba20();  // 1cba20                                // 0x001cbd90: jal 0x1cba20
    /* nop */                                                   // 0x001cbd94: nop 
    if (v0 == 0) goto label_0x1cbe04;                           // 0x001cbd98: beqz $v0, 0x1cbe04
    func_001cbe20();  // 1cbe20                                // 0x001cbda0: jal 0x1cbe20
    /* nop */                                                   // 0x001cbda4: nop 
    func_001cbc70();  // 1cbc70                                // 0x001cbda8: jal 0x1cbc70
    goto label_0x1cbe04;                                        // 0x001cbdb0: b 0x1cbe04
    s0 = 1;                                                     // 0x001cbdb4: addiu $s0, $zero, 1
label_0x1cbdb8:
    func_001cfa00();  // 1cfa00                                // 0x001cbdb8: jal 0x1cfa00
