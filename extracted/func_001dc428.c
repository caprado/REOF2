void func_001dc428() {
    ...
    /* nop */                                                   // 0x001dc460: nop 
    func_00114dc0();  // 114dc0                                // 0x001dc464: jal 0x114dc0
    a0 = 3;                                                     // 0x001dc468: addiu $a0, $zero, 3
label_0x1dc46c:
    if (s1 == 0) goto label_0x1dc47c;                           // 0x001dc46c: beqz $s1, 0x1dc47c
    /* nop */                                                   // 0x001dc470: nop 
    func_0011d378();  // 11d378                                // 0x001dc474: jal 0x11d378
    /* nop */                                                   // 0x001dc478: nop 
label_0x1dc47c:
    ...
    func_00116508();  // 116508                                // 0x001dc48c: jal 0x116508
...
label_0x1dc498:
    ...
    func_00116508();  // 116508                                // 0x001dc4c0: jal 0x116508
