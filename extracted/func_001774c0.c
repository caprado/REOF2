void func_001774c0() {
    ...
    func_001777d0();  // 1777d0                                // 0x001774dc: jal 0x1777d0
    ...
    func_00177730();  // 177730                                // 0x001774fc: jal 0x177730
    a2 = 1;                                                     // 0x00177500: addiu $a2, $zero, 1
    func_001775b0();  // 1775b0                                // 0x00177508: jal 0x1775b0
    goto label_0x177528;                                        // 0x00177510: b 0x177528
    v0 = *(int32_t*)((s1) + 0xc);                               // 0x00177514: lw $v0, 0xc($s1)
label_0x177518:
    func_00175120();  // 175120                                // 0x00177518: jal 0x175120
    /* nop */                                                   // 0x0017751c: nop 
...
label_0x177564:
    ...
    func_00177770();  // 177770                                // 0x00177570: jal 0x177770
