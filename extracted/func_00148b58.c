void func_00148b58() {
    ...
    func_00147ca0();  // 0x147c28                                // 0x00148b84: jal 0x147c28
    local_0 = v0;                                               // 0x00148b88: sw $v0, 0($sp)
    func_00145080();  // 0x144f18                                // 0x00148b8c: jal 0x144f18
    v0 = 0x1000 << 16;                                          // 0x00148b94: lui $v0, 0x1000
    v0 = v0 | 0x2000;                                           // 0x00148b9c: ori $v0, $v0, 0x2000
    func_00145080();  // 0x144f18                                // 0x00148ba0: jal 0x144f18
    g_10000000 = 0;  // Global at 0x10000000                    // 0x00148ba4: sw $zero, 0($v0)
    func_0011d378();  // 0x11d320                                // 0x00148ba8: jal 0x11d320
    /* nop */                                                   // 0x00148bac: nop 
    ...
    func_0011d390();  // 0x11d378                                // 0x00148bf0: jal 0x11d378
    /* nop */                                                   // 0x00148bf4: nop 
    func_00144f18();  // 0x144ee8                                // 0x00148bfc: jal 0x144ee8
    func_00145080();  // 0x144f18                                // 0x00148c04: jal 0x144f18
    a0 = *(int32_t*)((s1) + 0x870);                             // 0x00148c0c: lw $a0, 0x870($s1)
    v0 = 3;                                                     // 0x00148c10: addiu $v0, $zero, 3
    local_0 = v0;                                               // 0x00148c14: sw $v0, 0($sp)
    func_00147ca0();  // 0x147c28                                // 0x00148c18: jal 0x147c28
