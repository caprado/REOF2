void func_0015e800() {
    ...
    func_001696c0();  // 0x1696b0                                // 0x0015e82c: jal 0x1696b0
    ...
    func_001634a8();  // 0x163410                                // 0x0015e844: jal 0x163410
    ...
    /* nop */                                                   // 0x0015e854: nop 
label_0x15e858:
    func_00169728();  // 0x1696c0                                // 0x0015e858: jal 0x1696c0
    /* nop */                                                   // 0x0015e85c: nop 
    if (v0 == 0) goto label_0x15e878;                           // 0x0015e860: beqz $v0, 0x15e878
    a1 = 0x16 << 16;                                            // 0x0015e864: lui $a1, 0x16
    func_0015e7e0();  // 0x15e7b0                                // 0x0015e868: jal 0x15e7b0
