void func_0017a4d8() {
    ...
    func_0017cf48();  // 0x17cf18                                // 0x0017a53c: jal 0x17cf18
    ...
    *(uint32_t*)((s0) + 0x48) = v0;                             // 0x0017a564: sw $v0, 0x48($s0)
    func_0017a6f0();  // 0x17a5d8                                // 0x0017a570: jal 0x17a5d8
    a1 = local_0;                                               // 0x0017a57c: lw $a1, 0($sp)
    func_0017cf48();  // 0x17cf18                                // 0x0017a584: jal 0x17cf18
    ...
    func_0017a6f0();  // 0x17a5d8                                // 0x0017a5b0: jal 0x17a5d8
