void func_001db780() {
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001db7dc: jal 0x10a4d8
    ...
    func_001d3390();  // 1d3390                                // 0x001db7f0: jal 0x1d3390
...
label_0x1db9a8:
    ...
    func_0018da10();  // 18da10                                // 0x001db9b0: jal 0x18da10
