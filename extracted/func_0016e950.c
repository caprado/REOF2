void func_0016e950() {
    ...
    func_0016ebd8();  // 16ebd8                                // 0x0016e9a8: jal 0x16ebd8
    ...
    func_0016f318();  // 16f318                                // 0x0016e9c0: jal 0x16f318
    a0 = *(int32_t*)((v0) + 0x28);                              // 0x0016e9c4: lw $a0, 0x28($v0)
    func_0016eef0();  // 16eef0                                // 0x0016e9c8: jal 0x16eef0
    func_0017e530();  // 17e530                                // 0x0016e9d0: jal 0x17e530
    /* nop */                                                   // 0x0016e9d4: nop 
    a2 = 1;                                                     // 0x0016e9e0: addiu $a2, $zero, 1
    func_0013fca8();  // 13fca8                                // 0x0016e9e4: jal 0x13fca8
    a0 = local_38;                                              // 0x0016e9f0: lw $a0, 0x38($sp)
    func_001719d0();  // 1719d0                                // 0x0016e9fc: jal 0x1719d0
    a2 = 1;                                                     // 0x0016ea08: addiu $a2, $zero, 1
    func_0013fca8();  // 13fca8                                // 0x0016ea10: jal 0x13fca8
    func_0017e530();  // 17e530                                // 0x0016ea18: jal 0x17e530
    ...
    func_00177130();  // 177130                                // 0x0016ea30: jal 0x177130
    ...
    *(uint32_t*)((s6) + 0x10) = v1;                             // 0x0016ea64: sw $v1, 0x10($s6)
    func_0016d308();  // 16d308                                // 0x0016ea68: jal 0x16d308
    a3 = a3 | 0xf06;                                            // 0x0016ea6c: ori $a3, $a3, 0xf06
    func_0016d288();  // 16d288                                // 0x0016ea78: jal 0x16d288
    if (s0 == 0) goto label_0x16ea98;                           // 0x0016ea80: beqz $s0, 0x16ea98
    /* nop */                                                   // 0x0016ea84: nop 
    func_00170390();  // 170390                                // 0x0016ea88: jal 0x170390
...
label_0x16ea98:
    ...
    func_00170240();  // 170240                                // 0x0016eaa4: jal 0x170240
    func_0016eff8();  // 16eff8                                // 0x0016eab0: jal 0x16eff8
    a1 = local_30;                                              // 0x0016eab4: lw $a1, 0x30($sp)
    a1 = local_30;                                              // 0x0016eabc: lw $a1, 0x30($sp)
    func_0016f0f8();  // 16f0f8                                // 0x0016eac0: jal 0x16f0f8
...
label_0x16eb64:
    ...
    func_0015b2d0();  // 15b2d0                                // 0x0016eb6c: jal 0x15b2d0
    a1 = v0 + 8;                                                // 0x0016eb70: addiu $a1, $v0, 8
    a2 = *(int32_t*)((fp) + 0x18);                              // 0x0016eb78: lw $a2, 0x18($fp)
    func_00173580();  // 173580                                // 0x0016eb7c: jal 0x173580
...
label_0x16eb90:
    ...
    func_00170390();  // 170390                                // 0x0016eb98: jal 0x170390
