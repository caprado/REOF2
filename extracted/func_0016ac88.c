void func_0016ac88() {
    ...
    func_001679c0();  // 0x1679a0                                // 0x0016acb4: jal 0x1679a0
    a1 = *(int32_t*)((s0) + 0x18);                              // 0x0016acb8: lw $a1, 0x18($s0)
    a1 = *(int32_t*)((s0) + 0x14);                              // 0x0016acc0: lw $a1, 0x14($s0)
    func_001679c0();  // 0x1679a0                                // 0x0016acc4: jal 0x1679a0
    a1 = *(int32_t*)((s0) + 0x1c);                              // 0x0016acd0: lw $a1, 0x1c($s0)
    func_001679c0();  // 0x1679a0                                // 0x0016acd4: jal 0x1679a0
    ...
    func_001679e0();  // 0x1679c0                                // 0x0016ad20: jal 0x1679c0
    a1 = *(int32_t*)((s1) + 0x18);                              // 0x0016ad24: lw $a1, 0x18($s1)
    a1 = *(int32_t*)((s1) + 0x14);                              // 0x0016ad2c: lw $a1, 0x14($s1)
    func_001679e0();  // 0x1679c0                                // 0x0016ad30: jal 0x1679c0
    a1 = *(int32_t*)((s1) + 0x1c);                              // 0x0016ad3c: lw $a1, 0x1c($s1)
    func_001679e0();  // 0x1679c0                                // 0x0016ad44: jal 0x1679c0
