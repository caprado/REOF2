void func_0018d830() {
    ...
    func_001189b8();  // 0x118730                                // 0x0018d8a0: jal 0x118730
    a1 = 2;                                                     // 0x0018d8a4: addiu $a1, $zero, 2
    if (v0 >= 0) goto label_0x18d8c0;                           // 0x0018d8a8: bgez $v0, 0x18d8c0
    func_0012ba78();  // 0x12ba50                                // 0x0018d8b0: jal 0x12ba50
    /* nop */                                                   // 0x0018d8b4: nop 
    goto label_0x18d8f4;                                        // 0x0018d8b8: b 0x18d8f4
label_0x18d8c0:
    func_00118d70();  // 0x118b38                                // 0x0018d8c8: jal 0x118b38
    a2 = 2;                                                     // 0x0018d8cc: addiu $a2, $zero, 2
    func_00119290();  // 0x118fd0                                // 0x0018d8d8: jal 0x118fd0
    func_00118b38();  // 0x1189b8                                // 0x0018d8e0: jal 0x1189b8
    func_0012ba78();  // 0x12ba50                                // 0x0018d8e8: jal 0x12ba50
    /* nop */                                                   // 0x0018d8ec: nop 
