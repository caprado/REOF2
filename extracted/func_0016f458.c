void func_0016f458() {
    ...
    *(uint32_t*)((s1) + 0x1b30) = s2;                           // 0x0016f48c: sw $s2, 0x1b30($s1)
    ...
    /* nop */                                                   // 0x0016f4e4: nop 
label_0x16f4e8:
    func_00158b78();  // 0x158b08                                // 0x0016f4e8: jal 0x158b08
    /* nop */                                                   // 0x0016f4ec: nop 
    if (v0 == 0) goto label_0x16f528;                           // 0x0016f4f0: beqz $v0, 0x16f528
    func_0016fba0();  // 0x16fb68                                // 0x0016f4f8: jal 0x16fb68
    ...
    /* nop */                                                   // 0x0016f524: nop 
label_0x16f528:
    func_001752f8();  // 0x1752e8                                // 0x0016f528: jal 0x1752e8
    func_0015b420();  // 0x15b368                                // 0x0016f538: jal 0x15b368
    a1 = 1;                                                     // 0x0016f53c: addiu $a1, $zero, 1
    func_001752f8();  // 0x1752e8                                // 0x0016f544: jal 0x1752e8
    a1 = 1;                                                     // 0x0016f548: addiu $a1, $zero, 1
    a1 = 2;                                                     // 0x0016f550: addiu $a1, $zero, 2
    func_0015b420();  // 0x15b368                                // 0x0016f554: jal 0x15b368
    a1 = 3;                                                     // 0x0016f560: addiu $a1, $zero, 3
    func_0015b420();  // 0x15b368                                // 0x0016f564: jal 0x15b368
    a1 = 4;                                                     // 0x0016f570: addiu $a1, $zero, 4
    func_0015b420();  // 0x15b368                                // 0x0016f574: jal 0x15b368
    a1 = 5;                                                     // 0x0016f580: addiu $a1, $zero, 5
    func_0015b420();  // 0x15b368                                // 0x0016f584: jal 0x15b368
    a2 = *(int32_t*)((s1) + 0x38);                              // 0x0016f590: lw $a2, 0x38($s1)
    func_0015b420();  // 0x15b368                                // 0x0016f594: jal 0x15b368
    a1 = 6;                                                     // 0x0016f598: addiu $a1, $zero, 6
    a2 = 0x7fff << 16;                                          // 0x0016f5a0: lui $a2, 0x7fff
    a1 = 7;                                                     // 0x0016f5a4: addiu $a1, $zero, 7
    func_0015b420();  // 0x15b368                                // 0x0016f5a8: jal 0x15b368
    a2 = a2 | 0xffff;                                           // 0x0016f5ac: ori $a2, $a2, 0xffff
    a1 = 8;                                                     // 0x0016f5b4: addiu $a1, $zero, 8
    func_0015b420();  // 0x15b368                                // 0x0016f5b8: jal 0x15b368
    a1 = 9;                                                     // 0x0016f5c4: addiu $a1, $zero, 9
    func_0015b420();  // 0x15b368                                // 0x0016f5c8: jal 0x15b368
