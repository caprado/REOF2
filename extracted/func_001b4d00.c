...
label_0x1b4ea4:
    ...
    *(uint32_t*)((s2) + 0x38) = a0;                             // 0x001b4eb4: sw $a0, 0x38($s2)
    func_001b67a0();  // 1b67a0                                // 0x001b4eb8: jal 0x1b67a0
    a1 = g_002ac49c;  // Global at 0x002ac49c                   // 0x001b4ebc: lw $a1, 0xc($s0)
    func_001b69e0();  // 1b69e0                                // 0x001b4ec4: jal 0x1b69e0
