...
label_0x1a9ca8:
    ...
    func_001a98a0();  // 0x1a97d0                                // 0x001a9cb4: jal 0x1a97d0
    s1 = s1 + 4;                                                // 0x001a9cb8: addiu $s1, $s1, 4
    func_001aeef0();  // 0x1aee20                                // 0x001a9cc0: jal 0x1aee20
    func_001d3a90();  // 0x1d3a30                                // 0x001a9ccc: jal 0x1d3a30
...
label_0x1a9cdc:
    ...
    /* nop */                                                   // 0x001a9ce4: nop 
    func_0018db40();  // 0x18db10                                // 0x001a9ce8: jal 0x18db10
    /* nop */                                                   // 0x001a9cec: nop 
    v0 = *(uint8_t*)((gp) + -0x6114);                           // 0x001a9cf0: lbu $v0, -0x6114($gp)
    v0 = v0 << 7;                                               // 0x001a9cf4: sll $v0, $v0, 7
    func_001d3c30();  // 0x1d3c20                                // 0x001a9cf8: jal 0x1d3c20
    ...
    func_001b28a0();  // 0x1b2780                                // 0x001a9d0c: jal 0x1b2780
    ...
    func_001d6250();  // 0x1d61c0                                // 0x001a9d34: jal 0x1d61c0
    a3 = s3 + v0;                                               // 0x001a9d38: addu $a3, $s3, $v0
    func_0018db40();  // 0x18db10                                // 0x001a9d3c: jal 0x18db10
    /* nop */                                                   // 0x001a9d40: nop 
...
label_0x1a9d64:
    ...
    func_001d6250();  // 0x1d61c0                                // 0x001a9e24: jal 0x1d61c0
