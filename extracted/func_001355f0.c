...
label_0x135628:
    ...
    func_001358d8();  // 0x135790                                // 0x00135634: jal 0x135790
...
label_0x135650:
    func_00135780();  // 0x135718                                // 0x00135650: jal 0x135718
    /* nop */                                                   // 0x00135654: nop 
...
label_0x135670:
    func_001355f0();  // 0x135548                                // 0x00135674: jal 0x135548
    if (v0 != 0) goto label_0x135698;                           // 0x0013567c: bnez $v0, 0x135698
    *(uint32_t*)(s0) = v0;                                      // 0x00135680: sw $v0, 0($s0)
    func_00135790();  // 0x135780                                // 0x00135684: jal 0x135780
...
label_0x1356b8:
    func_00135790();  // 0x135780                                // 0x001356b8: jal 0x135780
