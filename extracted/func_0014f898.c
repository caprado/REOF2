void func_0014f898() {
    ...
    func_00148f00();  // 148f00                                // 0x0014f8d0: jal 0x148f00
    s7 = s5 + 0x800;                                            // 0x0014f8d4: addiu $s7, $s5, 0x800
    s4 = 0 | 0xff80;                                            // 0x0014f8d8: ori $s4, $zero, 0xff80
    /* nop */                                                   // 0x0014f8e4: nop 
label_0x14f8e8:
    a0 = s3 + -0x80;                                            // 0x0014f8e8: addiu $a0, $s3, -0x80
    func_00111f90();  // 111f90                                // 0x0014f8ec: jal 0x111f90
    s1 = s3 << 3;                                               // 0x0014f8f0: sll $s1, $s3, 3
    at = 0x22 << 16;                                            // 0x0014f8f4: lui $at, 0x22
    s0 = s1 + s7;                                               // 0x0014f900: addu $s0, $s1, $s7
    func_00111a58();  // 111a58                                // 0x0014f908: jal 0x111a58
    s1 = s1 + s6;                                               // 0x0014f90c: addu $s1, $s1, $s6
    func_00111998();  // 111998                                // 0x0014f918: jal 0x111998
    s3 = s3 + 1;                                                // 0x0014f91c: addiu $s3, $s3, 1
    func_00112048();  // 112048                                // 0x0014f924: jal 0x112048
    /* nop */                                                   // 0x0014f928: nop 
    at = 0x22 << 16;                                            // 0x0014f930: lui $at, 0x22
    func_00111a58();  // 111a58                                // 0x0014f938: jal 0x111a58
    *(uint16_t*)((s0) + 4) = v0;                                // 0x0014f93c: sh $v0, 4($s0)
    func_00111998();  // 111998                                // 0x0014f944: jal 0x111998
    func_00112048();  // 112048                                // 0x0014f94c: jal 0x112048
    ...
    *(uint16_t*)((s0) + 6) = 0;                                 // 0x0014f960: sh $zero, 6($s0)
    ...
    func_00111a58();  // 111a58                                // 0x0014f96c: jal 0x111a58
    *(uint16_t*)((s1) + 4) = 0;                                 // 0x0014f970: sh $zero, 4($s1)
    func_00111998();  // 111998                                // 0x0014f978: jal 0x111998
    func_00112048();  // 112048                                // 0x0014f980: jal 0x112048
    at = 0x22 << 16;                                            // 0x0014f98c: lui $at, 0x22
    func_00111a58();  // 111a58                                // 0x0014f994: jal 0x111a58
    *(uint16_t*)((s1) + 2) = v0;                                // 0x0014f998: sh $v0, 2($s1)
    func_00111998();  // 111998                                // 0x0014f9a0: jal 0x111998
    func_00112048();  // 112048                                // 0x0014f9a8: jal 0x112048
...
label_0x14f9f8:
    ...
    /* mflo $a0 */                                              // 0x0014fa0c
    func_00111f90();  // 111f90                                // 0x0014fa10: jal 0x111f90
    a0 = a0 + -0x10;                                            // 0x0014fa14: addiu $a0, $a0, -0x10
    at = 0x22 << 16;                                            // 0x0014fa18: lui $at, 0x22
    func_00111a58();  // 111a58                                // 0x0014fa20: jal 0x111a58
    a1 = 0 | 0xff80;                                            // 0x0014fa28: ori $a1, $zero, 0xff80
    func_00111998();  // 111998                                // 0x0014fa30: jal 0x111998
    func_00112048();  // 112048                                // 0x0014fa38: jal 0x112048
...
label_0x14faa8:
    ...
    func_00111f90();  // 111f90                                // 0x0014fac4: jal 0x111f90
    a0 = a0 + -0x10;                                            // 0x0014fac8: addiu $a0, $a0, -0x10
    at = 0x22 << 16;                                            // 0x0014facc: lui $at, 0x22
    func_00111a58();  // 111a58                                // 0x0014fad4: jal 0x111a58
    a1 = 0 | 0xff80;                                            // 0x0014fadc: ori $a1, $zero, 0xff80
    func_00111998();  // 111998                                // 0x0014fae4: jal 0x111998
    func_00112048();  // 112048                                // 0x0014faec: jal 0x112048
