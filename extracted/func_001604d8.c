void func_001604d8() {
    ...
    func_0015fc80();  // 15fc80                                // 0x001604ec: jal 0x15fc80
    if (v0 != 0) goto label_0x160510;                           // 0x001604f4: bnez $v0, 0x160510
    a0 = 0x23 << 16;                                            // 0x001604fc: lui $a0, 0x23
    func_00163410();  // 163410                                // 0x00160500: jal 0x163410
...
label_0x160510:
    func_0015f7e0();  // 15f7e0                                // 0x00160510: jal 0x15f7e0
    /* nop */                                                   // 0x00160514: nop 
    func_001753d0();  // 1753d0                                // 0x0016051c: jal 0x1753d0
    func_0015f870();  // 15f870                                // 0x00160524: jal 0x15f870
    func_0015f8d8();  // 15f8d8                                // 0x00160530: jal 0x15f8d8
    *(uint32_t*)(s1) = v0;                                      // 0x00160534: sw $v0, 0($s1)
    func_0015e138();  // 15e138                                // 0x0016053c: jal 0x15e138
    *(uint32_t*)((s1) + 4) = v0;                                // 0x00160540: sw $v0, 4($s1)
    func_001603d0();  // 1603d0                                // 0x00160548: jal 0x1603d0
