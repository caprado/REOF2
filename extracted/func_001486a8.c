void func_001486a8() {
    ...
    func_001456a8();  // 1456a8                                // 0x001486bc: jal 0x1456a8
    ...
    *(uint32_t*)((s0) + 0x140) = v0;                            // 0x001486e0: sw $v0, 0x140($s0)
    ...
    func_00148530();  // 148530                                // 0x001486ec: jal 0x148530
    a1 = &str_002269c8;  // "_chroma_format needs to be 1: 420" // 0x001486f0: addiu $a1, $a1, 0x69c8
label_0x1486f4:
    func_001456a8();  // 1456a8                                // 0x001486f8: jal 0x1456a8
    ...
    *(uint32_t*)((s0) + 0x14c) = v1;                            // 0x00148718: sw $v1, 0x14c($s0)
    func_001456a8();  // 1456a8                                // 0x0014871c: jal 0x1456a8
    ...
    *(uint32_t*)((s0) + 0x858) = v0;                            // 0x00148728: sw $v0, 0x858($s0)
    func_00144f18();  // 144f18                                // 0x0014872c: jal 0x144f18
    func_00144ee8();  // 144ee8                                // 0x00148738: jal 0x144ee8
    a1 = 0x5000 << 16;                                          // 0x0014873c: lui $a1, 0x5000
    func_00144f18();  // 144f18                                // 0x00148740: jal 0x144f18
    goto label_0x148768;                                        // 0x00148748: b 0x148768
label_0x148750:
    a2 = 0x21 << 16;                                            // 0x00148750: lui $a2, 0x21
    a2 = a2 + 0xd80;                                            // 0x00148758: addiu $a2, $a2, 0xd80
    func_00148b58();  // 148b58                                // 0x0014875c: jal 0x148b58
    a1 = 0x5000 << 16;                                          // 0x00148760: lui $a1, 0x5000
label_0x148768:
    func_001456a8();  // 1456a8                                // 0x00148768: jal 0x1456a8
    ...
    *(uint32_t*)((s0) + 0x85c) = v0;                            // 0x00148774: sw $v0, 0x85c($s0)
    func_00144f18();  // 144f18                                // 0x00148778: jal 0x144f18
    func_00144ee8();  // 144ee8                                // 0x00148784: jal 0x144ee8
    a1 = 0x5800 << 16;                                          // 0x00148788: lui $a1, 0x5800
    func_00144f18();  // 144f18                                // 0x0014878c: jal 0x144f18
    goto label_0x1487b0;                                        // 0x00148794: b 0x1487b0
    /* nop */                                                   // 0x00148798: nop 
label_0x14879c:
    a2 = 0x21 << 16;                                            // 0x0014879c: lui $a2, 0x21
    a2 = a2 + 0xdc0;                                            // 0x001487a4: addiu $a2, $a2, 0xdc0
    func_00148b58();  // 148b58                                // 0x001487a8: jal 0x148b58
    a1 = 0x5800 << 16;                                          // 0x001487ac: lui $a1, 0x5800
label_0x1487b0:
    func_00145ae8();  // 145ae8                                // 0x001487b0: jal 0x145ae8
...
label_0x148898:
    ...
    *(uint32_t*)((fp) + 0x11c) = v0;                            // 0x00148958: sw $v0, 0x11c($fp)
    ...
    func_00148a78();  // 148a78                                // 0x00148984: jal 0x148a78
    local_18 = v0;                                              // 0x00148988: sw $v0, 0x18($sp)
    func_00148688();  // 148688                                // 0x00148994: jal 0x148688
    func_00148688();  // 148688                                // 0x001489a4: jal 0x148688
    func_00148688();  // 148688                                // 0x001489b4: jal 0x148688
    a0 = local_30;                                              // 0x001489bc: lw $a0, 0x30($sp)
    func_00148688();  // 148688                                // 0x001489c4: jal 0x148688
    a0 = local_34;                                              // 0x001489cc: lw $a0, 0x34($sp)
    func_00148688();  // 148688                                // 0x001489d4: jal 0x148688
    a0 = local_38;                                              // 0x001489dc: lw $a0, 0x38($sp)
    func_00148688();  // 148688                                // 0x001489e4: jal 0x148688
    a0 = local_3c;                                              // 0x001489ec: lw $a0, 0x3c($sp)
    func_00148688();  // 148688                                // 0x001489f4: jal 0x148688
    a0 = local_40;                                              // 0x001489fc: lw $a0, 0x40($sp)
    func_00148688();  // 148688                                // 0x00148a04: jal 0x148688
