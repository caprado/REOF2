...
label_0x1d4e04:
    ...
    func_001d4a40();  // 0x1d4140                                // 0x001d4e10: jal 0x1d4140
...
label_0x1d4e2c:
    func_0010af38();  // 0x10ae00                                // 0x001d4e2c: jal 0x10ae00
    /* nop */                                                   // 0x001d4e30: nop 
...
label_0x1d4e44:
    func_0010ae00();  // 0x10ac68                                // 0x001d4e44: jal 0x10ac68
    a1 = 0x24 << 16;                                            // 0x001d4e4c: lui $a1, 0x24
    a0 = sp + 0x80;                                             // 0x001d4e50: addiu $a0, $sp, 0x80
    func_0010a990();  // 0x10a860                                // 0x001d4e54: jal 0x10a860
