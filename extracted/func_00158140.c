void func_00158140() {
    ...
    func_00156058();  // 0x155f90                                // 0x0015815c: jal 0x155f90
    a2 = 0x30;                                                  // 0x00158160: addiu $a2, $zero, 0x30
    *(uint32_t*)(s0) = s1;                                      // 0x00158164: sw $s1, 0($s0)
    func_00157eb8();  // 0x157ea8                                // 0x00158168: jal 0x157ea8
    a0 = s0 + 4;                                                // 0x0015816c: addiu $a0, $s0, 4
    *(uint32_t*)((s0) + 0x10) = s1;                             // 0x00158170: sw $s1, 0x10($s0)
    func_001581d8();  // 0x1581c0                                // 0x00158174: jal 0x1581c0
    a0 = s0 + 0x14;                                             // 0x00158178: addiu $a0, $s0, 0x14
    func_00158200();  // 0x1581d8                                // 0x0015817c: jal 0x1581d8
    a0 = s0 + 0x20;                                             // 0x00158180: addiu $a0, $s0, 0x20
    func_00158200();  // 0x1581d8                                // 0x00158184: jal 0x1581d8
    a0 = s0 + 0x40;                                             // 0x00158188: addiu $a0, $s0, 0x40
    func_00158200();  // 0x1581d8                                // 0x0015818c: jal 0x1581d8
    a0 = s0 + 0x60;                                             // 0x00158190: addiu $a0, $s0, 0x60
    func_00158200();  // 0x1581d8                                // 0x00158194: jal 0x1581d8
    a0 = s0 + 0x80;                                             // 0x00158198: addiu $a0, $s0, 0x80
    func_00158228();  // 0x158200                                // 0x0015819c: jal 0x158200
