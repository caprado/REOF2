void func_001a82b0() {
    ...
    *(uint32_t*)((gp) + -0x63f0) = 0;                           // 0x001a82d4: sw $zero, -0x63f0($gp)
    ...
    func_00108f48();  // 0x108ed8                                // 0x001a830c: jal 0x108ed8
    ...
    func_00107d30();  // 0x107c70                                // 0x001a8320: jal 0x107c70
    ...
    func_0010ae00();  // 0x10ac68                                // 0x001a835c: jal 0x10ac68
    *(uint32_t*)((gp) + -0x63f0) = 0;                           // 0x001a8360: sw $zero, -0x63f0($gp)
    ...
    func_0010ae00();  // 0x10ac68                                // 0x001a8370: jal 0x10ac68
    a1 = a1 + -0x58f0;                                          // 0x001a8374: addiu $a1, $a1, -0x58f0
    a0 = 0x2a << 16;                                            // 0x001a8378: lui $a0, 0x2a
    func_0010ae00();  // 0x10ac68                                // 0x001a8380: jal 0x10ac68
...
label_0x1a8388:
    ...
    func_00108f48();  // 0x108ed8                                // 0x001a8394: jal 0x108ed8
    ...
    func_00107d30();  // 0x107c70                                // 0x001a83a8: jal 0x107c70
    ...
    *(uint32_t*)((gp) + -0x63f0) = v0;                          // 0x001a83e4: sw $v0, -0x63f0($gp)
    func_0010ae00();  // 0x10ac68                                // 0x001a83e8: jal 0x10ac68
    ...
    func_0010ae00();  // 0x10ac68                                // 0x001a83fc: jal 0x10ac68
    a1 = a1 + -0x58c8;                                          // 0x001a8400: addiu $a1, $a1, -0x58c8
    a0 = 0x2a << 16;                                            // 0x001a8404: lui $a0, 0x2a
    func_0010ae00();  // 0x10ac68                                // 0x001a840c: jal 0x10ac68
    a0 = a0 + 0x13c0;                                           // 0x001a8410: addiu $a0, $a0, 0x13c0
label_0x1a8418:
    func_0012b470();  // 0x12b2f8                                // 0x001a8418: jal 0x12b2f8
    /* nop */                                                   // 0x001a841c: nop 
    v0 = 1;                                                     // 0x001a8420: addiu $v0, $zero, 1
    a0 = 2;                                                     // 0x001a8424: addiu $a0, $zero, 2
    func_0012c188();  // 0x12c160                                // 0x001a8428: jal 0x12c160
