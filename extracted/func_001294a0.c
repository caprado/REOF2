void func_001294a0() {
    ...
    func_00128268();  // 0x1281b8                                // 0x001294c4: jal 0x1281b8
    ...
    func_00127de8();  // 0x127d90                                // 0x001294d8: jal 0x127d90
    /* nop */                                                   // 0x001294dc: nop 
...
label_0x129508:
    ...
    func_00127de8();  // 0x127d90                                // 0x00129514: jal 0x127d90
    ...
    /* nop */                                                   // 0x00129524: nop 
label_0x129528:
    func_00130458();  // 0x130408                                // 0x00129528: jal 0x130408
    /* nop */                                                   // 0x0012952c: nop 
    func_001261b8();  // 0x1261a0                                // 0x00129530: jal 0x1261a0
    /* nop */                                                   // 0x00129534: nop 
    func_001302e0();  // 0x1302c8                                // 0x00129538: jal 0x1302c8
    a0 = *(int32_t*)((s0) + 4);                                 // 0x0012953c: lw $a0, 4($s0)
    v1 = *(int32_t*)((s0) + 0x14);                              // 0x00129540: lw $v1, 0x14($s0)
    v0 = v0 - v1;                                               // 0x00129548: subu $v0, $v0, $v1
    func_00129010();  // 0x128fa0                                // 0x0012954c: jal 0x128fa0
    *(uint32_t*)((s0) + 0x20) = v0;                             // 0x00129550: sw $v0, 0x20($s0)
    func_001261d0();  // 0x1261b8                                // 0x00129554: jal 0x1261b8
    *(uint8_t*)((s0) + 1) = s1;                                 // 0x00129558: sb $s1, 1($s0)
    ...
    func_00128268();  // 0x1281b8                                // 0x0012956c: jal 0x1281b8
