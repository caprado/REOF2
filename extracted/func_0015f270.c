void func_0015f270() {
    ...
    func_00112048();  // 0x111f90                                // 0x0015f288: jal 0x111f90
    at = 0x22 << 16;                                            // 0x0015f290: lui $at, 0x22
    func_00111ce0();  // 0x111a58                                // 0x0015f298: jal 0x111a58
    func_001120e8();  // 0x112048                                // 0x0015f2a0: jal 0x112048
    ...
    func_00164400();  // 0x1643e8                                // 0x0015f2e4: jal 0x1643e8
    /* nop */                                                   // 0x0015f2e8: nop 
