...
label_0x194508:
    ...
    func_001899f8();  // 1899f8                                // 0x00194514: jal 0x1899f8
    a2 = 3;                                                     // 0x00194518: addiu $a2, $zero, 3
    a0 = *(int32_t*)((s0) + 0xc);                               // 0x0019451c: lw $a0, 0xc($s0)
    func_001989a0();  // 1989a0                                // 0x00194520: jal 0x1989a0
    ...
    func_001988b0();  // 1988b0                                // 0x00194570: jal 0x1988b0
    a0 = *(int16_t*)(s0);                                       // 0x00194574: lh $a0, 0($s0)
    a0 = *(int16_t*)((s0) + 2);                                 // 0x00194578: lh $a0, 2($s0)
    func_001988d0();  // 1988d0                                // 0x00194580: jal 0x1988d0
...
label_0x194604:
    ...
    func_001988b0();  // 1988b0                                // 0x00194618: jal 0x1988b0
    a0 = *(int16_t*)((s0) + 4);                                 // 0x0019461c: lh $a0, 4($s0)
    a0 = *(int16_t*)((s0) + 6);                                 // 0x00194620: lh $a0, 6($s0)
    func_001988d0();  // 1988d0                                // 0x00194628: jal 0x1988d0
...
label_0x1946ac:
    ...
    func_001988b0();  // 1988b0                                // 0x001946c0: jal 0x1988b0
    a0 = *(int16_t*)((s0) + 8);                                 // 0x001946c4: lh $a0, 8($s0)
    a0 = *(int16_t*)((s0) + 0xa);                               // 0x001946c8: lh $a0, 0xa($s0)
    func_001988d0();  // 1988d0                                // 0x001946d0: jal 0x1988d0
...
label_0x194754:
    ...
    func_00193e90();  // 193e90                                // 0x00194768: jal 0x193e90
