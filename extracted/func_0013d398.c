void func_0013d398() {
    ...
    func_00130408();  // 0x1303a0                                // 0x0013d3c8: jal 0x1303a0
    a0 = *(int32_t*)((s0) + 0x28);                              // 0x0013d3cc: lw $a0, 0x28($s0)
    func_00130220();  // 0x1301e0                                // 0x0013d3d0: jal 0x1301e0
    a0 = *(int32_t*)((s0) + 0x28);                              // 0x0013d3d4: lw $a0, 0x28($s0)
    s2 = *(int32_t*)((s1) + 4);                                 // 0x0013d3d8: lw $s2, 4($s1)
    func_0010af38();  // 0x10ae00                                // 0x0013d3dc: jal 0x10ae00
...
label_0x13d440:
    ...
    func_001301a8();  // 0x130138                                // 0x0013d450: jal 0x130138
    a1 = *(int32_t*)((s1) + 4);                                 // 0x0013d454: lw $a1, 4($s1)
    a0 = *(int32_t*)((s0) + 0x28);                              // 0x0013d458: lw $a0, 0x28($s0)
    func_001304a8();  // 0x130468                                // 0x0013d45c: jal 0x130468
    ...
    *(uint8_t*)((s0) + 2) = 0;                                  // 0x0013d474: sb $zero, 2($s0)
    ...
    func_00130ae8();  // 0x130ad8                                // 0x0013d47c: jal 0x130ad8
    a1 = *(int32_t*)((s0) + 0x14);                              // 0x0013d480: lw $a1, 0x14($s0)
    a0 = *(int32_t*)((s0) + 0x28);                              // 0x0013d484: lw $a0, 0x28($s0)
    func_001302c8();  // 0x130280                                // 0x0013d488: jal 0x130280
    func_00130358();  // 0x130318                                // 0x0013d490: jal 0x130318
