void func_00163a60() {
    ...
    func_0012b2e0();  // 0x12b2d0                                // 0x00163a78: jal 0x12b2d0
    v0 = 1;                                                     // 0x00163a84: addiu $v0, $zero, 1
    if (s2 != v0) goto label_0x163ab0;                          // 0x00163a88: bne $s2, $v0, 0x163ab0
    func_00163b68();  // 0x163b48                                // 0x00163a90: jal 0x163b48
    /* nop */                                                   // 0x00163a94: nop 
    if (v0 != s2) goto label_0x163ac4;                          // 0x00163a98: bne $v0, $s2, 0x163ac4
    func_00163d98();  // 0x163cf8                                // 0x00163aa0: jal 0x163cf8
    /* nop */                                                   // 0x00163aa4: nop 
    goto label_0x163ac4;                                        // 0x00163aa8: b 0x163ac4
label_0x163ab0:
    func_00163ba0();  // 0x163b68                                // 0x00163ab0: jal 0x163b68
    /* nop */                                                   // 0x00163ab4: nop 
    func_00163d98();  // 0x163cf8                                // 0x00163ab8: jal 0x163cf8
label_0x163ac4:
