...
label_0x130880:
    ...
    *(uint8_t*)((s0) + 0x42) = 0;                               // 0x00130890: sb $zero, 0x42($s0)
    func_001359b8();  // 0x135940                                // 0x00130894: jal 0x135940
...
label_0x1308a4:
    func_001413a8();  // 0x141390                                // 0x001308a4: jal 0x141390
    /* nop */                                                   // 0x001308a8: nop 
    ...
    /* nop */                                                   // 0x001308b8: nop 
    func_001413c0();  // 0x1413a8                                // 0x001308bc: jal 0x1413a8
    *(uint8_t*)((s0) + 0x45) = v1;                              // 0x001308c0: sb $v1, 0x45($s0)
    ...
    func_00135718();  // 0x1355f0                                // 0x001308d8: jal 0x1355f0
    ...
    *(uint32_t*)((s0) + 8) = v0;                                // 0x001308e4: sw $v0, 8($s0)
    ...
    func_00127e58();  // 0x127de8                                // 0x001308f0: jal 0x127de8
...
label_0x130910:
    ...
    func_00135a88();  // 0x135a20                                // 0x00130918: jal 0x135a20
    func_00135a20();  // 0x1359b8                                // 0x00130920: jal 0x1359b8
    a0 = *(int32_t*)((s0) + 8);                                 // 0x00130924: lw $a0, 8($s0)
    a0 = *(int32_t*)((s0) + 8);                                 // 0x00130928: lw $a0, 8($s0)
    func_00135a88();  // 0x135a20                                // 0x00130934: jal 0x135a20
...
label_0x130998:
label_0x13099c:
    func_001302c8();  // 0x130280                                // 0x0013099c: jal 0x130280
    goto label_0x1309b8;                                        // 0x001309a4: b 0x1309b8
    *(uint8_t*)((s0) + 0x41) = 0;                               // 0x001309a8: sb $zero, 0x41($s0)
    /* nop */                                                   // 0x001309ac: nop 
label_0x1309b0:
    func_001413c0();  // 0x1413a8                                // 0x001309b0: jal 0x1413a8
    /* nop */                                                   // 0x001309b4: nop 
label_0x1309b8:
...
label_0x1309c8:
    ...
    func_00130838();  // 0x1304c0                                // 0x001309e8: jal 0x1304c0
label_0x1309f0:
label_0x1309f4:
