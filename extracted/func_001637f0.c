void func_001637f0() {
    ...
    func_001643e8();  // 1643e8                                // 0x00163800: jal 0x1643e8
...
label_0x163820:
    ...
    func_00164308();  // 164308                                // 0x00163848: jal 0x164308
    t0 = *(int32_t*)((s0) + 0x124);                             // 0x0016384c: lw $t0, 0x124($s0)
    func_00164380();  // 164380                                // 0x00163850: jal 0x164380
...
label_0x163890:
    func_0015bc68();  // 15bc68                                // 0x00163890: jal 0x15bc68
    /* nop */                                                   // 0x00163894: nop 
