void func_0015dc08() {
    ...
    func_001790b8();  // 0x178fc8                                // 0x0015dc2c: jal 0x178fc8
    ...
    func_00179128();  // 0x1790b8                                // 0x0015dc48: jal 0x1790b8
    ...
    func_00179e80();  // 0x179e18                                // 0x0015dc64: jal 0x179e18
    ...
    *(uint32_t*)((s2) + 4) = v0;                                // 0x0015dc84: sw $v0, 4($s2)
    func_00161250();  // 0x161238                                // 0x0015dc88: jal 0x161238
    a1 = 1;                                                     // 0x0015dc8c: addiu $a1, $zero, 1
    goto label_0x15dca4;                                        // 0x0015dc90: b 0x15dca4
label_0x15dc98:
    func_00161250();  // 0x161238                                // 0x0015dc98: jal 0x161238
label_0x15dca0:
label_0x15dca4:
