void func_00162588() {
    ...
    func_0015fcb0();  // 0x15fc80                                // 0x001625a4: jal 0x15fc80
...
label_0x1625d0:
    func_0013ccc0();  // 0x13cc38                                // 0x001625d0: jal 0x13cc38
    a0 = *(int32_t*)((s0) + 0x4c);                              // 0x001625d4: lw $a0, 0x4c($s0)
    func_00162588();  // 0x1624c8                                // 0x001625e0: jal 0x1624c8
    func_00162378();  // 0x162320                                // 0x001625ec: jal 0x162320
...
label_0x162648:
    ...
    func_001634a8();  // 0x163410                                // 0x00162668: jal 0x163410
...
label_0x162678:
    func_001626e8();  // 0x1626d0                                // 0x00162678: jal 0x1626d0
