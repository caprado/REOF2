void func_0013a770() {
    ...
    func_00107c70();  // 107c70                                // 0x0013a7a8: jal 0x107c70
    ...
    /* nop */                                                   // 0x0013a7bc: nop 
    func_0013a698();  // 13a698                                // 0x0013a7c0: jal 0x13a698
    /* nop */                                                   // 0x0013a7c4: nop 
label_0x13a7c8:
    ...
    /* nop */                                                   // 0x0013a7dc: nop 
label_0x13a7e0:
    func_0013a698();  // 13a698                                // 0x0013a7e0: jal 0x13a698
    /* nop */                                                   // 0x0013a7e4: nop 
label_0x13a7e8:
    ...
    func_00116508();  // 116508                                // 0x0013a80c: jal 0x116508
...
label_0x13a820:
    ...
    func_00116508();  // 116508                                // 0x0013a840: jal 0x116508
...
label_0x13a850:
    ...
    func_00107c70();  // 107c70                                // 0x0013a858: jal 0x107c70
    func_0013a270();  // 13a270                                // 0x0013a864: jal 0x13a270
    ...
    func_00116508();  // 116508                                // 0x0013a88c: jal 0x116508
...
label_0x13a898:
    func_001392b8();  // 1392b8                                // 0x0013a89c: jal 0x1392b8
    ...
    /* mflo $s1 */                                              // 0x0013a8cc
    func_0013a0d8();  // 13a0d8                                // 0x0013a8d4: jal 0x13a0d8
    s1 = s1 << 3;                                               // 0x0013a8d8: sll $s1, $s1, 3
    func_0013a3f8();  // 13a3f8                                // 0x0013a8e0: jal 0x13a3f8
