void func_00137508() {
    ...
    func_001413c0();  // 1413c0                                // 0x00137534: jal 0x1413c0
    ...
    func_00116508();  // 116508                                // 0x0013754c: jal 0x116508
    /* nop */                                                   // 0x00137550: nop 
...
label_0x137560:
    ...
    *(uint32_t*)((s0) + 4) = v1;                                // 0x00137568: sw $v1, 4($s0)
    ...
    func_00116508();  // 116508                                // 0x00137570: jal 0x116508
...
label_0x137584:
    ...
    /* nop */                                                   // 0x001375ec: nop 
    func_001413f0();  // 1413f0                                // 0x001375f0: jal 0x1413f0
    /* nop */                                                   // 0x001375f4: nop 
    func_00137ec8();  // 137ec8                                // 0x001375f8: jal 0x137ec8
    a0 = 0x1400;                                                // 0x001375fc: addiu $a0, $zero, 0x1400
    func_00101b08();  // 101b08                                // 0x00137600: jal 0x101b08
    /* nop */                                                   // 0x00137604: nop 
    a0 = 0x1401;                                                // 0x00137608: addiu $a0, $zero, 0x1401
    func_00137ec8();  // 137ec8                                // 0x0013760c: jal 0x137ec8
    func_00141468();  // 141468                                // 0x00137614: jal 0x141468
    /* nop */                                                   // 0x00137618: nop 
    goto label_0x137648;                                        // 0x0013761c: b 0x137648
    v0 = s0 + 1;                                                // 0x00137620: addiu $v0, $s0, 1
    /* nop */                                                   // 0x00137624: nop 
label_0x137628:
    func_00137ec8();  // 137ec8                                // 0x00137628: jal 0x137ec8
    a0 = 0x1500;                                                // 0x0013762c: addiu $a0, $zero, 0x1500
    func_00101b08();  // 101b08                                // 0x00137630: jal 0x101b08
    /* nop */                                                   // 0x00137634: nop 
    a0 = 0x1501;                                                // 0x00137638: addiu $a0, $zero, 0x1501
    func_00137ec8();  // 137ec8                                // 0x0013763c: jal 0x137ec8
...
label_0x137648:
    ...
    *(uint32_t*)((s1) + 0x34) = s0;                             // 0x0013765c: sw $s0, 0x34($s1)
    ...
    func_00116508();  // 116508                                // 0x00137668: jal 0x116508
