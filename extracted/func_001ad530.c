void func_001ad530() {
    ...
    func_001aacc0();  // 0x1aaca0                                // 0x001ad544: jal 0x1aaca0
...
label_0x1ad560:
    func_001b7a80();  // 0x1b7a70                                // 0x001ad560: jal 0x1b7a70
    /* nop */                                                   // 0x001ad564: nop 
...
label_0x1ad578:
    func_001b7a80();  // 0x1b7a70                                // 0x001ad578: jal 0x1b7a70
    /* nop */                                                   // 0x001ad57c: nop 
...
label_0x1ad598:
    ...
    func_001adab0();  // 0x1ad9c0                                // 0x001ad5b0: jal 0x1ad9c0
    ...
    func_00133240();  // 0x133150                                // 0x001ad5d0: jal 0x133150
    a1 = 3;                                                     // 0x001ad5d4: addiu $a1, $zero, 3
    a0 = *(int32_t*)(s0);                                       // 0x001ad5d8: lw $a0, 0($s0)
    func_00132c40();  // 0x132b10                                // 0x001ad5dc: jal 0x132b10
label_0x1ad5e8:
