void func_00146120() {
    ...
    func_001456a8();  // 1456a8                                // 0x00146130: jal 0x1456a8
    func_001456a8();  // 1456a8                                // 0x0014613c: jal 0x1456a8
    a1 = 8;                                                     // 0x00146140: addiu $a1, $zero, 8
    func_001456a8();  // 1456a8                                // 0x00146148: jal 0x1456a8
    a1 = 1;                                                     // 0x0014614c: addiu $a1, $zero, 1
    func_001456a8();  // 1456a8                                // 0x00146154: jal 0x1456a8
    a1 = 7;                                                     // 0x00146158: addiu $a1, $zero, 7
    func_001456a8();  // 1456a8                                // 0x00146160: jal 0x1456a8
    a1 = 1;                                                     // 0x00146164: addiu $a1, $zero, 1
    func_001456a8();  // 1456a8                                // 0x0014616c: jal 0x1456a8
    a1 = 0x14;                                                  // 0x00146170: addiu $a1, $zero, 0x14
    func_001456a8();  // 1456a8                                // 0x00146178: jal 0x1456a8
    a1 = 1;                                                     // 0x0014617c: addiu $a1, $zero, 1
    func_001456a8();  // 1456a8                                // 0x00146184: jal 0x1456a8
    a1 = 0x16;                                                  // 0x00146188: addiu $a1, $zero, 0x16
    func_001456a8();  // 1456a8                                // 0x00146190: jal 0x1456a8
    ...
    func_00148530();  // 148530                                // 0x001461e4: jal 0x148530
...
label_0x146240:
    ...
    func_00148530();  // 148530                                // 0x00146244: jal 0x148530
label_0x14624c:
    func_001441c0();  // 1441c0                                // 0x0014624c: jal 0x1441c0
