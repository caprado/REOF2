...
label_0x105218:
    ...
    *(uint32_t*)((s1) + 4) = v0;                                // 0x00105230: sw $v0, 4($s1)
    func_00107b68();  // 0x107ab8                                // 0x00105238: jal 0x107ab8
...
label_0x105250:
    ...
    func_0010a1d8();  // 0x10a058                                // 0x0010525c: jal 0x10a058
    ...
    *(uint8_t*)(s4) = 0;                                        // 0x00105270: sb $zero, 0($s4)
    ...
    func_00107a20();  // 0x107940                                // 0x00105294: jal 0x107940
    ...
    *(uint32_t*)((s1) + 4) = v1;                                // 0x001052c8: sw $v1, 4($s1)
    func_00107b68();  // 0x107ab8                                // 0x001052cc: jal 0x107ab8
