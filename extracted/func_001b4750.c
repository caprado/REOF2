void func_001b4750() {
    ...
    thunk_func_0018dab0();  // 18dab0                          // 0x001b476c: jal 0x18dab0
    ...
    *(uint32_t*)((gp) + -0x63a8) = v0;                          // 0x001b4774: sw $v0, -0x63a8($gp)
    ...
    /* nop */                                                   // 0x001b4780: nop 
label_0x1b4784:
    func_0018db00();  // 18db00                                // 0x001b4784: jal 0x18db00
    /* nop */                                                   // 0x001b4788: nop 
...
label_0x1b47a8:
    ...
    func_001d3390();  // 1d3390                                // 0x001b47b4: jal 0x1d3390
    ...
    func_001b4a80();  // 1b4a80                                // 0x001b47d8: jal 0x1b4a80
