...
label_0x1a606c:
    func_00112048();  // 0x111f90                                // 0x001a606c: jal 0x111f90
    a0 = -v1;                                                   // 0x001a6070: negu $a0, $v1
    func_00112048();  // 0x111f90                                // 0x001a6078: jal 0x111f90
    func_00122368();  // 0x122350                                // 0x001a6084: jal 0x122350
    func_00112170();  // 0x112118                                // 0x001a608c: jal 0x112118
...
label_0x1a60b0:
    ...
    *(uint16_t*)((s1) + 6) = v0;                                // 0x001a60d8: sh $v0, 6($s1)
    ...
    func_00112048();  // 0x111f90                                // 0x001a60e4: jal 0x111f90
    func_00112048();  // 0x111f90                                // 0x001a60f0: jal 0x111f90
    func_001119f0();  // 0x111998                                // 0x001a60fc: jal 0x111998
    func_001223c8();  // 0x122380                                // 0x001a6104: jal 0x122380
    func_001120e8();  // 0x112048                                // 0x001a610c: jal 0x112048
