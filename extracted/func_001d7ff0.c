void func_001d7ff0() {
    ...
    func_001d3c30();  // 0x1d3c20                                // 0x001d8004: jal 0x1d3c20
    a0 = 0x15;                                                  // 0x001d800c: addiu $a0, $zero, 0x15
    func_001aefe0();  // 0x1aefd0                                // 0x001d8010: jal 0x1aefd0
    a1 = 2;                                                     // 0x001d8014: addiu $a1, $zero, 2
    a0 = 1;                                                     // 0x001d8018: addiu $a0, $zero, 1
    func_001aefe0();  // 0x1aefd0                                // 0x001d801c: jal 0x1aefd0
    a0 = 0x12;                                                  // 0x001d8024: addiu $a0, $zero, 0x12
    func_001aefe0();  // 0x1aefd0                                // 0x001d8028: jal 0x1aefd0
    a0 = 0x62;                                                  // 0x001d8030: addiu $a0, $zero, 0x62
    func_001aefe0();  // 0x1aefd0                                // 0x001d8034: jal 0x1aefd0
    a1 = 1;                                                     // 0x001d8038: addiu $a1, $zero, 1
    a0 = 0xc;                                                   // 0x001d803c: addiu $a0, $zero, 0xc
    func_001aefe0();  // 0x1aefd0                                // 0x001d8040: jal 0x1aefd0
    a0 = 0x66;                                                  // 0x001d8048: addiu $a0, $zero, 0x66
    func_001aefe0();  // 0x1aefd0                                // 0x001d804c: jal 0x1aefd0
    a0 = 2;                                                     // 0x001d8054: addiu $a0, $zero, 2
    func_001aefe0();  // 0x1aefd0                                // 0x001d8058: jal 0x1aefd0
    a0 = 0x12;                                                  // 0x001d8060: addiu $a0, $zero, 0x12
    func_001aefe0();  // 0x1aefd0                                // 0x001d8064: jal 0x1aefd0
    func_001aefe0();  // 0x1aefd0                                // 0x001d8070: jal 0x1aefd0
    a0 = sp + 0x60;                                             // 0x001d8078: addiu $a0, $sp, 0x60
    func_00107d30();  // 0x107c70                                // 0x001d8080: jal 0x107c70
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001d809c: jal 0x10a4d8
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001d80b0: jal 0x10a4d8
    ...
    func_001b28a0();  // 0x1b2780                                // 0x001d80d0: jal 0x1b2780
    ...
    *(uint32_t*)((s2) + 0x1c) = v0;                             // 0x001d8114: sw $v0, 0x1c($s2)
    ...
    func_001d4f30();  // 0x1d4db0                                // 0x001d8130: jal 0x1d4db0
...
label_0x1d8170:
    ...
    func_001d33e0();  // 0x1d3390                                // 0x001d817c: jal 0x1d3390
