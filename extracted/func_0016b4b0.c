void func_0016b4b0() {
    ...
    func_0016b5e8();  // 0x16b578                                // 0x0016b4d0: jal 0x16b578
    *(uint32_t*)((s1) + 0x1aec) = s2;                           // 0x0016b4d4: sw $s2, 0x1aec($s1)
    func_001580e8();  // 0x1580b0                                // 0x0016b4d8: jal 0x1580b0
    /* nop */                                                   // 0x0016b4dc: nop 
