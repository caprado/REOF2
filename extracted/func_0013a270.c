void func_0013a270() {
    ...
    *(uint8_t*)((v0) + 4) = a2;                                 // 0x0013a2b4: sb $a2, 4($v0)
    func_0010a860();  // 0x10a788                                // 0x0013a2b8: jal 0x10a788
...
label_0x13a310:
    ...
    /* nop */                                                   // 0x0013a34c: nop 
label_0x13a350:
    func_00137fb0();  // 0x137ec8                                // 0x0013a350: jal 0x137ec8
