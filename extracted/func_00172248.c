...
label_0x172268:
    ...
    func_001723b8();  // 0x1722a0                                // 0x00172274: jal 0x1722a0
    /* nop */                                                   // 0x00172278: nop 
label_0x17227c:
    ...
    *(uint32_t*)((s1) + 0x44) = 0;                              // 0x001722d8: sw $zero, 0x44($s1)
    func_0017e658();  // 0x17e530                                // 0x001722dc: jal 0x17e530
    /* nop */                                                   // 0x001722e0: nop 
    ...
    func_001723e0();  // 0x1723b8                                // 0x001722f8: jal 0x1723b8
    ...
    *(uint32_t*)((s1) + 0x48) = s0;                             // 0x0017230c: sw $s0, 0x48($s1)
    ...
    /* nop */                                                   // 0x00172324: nop 
    func_00172428();  // 0x1723f8                                // 0x00172328: jal 0x1723f8
    goto label_0x172374;                                        // 0x00172330: b 0x172374
    func_001724e8();  // 0x172428                                // 0x00172338: jal 0x172428
    goto label_0x172374;                                        // 0x00172340: b 0x172374
    func_00172828();  // 0x172788                                // 0x00172348: jal 0x172788
    goto label_0x172374;                                        // 0x00172350: b 0x172374
    func_00172898();  // 0x172828                                // 0x00172358: jal 0x172828
    goto label_0x172374;                                        // 0x00172360: b 0x172374
    func_001728a0();  // 0x172898                                // 0x00172368: jal 0x172898
label_0x172374:
    *(uint32_t*)((s1) + 0x48) = s0;                             // 0x00172374: sw $s0, 0x48($s1)
    func_0017e658();  // 0x17e530                                // 0x00172378: jal 0x17e530
