...
label_0x194028:
    ...
    func_00189ad0();  // 0x1899f8                                // 0x00194034: jal 0x1899f8
    a2 = 3;                                                     // 0x00194038: addiu $a2, $zero, 3
    a0 = *(int32_t*)((s0) + 8);                                 // 0x0019403c: lw $a0, 8($s0)
    func_00198aa0();  // 0x1989a0                                // 0x00194040: jal 0x1989a0
    ...
    func_001988d0();  // 0x1988b0                                // 0x00194090: jal 0x1988b0
    a0 = *(int16_t*)(s0);                                       // 0x00194094: lh $a0, 0($s0)
    a0 = *(int16_t*)((s0) + 2);                                 // 0x00194098: lh $a0, 2($s0)
    func_00198910();  // 0x1988d0                                // 0x001940a0: jal 0x1988d0
    ...
    func_00194000();  // 0x193f40                                // 0x001940d0: jal 0x193f40
...
label_0x194160:
    ...
    func_001988d0();  // 0x1988b0                                // 0x00194174: jal 0x1988b0
    a0 = *(int16_t*)((s0) + 4);                                 // 0x00194178: lh $a0, 4($s0)
    a0 = *(int16_t*)((s0) + 6);                                 // 0x0019417c: lh $a0, 6($s0)
    func_00198910();  // 0x1988d0                                // 0x00194184: jal 0x1988d0
    ...
    func_00194000();  // 0x193f40                                // 0x001941b4: jal 0x193f40
...
label_0x194244:
    ...
    func_00193f40();  // 0x193e90                                // 0x00194258: jal 0x193e90
