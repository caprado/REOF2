void func_00180198() {
    ...
    /* nop */                                                   // 0x001801e0: nop 
    func_001805d8();  // 1805d8                                // 0x001801e4: jal 0x1805d8
    if (v0 < 0) goto label_0x180254;                            // 0x001801ec: bltz $v0, 0x180254
    v0 = -1;                                                    // 0x001801f0: addiu $v0, $zero, -1
label_0x1801f4:
    func_00180630();  // 180630                                // 0x001801f4: jal 0x180630
    ...
    func_00107ab8();  // 107ab8                                // 0x00180218: jal 0x107ab8
    ...
    func_00180760();  // 180760                                // 0x0018023c: jal 0x180760
