void func_00129658() {
    ...
    func_00130278();  // 130278                                // 0x00129680: jal 0x130278
    a0 = *(int32_t*)((s0) + 4);                                 // 0x00129684: lw $a0, 4($s0)
    a0 = *(int32_t*)((s0) + 4);                                 // 0x00129688: lw $a0, 4($s0)
    func_001302c8();  // 1302c8                                // 0x0012968c: jal 0x1302c8
    ...
    *(uint32_t*)((s0) + 0x20) = v0;                             // 0x001296b4: sw $v0, 0x20($s0)
    func_00128fa0();  // 128fa0                                // 0x001296b8: jal 0x128fa0
