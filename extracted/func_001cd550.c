void func_001cd550() {
    ...
    func_001ce6c0();  // 1ce6c0                                // 0x001cd570: jal 0x1ce6c0
...
label_0x1cd588:
    thunk_func_001ce800();  // 1ce800                          // 0x001cd588: jal 0x1ce800
    ...
    func_001ce6f0();  // 1ce6f0                                // 0x001cd5a8: jal 0x1ce6f0
    ...
    *(uint32_t*)(s2) = v0;                                      // 0x001cd5b4: sw $v0, 0($s2)
    ...
    thunk_func_001ce8a0();  // 1ce8a0                          // 0x001cd5bc: jal 0x1ce8a0
label_0x1cd5c8:
