...
label_0x1aa780:
    ...
    func_001aeef0();  // 0x1aee20                                // 0x001aa788: jal 0x1aee20
    a1 = *(int32_t*)(s2);                                       // 0x001aa790: lw $a1, 0($s2)
    func_001d3a90();  // 0x1d3a30                                // 0x001aa794: jal 0x1d3a30
...
label_0x1aa7dc:
    func_0018db40();  // 0x18db10                                // 0x001aa7dc: jal 0x18db10
    /* nop */                                                   // 0x001aa7e0: nop 
