void func_0012e8b0() {
    ...
    func_0012e3c8();  // 0x12e258                                // 0x0012e910: jal 0x12e258
    ...
    func_00107d30();  // 0x107c70                                // 0x0012e95c: jal 0x107c70
...
label_0x12e98c:
    ...
    *(uint32_t*)((s0) + 0x30) = v0;                             // 0x0012e998: sw $v0, 0x30($s0)
    ...
    /* nop */                                                   // 0x0012e9bc: nop 
label_0x12e9c0:
    func_0012e628();  // 0x12e3c8                                // 0x0012e9c0: jal 0x12e3c8
    ...
    *(uint16_t*)(s3) = v0;                                      // 0x0012e9e8: sh $v0, 0($s3)
    ...
    func_0012dec8();  // 0x12deb0                                // 0x0012e9f4: jal 0x12deb0
    ...
    *(uint16_t*)(a2) = v1;                                      // 0x0012ea18: sh $v1, 0($a2)
    ...
    func_0012e8b0();  // 0x12e628                                // 0x0012ea20: jal 0x12e628
