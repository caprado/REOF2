...
label_0x12a478:
    func_00131af8();  // 0x131a58                                // 0x0012a478: jal 0x131a58
    /* nop */                                                   // 0x0012a47c: nop 
    func_001261b8();  // 0x1261a0                                // 0x0012a480: jal 0x1261a0
    /* nop */                                                   // 0x0012a484: nop 
    a1 = *(int32_t*)((s0) + 0x10);                              // 0x0012a488: lw $a1, 0x10($s0)
    func_00131910();  // 0x131820                                // 0x0012a48c: jal 0x131820
    ...
    *(uint8_t*)((s0) + 2) = v1;                                 // 0x0012a4b4: sb $v1, 2($s0)
    func_0013d080();  // 0x13d018                                // 0x0012a4b8: jal 0x13d018
    a1 = a1 << 0xb;                                             // 0x0012a4bc: sll $a1, $a1, 0xb
    func_001261d0();  // 0x1261b8                                // 0x0012a4c0: jal 0x1261b8
    /* nop */                                                   // 0x0012a4c4: nop 
    func_0013cc38();  // 0x13cbd0                                // 0x0012a4c8: jal 0x13cbd0
