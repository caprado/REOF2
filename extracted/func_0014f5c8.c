void func_0014f5c8() {
    ...
    func_00148f00();  // 148f00                                // 0x0014f604: jal 0x148f00
...
label_0x14f628:
    ...
    func_00111f90();  // 111f90                                // 0x0014f62c: jal 0x111f90
    ...
    func_00111a58();  // 111a58                                // 0x0014f64c: jal 0x111a58
    s1 = s0 + v0;                                               // 0x0014f650: addu $s1, $s0, $v0
    func_00111998();  // 111998                                // 0x0014f65c: jal 0x111998
    s0 = s0 + s7;                                               // 0x0014f660: addu $s0, $s0, $s7
    func_00112048();  // 112048                                // 0x0014f668: jal 0x112048
    /* nop */                                                   // 0x0014f66c: nop 
    ...
    *(uint16_t*)((s0) + 4) = v0;                                // 0x0014f684: sh $v0, 4($s0)
    func_00111f90();  // 111f90                                // 0x0014f688: jal 0x111f90
    *(uint16_t*)((s0) + 2) = v0;                                // 0x0014f68c: sh $v0, 2($s0)
    at = 0x22 << 16;                                            // 0x0014f690: lui $at, 0x22
    func_00111a58();  // 111a58                                // 0x0014f69c: jal 0x111a58
    func_00111998();  // 111998                                // 0x0014f6a8: jal 0x111998
    func_00112048();  // 112048                                // 0x0014f6b0: jal 0x112048
    at = 0x22 << 16;                                            // 0x0014f6bc: lui $at, 0x22
    func_00111a58();  // 111a58                                // 0x0014f6c4: jal 0x111a58
    *(uint16_t*)((s1) + 4) = v0;                                // 0x0014f6c8: sh $v0, 4($s1)
    func_00111998();  // 111998                                // 0x0014f6d0: jal 0x111998
    func_00112048();  // 112048                                // 0x0014f6d8: jal 0x112048
    ...
    *(uint16_t*)((s1) + 6) = 0;                                 // 0x0014f6ec: sh $zero, 6($s1)
    ...
    func_00111a58();  // 111a58                                // 0x0014f6f8: jal 0x111a58
    *(uint16_t*)((s2) + 4) = 0;                                 // 0x0014f6fc: sh $zero, 4($s2)
    func_00111998();  // 111998                                // 0x0014f704: jal 0x111998
    func_00112048();  // 112048                                // 0x0014f70c: jal 0x112048
    at = 0x22 << 16;                                            // 0x0014f718: lui $at, 0x22
    func_00111a58();  // 111a58                                // 0x0014f720: jal 0x111a58
    *(uint16_t*)((s2) + 2) = v0;                                // 0x0014f724: sh $v0, 2($s2)
    func_00111998();  // 111998                                // 0x0014f72c: jal 0x111998
    func_00112048();  // 112048                                // 0x0014f734: jal 0x112048
    ...
    *(uint16_t*)(s2) = v0;                                      // 0x0014f748: sh $v0, 0($s2)
    func_00111f90();  // 111f90                                // 0x0014f750: jal 0x111f90
    s1 = s5 - s6;                                               // 0x0014f754: subu $s1, $s5, $s6
    func_00111f90();  // 111f90                                // 0x0014f75c: jal 0x111f90
    func_00111ce0();  // 111ce0                                // 0x0014f768: jal 0x111ce0
...
label_0x14f7c0:
    func_00111f90();  // 111f90                                // 0x0014f7c0: jal 0x111f90
    a0 = s5 - s1;                                               // 0x0014f7c4: subu $a0, $s5, $s1
    func_00111a58();  // 111a58                                // 0x0014f7cc: jal 0x111a58
    func_00112048();  // 112048                                // 0x0014f7d4: jal 0x112048
...
label_0x14f830:
    func_00111f90();  // 111f90                                // 0x0014f830: jal 0x111f90
    a0 = s3 - s6;                                               // 0x0014f834: subu $a0, $s3, $s6
    func_00111a58();  // 111a58                                // 0x0014f83c: jal 0x111a58
    func_00112048();  // 112048                                // 0x0014f844: jal 0x112048
