void func_001d9ea0() {
    ...
    func_001a2780();  // 0x1a2740                                // 0x001d9ecc: jal 0x1a2740
    ...
    func_0018fbd0();  // 0x18fba0                                // 0x001d9ee8: jal 0x18fba0
    s1 = v1 + v0;                                               // 0x001d9eec: addu $s1, $v1, $v0
    a0 = sp + 0xa0;                                             // 0x001d9ef4: addiu $a0, $sp, 0xa0
    thunk_func_001a1c30();  // 0x1da600                          // 0x001d9efc: jal 0x1da600
    func_001922b0();  // 0x192230                                // 0x001d9f04: jal 0x192230
    a0 = sp + 0xa0;                                             // 0x001d9f08: addiu $a0, $sp, 0xa0
    *(uint32_t*)((s4) + 0x80c) = v0;                            // 0x001d9f0c: sw $v0, 0x80c($s4)
    func_001b0e80();  // 0x1b0e30                                // 0x001d9f10: jal 0x1b0e30
    a0 = *(int32_t*)((s4) + 0x80c);                             // 0x001d9f14: lw $a0, 0x80c($s4)
    a1 = *(int32_t*)((s4) + 0x80c);                             // 0x001d9f18: lw $a1, 0x80c($s4)
    func_00193540();  // 0x193400                                // 0x001d9f1c: jal 0x193400
    func_001930f0();  // 0x1930d0                                // 0x001d9f28: jal 0x1930d0
...
label_0x1d9f7c:
    ...
    /* nop */                                                   // 0x001d9f84: nop 
    func_00192350();  // 0x192330                                // 0x001d9f88: jal 0x192330
    a0 = *(int32_t*)((s4) + 0x80c);                             // 0x001d9f8c: lw $a0, 0x80c($s4)
    func_001b0ec0();  // 0x1b0e80                                // 0x001d9f90: jal 0x1b0e80
