void func_00133530() {
    ...
    func_0012d540();  // 0x12d528                                // 0x00133554: jal 0x12d528
    func_0012d570();  // 0x12d540                                // 0x00133560: jal 0x12d540
    func_0012d588();  // 0x12d570                                // 0x0013356c: jal 0x12d570
    func_0012d710();  // 0x12d6f8                                // 0x00133578: jal 0x12d6f8
    s0 = s0 - s3;                                               // 0x00133580: subu $s0, $s0, $s3
    func_0012d428();  // 0x12d418                                // 0x00133588: jal 0x12d418
    *(uint32_t*)((s2) + 0x90) = s0;                             // 0x00133590: sw $s0, 0x90($s2)
    func_0012d418();  // 0x12d408                                // 0x00133598: jal 0x12d408
    func_0012d438();  // 0x12d428                                // 0x001335a4: jal 0x12d428
    func_0012d3b8();  // 0x12d3a8                                // 0x001335b0: jal 0x12d3a8
    ...
    func_0012d540();  // 0x12d528                                // 0x00133614: jal 0x12d528
    func_0012d570();  // 0x12d540                                // 0x00133620: jal 0x12d540
    func_0012d588();  // 0x12d570                                // 0x0013362c: jal 0x12d570
    ...
    func_0012d418();  // 0x12d408                                // 0x0013365c: jal 0x12d408
...
label_0x133670:
    ...
    func_00127de8();  // 0x127d90                                // 0x00133698: jal 0x127d90
    /* nop */                                                   // 0x0013369c: nop 
label_0x1336a0:
    ...
    func_0012d428();  // 0x12d418                                // 0x001336bc: jal 0x12d418
    a1 = s4 - s3;                                               // 0x001336c4: subu $a1, $s4, $s3
    *(uint32_t*)((s1) + 0x90) = a1;                             // 0x001336c8: sw $a1, 0x90($s1)
    func_0012d418();  // 0x12d408                                // 0x001336cc: jal 0x12d408
    func_0012d438();  // 0x12d428                                // 0x001336d8: jal 0x12d428
    func_0012d3b8();  // 0x12d3a8                                // 0x001336e4: jal 0x12d3a8
...
label_0x133740:
    func_0012d748();  // 0x12d710                                // 0x00133740: jal 0x12d710
