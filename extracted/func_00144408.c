void func_00144408() {
    ...
    func_00144408();  // 0x1442d8                                // 0x00144438: jal 0x1442d8
...
label_0x144450:
    ...
    func_00143f08();  // 0x143c70                                // 0x00144478: jal 0x143c70
    *(uint32_t*)((v0) + 0x6e4) = 0;                             // 0x0014447c: sw $zero, 0x6e4($v0)
    ...
    func_00145598();  // 0x145478                                // 0x001444a8: jal 0x145478
...
label_0x1444d0:
    func_001441c0();  // 0x1440b0                                // 0x001444d0: jal 0x1440b0
...
label_0x1444e8:
    ...
    func_00148588();  // 0x148530                                // 0x001444fc: jal 0x148530
...
label_0x14450c:
    ...
    func_00144b70();  // 0x1446c8                                // 0x00144534: jal 0x1446c8
...
label_0x144550:
    ...
    func_001446c8();  // 0x144608                                // 0x00144560: jal 0x144608
...
label_0x144574:
    ...
    func_00142150();  // 0x141f00                                // 0x0014458c: jal 0x141f00
...
label_0x1445a8:
    ...
    func_00143c48();  // 0x142c78                                // 0x001445b8: jal 0x142c78
