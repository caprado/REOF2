void func_001696c0() {
    ...
    func_00169b10();  // 169b10                                // 0x001696ec: jal 0x169b10
    g_002157ac = a0;  // Global at 0x002157ac                   // 0x001696f0: sw $a0, 0x57ac($a1)
    func_00169728();  // 169728                                // 0x001696f4: jal 0x169728
    /* bnezl $v0, 0x16971c */                                   // 0x001696fc: bnezl $v0, 0x16971c
    func_00169b40();  // 169b40                                // 0x00169704: jal 0x169b40
    /* nop */                                                   // 0x00169708: nop 
    func_00169b78();  // 169b78                                // 0x0016970c: jal 0x169b78
    /* nop */                                                   // 0x00169710: nop 
