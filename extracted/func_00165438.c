...
label_0x1654b8:
    ...
    func_0013f658();  // 0x13f568                                // 0x001654c0: jal 0x13f568
...
label_0x165528:
    ...
    *(uint32_t*)((t0) + 0xc) = t3;                              // 0x0016554c: sw $t3, 0xc($t0)
    func_00131a58();  // 0x1319d8                                // 0x00165550: jal 0x1319d8
    *(uint32_t*)((t0) + 0x10) = a2;                             // 0x00165554: sw $a2, 0x10($t0)
    func_00165c00();  // 0x165bb0                                // 0x0016555c: jal 0x165bb0
    a1 = 1;                                                     // 0x00165560: addiu $a1, $zero, 1
    func_001658c8();  // 0x1657c8                                // 0x00165564: jal 0x1657c8
label_0x165570:
