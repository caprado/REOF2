...
void func_001ba660() {
    ...
    func_001a8a90();  // 1a8a90                                // 0x001ba668: jal 0x1a8a90
    func_001b07d0();  // 1b07d0                                // 0x001ba670: jal 0x1b07d0
    *(uint16_t*)((gp) + -0x633c) = 0;                           // 0x001ba674: sh $zero, -0x633c($gp)
    func_001ae540();  // 1ae540                                // 0x001ba678: jal 0x1ae540
    /* nop */                                                   // 0x001ba67c: nop 
    func_001af180();  // 1af180                                // 0x001ba680: jal 0x1af180
    *(uint16_t*)((gp) + -0x634c) = 0;                           // 0x001ba684: sh $zero, -0x634c($gp)
    thunk_func_001aefe0();  // 1aefe0                          // 0x001ba688: jal 0x1aefe0
    a0 = 1;                                                     // 0x001ba68c: addiu $a0, $zero, 1
    func_001af020();  // 1af020                                // 0x001ba690: jal 0x1af020
    a0 = gp + -0x6380;                                          // 0x001ba694: addiu $a0, $gp, -0x6380
    func_001aef60();  // 1aef60                                // 0x001ba698: jal 0x1aef60
    ...
    func_00107c70();  // 107c70                                // 0x001ba6b4: jal 0x107c70
    ...
    func_001af190();  // 1af190                                // 0x001ba6e0: jal 0x1af190
    a0 = g_003137f8;  // Global at 0x003137f8                   // 0x001ba6e4: lw $a0, 0x37f8($at)
    v0 = 3 << 16;                                               // 0x001ba6e8: lui $v0, 3
    func_001af1f0();  // 1af1f0                                // 0x001ba6ec: jal 0x1af1f0
    ...
    func_001af1f0();  // 1af1f0                                // 0x001ba770: jal 0x1af1f0
    ...
    func_001af1f0();  // 1af1f0                                // 0x001ba780: jal 0x1af1f0
    ...
    func_001af1f0();  // 1af1f0                                // 0x001ba790: jal 0x1af1f0
    ...
    func_001af1f0();  // 1af1f0                                // 0x001ba7c4: jal 0x1af1f0
    ...
    func_001af1f0();  // 1af1f0                                // 0x001ba7d4: jal 0x1af1f0
    ...
    func_001af1f0();  // 1af1f0                                // 0x001ba7e4: jal 0x1af1f0
    ...
    func_001af1f0();  // 1af1f0                                // 0x001ba804: jal 0x1af1f0
    ...
    func_00106ee8();  // 106ee8                                // 0x001ba868: jal 0x106ee8
    ...
    func_001ae830();  // 1ae830                                // 0x001ba880: jal 0x1ae830
    g_00313850 = v0;  // Global at 0x00313850                   // 0x001ba884: sw $v0, 0x3850($at)
    func_001baa30();  // 1baa30                                // 0x001ba888: jal 0x1baa30
    /* nop */                                                   // 0x001ba88c: nop 
    func_001dd790();  // 1dd790                                // 0x001ba890: jal 0x1dd790
    /* nop */                                                   // 0x001ba894: nop 
    func_001ac0c0();  // 1ac0c0                                // 0x001ba898: jal 0x1ac0c0
    /* nop */                                                   // 0x001ba89c: nop 
