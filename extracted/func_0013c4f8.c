void func_0013c4f8() {
    ...
    func_00107c70();  // 107c70                                // 0x0013c534: jal 0x107c70
    ...
    /* nop */                                                   // 0x0013c548: nop 
    func_0013c480();  // 13c480                                // 0x0013c54c: jal 0x13c480
    /* nop */                                                   // 0x0013c550: nop 
label_0x13c554:
    func_0013c250();  // 13c250                                // 0x0013c554: jal 0x13c250
    /* nop */                                                   // 0x0013c558: nop 
    ...
    func_00116508();  // 116508                                // 0x0013c580: jal 0x116508
...
label_0x13c590:
    ...
    func_00116508();  // 116508                                // 0x0013c5b0: jal 0x116508
    a0 = &str_00225af8;  // "HTCI: Can't read filelist file.(%s)\n" // 0x0013c5b4: addiu $a0, $a0, 0x5af8
    goto label_0x13c660;                                        // 0x0013c5b8: b 0x13c660
label_0x13c5c0:
    func_00107c70();  // 107c70                                // 0x0013c5c4: jal 0x107c70
    func_0013bf00();  // 13bf00                                // 0x0013c5d0: jal 0x13bf00
    ...
    func_00116508();  // 116508                                // 0x0013c5f8: jal 0x116508
...
label_0x13c604:
    func_0013ac88();  // 13ac88                                // 0x0013c608: jal 0x13ac88
    ...
    /* mflo $s1 */                                              // 0x0013c634
    func_0013bd60();  // 13bd60                                // 0x0013c63c: jal 0x13bd60
    s1 = s1 << 3;                                               // 0x0013c640: sll $s1, $s1, 3
    func_0013c060();  // 13c060                                // 0x0013c648: jal 0x13c060
