void func_001d61c0() {
    ...
    func_001d96b0();  // 0x1d9490                                // 0x001d61ec: jal 0x1d9490
    func_001b29f0();  // 0x1b29e0                                // 0x001d61f4: jal 0x1b29e0
    a2 = s2 & 0xff;                                             // 0x001d61fc: andi $a2, $s2, 0xff
    func_001d98d0();  // 0x1d96b0                                // 0x001d6204: jal 0x1d96b0
...
label_0x1d621c:
    ...
    func_001d4db0();  // 0x1d4c80                                // 0x001d6224: jal 0x1d4c80
