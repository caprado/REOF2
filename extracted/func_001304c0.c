void func_001304c0() {
    ...
    func_00135c78();  // 0x135c10                                // 0x001304e8: jal 0x135c10
    s4 = *(int32_t*)((s3) + 4);                                 // 0x001304ec: lw $s4, 4($s3)
    func_001413a8();  // 0x141390                                // 0x001304f0: jal 0x141390
    ...
    *(uint8_t*)((s3) + 2) = 0;                                  // 0x0013050c: sb $zero, 2($s3)
    func_001413c0();  // 0x1413a8                                // 0x00130510: jal 0x1413a8
    ...
    func_00140598();  // 0x1404a0                                // 0x00130530: jal 0x1404a0
...
label_0x130620:
    ...
    *(uint8_t*)((s3) + 2) = 0;                                  // 0x00130628: sb $zero, 2($s3)
    func_001413c0();  // 0x1413a8                                // 0x0013062c: jal 0x1413a8
...
label_0x130658:
    func_001413c0();  // 0x1413a8                                // 0x00130658: jal 0x1413a8
    /* nop */                                                   // 0x0013065c: nop 
    goto label_0x13081c;                                        // 0x00130660: b 0x13081c
label_0x130668:
    *(uint32_t*)((s3) + 0x20) = 0;                              // 0x00130668: sw $zero, 0x20($s3)
    func_001413c0();  // 0x1413a8                                // 0x0013066c: jal 0x1413a8
...
label_0x1306bc:
    func_001304c0();  // 0x1304a8                                // 0x001306bc: jal 0x1304a8
    ...
    *(uint8_t*)((s3) + 2) = 0;                                  // 0x001306f8: sb $zero, 2($s3)
    ...
    func_00135a88();  // 0x135a20                                // 0x00130778: jal 0x135a20
    if (v1 != 0) s0 = v0;                                       // 0x0013077c: movn $s0, $v0, $v1
    a2 = local_10;                                              // 0x00130780: lw $a2, 0x10($sp)
    func_00135af0();  // 0x135a88                                // 0x00130788: jal 0x135a88
    ...
    *(uint8_t*)((s3) + 2) = 0;                                  // 0x001307cc: sb $zero, 2($s3)
    func_00135c78();  // 0x135c10                                // 0x001307d0: jal 0x135c10
