void func_001650a8() {
    ...
    func_00131bb8();  // 131bb8                                // 0x001650dc: jal 0x131bb8
    func_001329b0();  // 1329b0                                // 0x001650e8: jal 0x1329b0
...
label_0x165100:
    func_001752e8();  // 1752e8                                // 0x00165104: jal 0x1752e8
...
label_0x165148:
    ...
    func_001698d0();  // 1698d0                                // 0x0016514c: jal 0x1698d0
...
label_0x165160:
    ...
    func_001698d0();  // 1698d0                                // 0x00165164: jal 0x1698d0
...
label_0x165178:
    ...
    func_001698d0();  // 1698d0                                // 0x00165180: jal 0x1698d0
...
label_0x16518c:
    ...
    func_00177b10();  // 177b10                                // 0x0016519c: jal 0x177b10
    ...
    /* nop */                                                   // 0x001651b4: nop 
label_0x1651b8:
    func_001652d0();  // 1652d0                                // 0x001651b8: jal 0x1652d0
    a1 = 1;                                                     // 0x001651bc: addiu $a1, $zero, 1
label_0x1651c0:
    func_001652a0();  // 1652a0                                // 0x001651c0: jal 0x1652a0
