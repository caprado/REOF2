void func_001a94a0() {
    ...
    func_0010ae00();  // 0x10ac68                                // 0x001a94cc: jal 0x10ac68
    ...
    func_001aac80();  // 0x1aaa00                                // 0x001a94e8: jal 0x1aaa00
    a2 = sp + 0x170;                                            // 0x001a94ec: addiu $a2, $sp, 0x170
    goto label_0x1a963c;                                        // 0x001a94f0: b 0x1a963c
label_0x1a94f8:
    func_0010caa0();  // 0x10ca50                                // 0x001a94f8: jal 0x10ca50
    /* nop */                                                   // 0x001a94fc: nop 
    a0 = sp + 0x170;                                            // 0x001a9500: addiu $a0, $sp, 0x170
    func_0010b4b0();  // 0x10b460                                // 0x001a9504: jal 0x10b460
