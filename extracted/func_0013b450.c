void func_0013b450() {
    ...
    *(uint8_t*)(s1) = 0;                                        // 0x0013b4bc: sb $zero, 0($s1)
    ...
    func_00116598();  // 0x116508                                // 0x0013b4c4: jal 0x116508
