void func_0015f8d8() {
    ...
    func_0015fcb0();  // 0x15fc80                                // 0x0015f8e4: jal 0x15fc80
    if (v0 != 0) goto label_0x15f908;                           // 0x0015f8ec: bnez $v0, 0x15f908
    a0 = 0x22 << 16;                                            // 0x0015f8f4: lui $a0, 0x22
    func_001634a8();  // 0x163410                                // 0x0015f8f8: jal 0x163410
...
label_0x15f908:
    func_0015f820();  // 0x15f7e0                                // 0x0015f908: jal 0x15f7e0
    /* nop */                                                   // 0x0015f90c: nop 
    func_001754a8();  // 0x1753d0                                // 0x0015f914: jal 0x1753d0
