...
label_0x1942a8:
    ...
    func_001899f8();  // 1899f8                                // 0x001942b4: jal 0x1899f8
    a2 = 3;                                                     // 0x001942b8: addiu $a2, $zero, 3
    a0 = *(int32_t*)((s0) + 8);                                 // 0x001942bc: lw $a0, 8($s0)
    func_001989a0();  // 1989a0                                // 0x001942c0: jal 0x1989a0
    ...
    func_001988b0();  // 1988b0                                // 0x00194330: jal 0x1988b0
    a0 = *(int16_t*)(s0);                                       // 0x00194334: lh $a0, 0($s0)
    a0 = *(int16_t*)((s0) + 2);                                 // 0x00194338: lh $a0, 2($s0)
    func_001988d0();  // 1988d0                                // 0x00194340: jal 0x1988d0
...
label_0x1944ac:
    ...
    func_00193e90();  // 193e90                                // 0x001944c0: jal 0x193e90
