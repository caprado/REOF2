void func_0017cc20() {
    ...
    func_0017cd38();  // 17cd38                                // 0x0017cc48: jal 0x17cd38
    if (s2 == 0) goto label_0x17cd14;                           // 0x0017cc5c: beqz $s2, 0x17cd14
    func_0017ce28();  // 17ce28                                // 0x0017cc64: jal 0x17ce28
    /* nop */                                                   // 0x0017cc68: nop 
    ...
    func_0017ce88();  // 17ce88                                // 0x0017cc88: jal 0x17ce88
    a2 = &str_00229c48;  // "E201281: SfxZHn: can't create."    // 0x0017cc8c: addiu $a2, $a2, -0x63b8
    goto label_0x17cd14;                                        // 0x0017cc90: b 0x17cd14
label_0x17cc98:
    func_0017cd88();  // 17cd88                                // 0x0017cc98: jal 0x17cd88
    func_0017d408();  // 17d408                                // 0x0017cca0: jal 0x17d408
    /* nop */                                                   // 0x0017cca4: nop 
    ...
    func_0017a340();  // 17a340                                // 0x0017ccbc: jal 0x17a340
...
label_0x17cce4:
    func_0017ce88();  // 17ce88                                // 0x0017cce4: jal 0x17ce88
    /* nop */                                                   // 0x0017cce8: nop 
    func_0017ce38();  // 17ce38                                // 0x0017ccec: jal 0x17ce38
