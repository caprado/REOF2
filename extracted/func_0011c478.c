void func_0011c478() {
    ...
    func_0011bb38();  // 0x11ba38                                // 0x0011c4a0: jal 0x11ba38
    if (v0 < 0) goto label_0x11c55c;                            // 0x0011c4a8: bltz $v0, 0x11c55c
    v0 = 0xffff << 16;                                          // 0x0011c4ac: lui $v0, 0xffff
    func_0011bbc8();  // 0x11bb38                                // 0x0011c4b0: jal 0x11bb38
    /* nop */                                                   // 0x0011c4b4: nop 
    ...
    func_0010b460();  // 0x10b2a0                                // 0x0011c4dc: jal 0x10b2a0
    ...
    func_0010b460();  // 0x10b2a0                                // 0x0011c4f0: jal 0x10b2a0
    ...
    func_001178a0();  // 0x1176a8                                // 0x0011c520: jal 0x1176a8
