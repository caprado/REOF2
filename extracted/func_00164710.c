...
label_0x164728:
    ...
    func_001752f8();  // 0x1752e8                                // 0x0016473c: jal 0x1752e8
    if (v0 == 0) goto label_0x1647a4;                           // 0x00164744: beqz $v0, 0x1647a4
    func_001652d0();  // 0x1652b8                                // 0x0016474c: jal 0x1652b8
    /* nop */                                                   // 0x00164750: nop 
...
label_0x164768:
    func_00164830();  // 0x1647b8                                // 0x00164768: jal 0x1647b8
    func_00165080();  // 0x164fd8                                // 0x00164774: jal 0x164fd8
    a1 = local_0;                                               // 0x0016477c: lw $a1, 0($sp)
    func_00165238();  // 0x1650a8                                // 0x00164780: jal 0x1650a8
    func_001653a8();  // 0x1652f0                                // 0x00164788: jal 0x1652f0
    func_00165438();  // 0x1653d0                                // 0x00164790: jal 0x1653d0
    func_00164710();  // 0x164680                                // 0x00164798: jal 0x164680
label_0x1647a4:
