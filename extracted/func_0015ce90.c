void func_0015ce90() {
    ...
    *(uint32_t*)((s0) + 4) = 0;                                 // 0x0015ceac: sw $zero, 4($s0)
    func_00161608();  // 161608                                // 0x0015ceb0: jal 0x161608
    ...
    func_00160838();  // 160838                                // 0x0015cec4: jal 0x160838
    /* nop */                                                   // 0x0015cec8: nop 
    ...
    func_0013c978();  // 13c978                                // 0x0015ced8: jal 0x13c978
    /* nop */                                                   // 0x0015cedc: nop 
    ...
    func_00164298();  // 164298                                // 0x0015ceec: jal 0x164298
    /* nop */                                                   // 0x0015cef0: nop 
    ...
    /* nop */                                                   // 0x0015cf34: nop 
    func_0015c6e0();  // 15c6e0                                // 0x0015cf38: jal 0x15c6e0
    /* nop */                                                   // 0x0015cf3c: nop 
label_0x15cf40:
    func_00163030();  // 163030                                // 0x0015cf40: jal 0x163030
    a0 = s0 + 0x1ec;                                            // 0x0015cf44: addiu $a0, $s0, 0x1ec
    func_0015d400();  // 15d400                                // 0x0015cf48: jal 0x15d400
    func_0015d480();  // 15d480                                // 0x0015cf50: jal 0x15d480
    if (v0 == 0) goto label_0x15cf68;                           // 0x0015cf58: beqz $v0, 0x15cf68
    a0 = 0x22 << 16;                                            // 0x0015cf5c: lui $a0, 0x22
    func_00163410();  // 163410                                // 0x0015cf60: jal 0x163410
    a0 = &str_002273d8;  // "E204161: mwPlyGetHdrInf(): NULL pointer" // 0x0015cf64: addiu $a0, $a0, 0x73d8
label_0x15cf68:
    func_00107c70();  // 107c70                                // 0x0015cf70: jal 0x107c70
