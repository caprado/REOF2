void func_00173840() {
    ...
    func_00173930();  // 0x1738d0                                // 0x00173860: jal 0x1738d0
    /* nop */                                                   // 0x00173864: nop 
    if (v0 != 0) goto label_0x1738a0;                           // 0x00173868: bnez $v0, 0x1738a0
    func_00169ba0();  // 0x169b88                                // 0x00173870: jal 0x169b88
    /* nop */                                                   // 0x00173874: nop 
    func_001738c0();  // 0x1738b0                                // 0x00173878: jal 0x1738b0
    a0 = 1;                                                     // 0x0017387c: addiu $a0, $zero, 1
    func_00173af8();  // 0x173930                                // 0x00173880: jal 0x173930
    func_001738c0();  // 0x1738b0                                // 0x0017388c: jal 0x1738b0
    func_00169bc8();  // 0x169ba0                                // 0x00173894: jal 0x169ba0
label_0x1738a0:
