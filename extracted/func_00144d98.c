void func_00144d98() {
    ...
    func_00145208();  // 145208                                // 0x00144de4: jal 0x145208
    ...
    func_001456a8();  // 1456a8                                // 0x00144dfc: jal 0x1456a8
    goto label_0x144e10;                                        // 0x00144e04: b 0x144e10
label_0x144e0c:
label_0x144e10:
    func_00144b70();  // 144b70                                // 0x00144e1c: jal 0x144b70
    if (s7 == 0) goto label_0x144e3c;                           // 0x00144e24: beqz $s7, 0x144e3c
    func_00143f08();  // 143f08                                // 0x00144e2c: jal 0x143f08
    *(uint32_t*)(fp) = v0;                                      // 0x00144e34: sw $v0, 0($fp)
label_0x144e3c:
    func_00145208();  // 145208                                // 0x00144e3c: jal 0x145208
    ...
    func_001456a8();  // 1456a8                                // 0x00144e54: jal 0x1456a8
...
label_0x144e7c:
    func_00144b70();  // 144b70                                // 0x00144e84: jal 0x144b70
...
label_0x144ea0:
    ...
    func_00143f08();  // 143f08                                // 0x00144ea8: jal 0x143f08
