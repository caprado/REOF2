void func_001d4ab0() {
    ...
    /* nop */                                                   // 0x001d4adc: nop 
label_0x1d4ae0:
    func_001d4140();  // 1d4140                                // 0x001d4aec: jal 0x1d4140
    ...
    func_0010ac68();  // 10ac68                                // 0x001d4b10: jal 0x10ac68
    a0 = sp + 0x250;                                            // 0x001d4b18: addiu $a0, $sp, 0x250
    func_0010b460();  // 10b460                                // 0x001d4b1c: jal 0x10b460
...
label_0x1d4b90:
    *(uint8_t*)(a0) = 0;                                        // 0x001d4b90: sb $zero, 0($a0)
    ...
    func_0010b460();  // 10b460                                // 0x001d4ba0: jal 0x10b460
    ...
    func_0010b460();  // 10b460                                // 0x001d4bb0: jal 0x10b460
...
label_0x1d4bd0:
    ...
    func_0010b460();  // 10b460                                // 0x001d4be0: jal 0x10b460
