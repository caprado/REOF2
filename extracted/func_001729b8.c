void func_001729b8() {
    ...
    func_00172cb8();  // 0x172c18                                // 0x00172a0c: jal 0x172c18
    /* bnezl $v0, 0x172b20 */                                   // 0x00172a14: bnezl $v0, 0x172b20
    func_001752f8();  // 0x1752e8                                // 0x00172a20: jal 0x1752e8
...
label_0x172a8c:
    ...
    func_00172d70();  // 0x172cb8                                // 0x00172aa4: jal 0x172cb8
    if (v0 != 0) goto label_0x172b20;                           // 0x00172aac: bnez $v0, 0x172b20
label_0x172ab8:
    a2 = sp + 4;                                                // 0x00172ab8: addiu $a2, $sp, 4
    func_00176060();  // 0x176010                                // 0x00172abc: jal 0x176010
    ...
    func_001752f8();  // 0x1752e8                                // 0x00172ad4: jal 0x1752e8
    s0 = *(int32_t*)((v1) + 0x240);                             // 0x00172ad8: lw $s0, 0x240($v1)
    a2 = 0xf << 16;                                             // 0x00172ae0: lui $a2, 0xf
    func_0015b7b0();  // 0x15b740                                // 0x00172ae8: jal 0x15b740
...
label_0x172b04:
    ...
    /* nop */                                                   // 0x00172b0c: nop 
label_0x172b10:
    func_001764c8();  // 0x176438                                // 0x00172b14: jal 0x176438
