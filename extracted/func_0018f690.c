void func_0018f690() {
    ...
    func_0018faa0();  // 0x18f780                                // 0x0018f6c4: jal 0x18f780
    a0 = v0 + at;                                               // 0x0018f6c8: addu $a0, $v0, $at
    v0 = 0x7000 << 16;                                          // 0x0018f6cc: lui $v0, 0x7000
    func_0018f690();  // 0x18f600                                // 0x0018f6d0: jal 0x18f600
    ...
    func_001910b0();  // 0x191030                                // 0x0018f6e8: jal 0x191030
    ...
    func_001910b0();  // 0x191030                                // 0x0018f704: jal 0x191030
...
label_0x18f740:
label_0x18f748:
    func_001975e0();  // 0x197300                                // 0x0018f754: jal 0x197300
