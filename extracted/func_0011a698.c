void func_0011a698() {
    ...
    func_00118330();  // 118330                                // 0x0011a6cc: jal 0x118330
    ...
    func_00118460();  // 118460                                // 0x0011a6e4: jal 0x118460
    /* nop */                                                   // 0x0011a6e8: nop 
...
label_0x11a7a0:
    ...
    func_00116c90();  // 116c90                                // 0x0011a7d8: jal 0x116c90
    ...
    func_001176a8();  // 1176a8                                // 0x0011a800: jal 0x1176a8
