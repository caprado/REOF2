void func_001658c8() {
    ...
    func_0017e530();  // 17e530                                // 0x0016591c: jal 0x17e530
    func_0017e658();  // 17e658                                // 0x00165924: jal 0x17e658
    a2 = sp + 0x10;                                             // 0x00165930: addiu $a2, $sp, 0x10
    a3 = sp + 0x20;                                             // 0x00165938: addiu $a3, $sp, 0x20
    func_00177b70();  // 177b70                                // 0x0016593c: jal 0x177b70
