...
label_0x152128:
    ...
    func_00150ac8();  // 150ac8                                // 0x00152140: jal 0x150ac8
    *(uint32_t*)((s4) + 0x338) = v1;                            // 0x00152144: sw $v1, 0x338($s4)
    func_00150b90();  // 150b90                                // 0x00152148: jal 0x150b90
...
label_0x152618:
    func_00150b90();  // 150b90                                // 0x00152618: jal 0x150b90
...
label_0x152994:
    func_00150df0();  // 150df0                                // 0x00152994: jal 0x150df0
...
label_0x153560:
    ...
    *(uint32_t*)((s4) + 0xb4) = v0;                             // 0x00153568: sw $v0, 0xb4($s4)
    /* nop */                                                   // 0x0015356c: nop 
    func_00150d30();  // 150d30                                // 0x00153570: jal 0x150d30
...
label_0x1542d0:
    func_00150ac8();  // 150ac8                                // 0x001542d0: jal 0x150ac8
    func_00150d80();  // 150d80                                // 0x001542d8: jal 0x150d80
