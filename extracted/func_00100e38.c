...
void func_00100e38() {
    ...
    func_00116598();  // 0x116508                                // 0x00100e58: jal 0x116508
...
label_0x100e68:
    func_00115408();  // 0x115340                                // 0x00100e68: jal 0x115340
    a0 = 0xfa0;                                                 // 0x00100e6c: addiu $a0, $zero, 0xfa0
label_0x100e70:
    func_001178e0();  // 0x1178a0                                // 0x00100e70: jal 0x1178a0
...
label_0x100e88:
    ...
    func_001178e0();  // 0x1178a0                                // 0x00100e8c: jal 0x1178a0
