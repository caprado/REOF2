void func_00128f00() {
    ...
    func_00128268();  // 0x1281b8                                // 0x00128f2c: jal 0x1281b8
    func_00128cd0();  // 0x128c40                                // 0x00128f34: jal 0x128c40
    /* nop */                                                   // 0x00128f38: nop 
    if (s0 == 0) goto label_0x128f6c;                           // 0x00128f48: beqz $s0, 0x128f6c
    func_00128f00();  // 0x128e28                                // 0x00128f50: jal 0x128e28
    /* nop */                                                   // 0x00128f54: nop 
    if (v0 >= 0) goto label_0x128f70;                           // 0x00128f58: bgez $v0, 0x128f70
    func_001290c8();  // 0x129010                                // 0x00128f64: jal 0x129010
label_0x128f6c:
label_0x128f70:
    a0 = 2;                                                     // 0x00128f74: addiu $a0, $zero, 2
    a1 = 1;                                                     // 0x00128f78: addiu $a1, $zero, 1
    func_00128268();  // 0x1281b8                                // 0x00128f7c: jal 0x1281b8
