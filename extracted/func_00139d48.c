void func_00139d48() {
    ...
    func_0013a770();  // 0x13a6c0                                // 0x00139d5c: jal 0x13a6c0
    ...
    func_00139fb0();  // 0x139f08                                // 0x00139d7c: jal 0x139f08
    /* nop */                                                   // 0x00139d80: nop 
    func_00137fb0();  // 0x137ec8                                // 0x00139d84: jal 0x137ec8
    a0 = 0 | 0x8400;                                            // 0x00139d88: ori $a0, $zero, 0x8400
    func_00100e38();  // 0x100d98                                // 0x00139d8c: jal 0x100d98
    func_00137fb0();  // 0x137ec8                                // 0x00139d94: jal 0x137ec8
    a0 = 0 | 0x8401;                                            // 0x00139d98: ori $a0, $zero, 0x8401
    func_00139390();  // 0x1392e8                                // 0x00139da0: jal 0x1392e8
    ...
    func_00116598();  // 0x116508                                // 0x00139dc4: jal 0x116508
