void func_001ac020() {
    ...
    func_001a82b0();  // 1a82b0                                // 0x001ac030: jal 0x1a82b0
    a1 = a1 + -0x24f0;                                          // 0x001ac034: addiu $a1, $a1, -0x24f0
    func_001d3110();  // 1d3110                                // 0x001ac038: jal 0x1d3110
    /* nop */                                                   // 0x001ac03c: nop 
    func_00129ea8();  // 129ea8                                // 0x001ac040: jal 0x129ea8
    /* nop */                                                   // 0x001ac044: nop 
    a0 = 0x1b << 16;                                            // 0x001ac048: lui $a0, 0x1b
    func_0012b2e0();  // 12b2e0                                // 0x001ac050: jal 0x12b2e0
