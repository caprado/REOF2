void func_00167794() {
    ...
    func_001698d0();  // 1698d0                                // 0x001677e8: jal 0x1698d0
    a1 = a1 | 0x401;                                            // 0x001677ec: ori $a1, $a1, 0x401
    goto label_0x167868;                                        // 0x001677f0: b 0x167868
    func_00169b88();  // 169b88                                // 0x001677f8: jal 0x169b88
...
label_0x16782c:
    ...
    *(uint32_t*)((s0) + 0x2c) = v0;                             // 0x00167840: sw $v0, 0x2c($s0)
    func_001698d0();  // 1698d0                                // 0x00167844: jal 0x1698d0
    /* nop */                                                   // 0x00167848: nop 
label_0x167850:
    v0 = 1;                                                     // 0x00167850: addiu $v0, $zero, 1
    func_00169ba0();  // 169ba0                                // 0x00167858: jal 0x169ba0
