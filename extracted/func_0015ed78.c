void func_0015ed78() {
    ...
    func_0015fcb0();  // 0x15fc80                                // 0x0015ed8c: jal 0x15fc80
...
label_0x15ee00:
    ...
    func_0015f048();  // 0x15efb0                                // 0x0015ee2c: jal 0x15efb0
    *(uint32_t*)((s0) + 0x128) = v0;                            // 0x0015ee30: sw $v0, 0x128($s0)
    func_0015ed68();  // 0x15ec78                                // 0x0015ee34: jal 0x15ec78
    func_0015f3d8();  // 0x15f398                                // 0x0015ee40: jal 0x15f398
    func_0015f778();  // 0x15f768                                // 0x0015ee50: jal 0x15f768
    ...
    func_0015fcb0();  // 0x15fc80                                // 0x0015ee9c: jal 0x15fc80
    ...
    /* nop */                                                   // 0x0015eecc: nop 
label_0x15eed0:
    func_0015f048();  // 0x15efb0                                // 0x0015eed0: jal 0x15efb0
    /* nop */                                                   // 0x0015eed4: nop 
    ...
    /* nop */                                                   // 0x0015eee8: nop 
    func_0013f0e8();  // 0x13f020                                // 0x0015eef0: jal 0x13f020
    ...
    *(uint32_t*)((s0) + 0x154) = s2;                            // 0x0015ef04: sw $s2, 0x154($s0)
    func_0015ed68();  // 0x15ec78                                // 0x0015ef08: jal 0x15ec78
    *(uint32_t*)((s0) + 0x14c) = v0;                            // 0x0015ef0c: sw $v0, 0x14c($s0)
    ...
    func_0015fcb0();  // 0x15fc80                                // 0x0015ef44: jal 0x15fc80
...
label_0x15ef70:
    func_0015f048();  // 0x15efb0                                // 0x0015ef70: jal 0x15efb0
    /* nop */                                                   // 0x0015ef74: nop 
    ...
    *(uint32_t*)((s0) + 0x144) = 0;                             // 0x0015ef8c: sw $zero, 0x144($s0)
    func_0015ed68();  // 0x15ec78                                // 0x0015ef90: jal 0x15ec78
