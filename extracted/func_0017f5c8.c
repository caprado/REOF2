void func_0017f5c8() {
    ...
    *(float*)((sp) + 0x50) = FPU_F20;  // Store float           // 0x0017f5cc: swc1 $f20, 0x50($sp)
    ...
    func_0017ee18();  // 0x17edb0                                // 0x0017f5f8: jal 0x17edb0
    func_0017e9d8();  // 0x17e958                                // 0x0017f604: jal 0x17e958
    /* FPU: mov.s $f12, $f20 */                                 // 0x0017f610: mov.s $f12, $f20
    func_0017ee18();  // 0x17edb0                                // 0x0017f614: jal 0x17edb0
    a0 = s0 + 0x10;                                             // 0x0017f61c: addiu $a0, $s0, 0x10
    func_0017e9d8();  // 0x17e958                                // 0x0017f620: jal 0x17e958
    /* FPU: mov.s $f12, $f20 */                                 // 0x0017f62c: mov.s $f12, $f20
    func_0017ee18();  // 0x17edb0                                // 0x0017f630: jal 0x17edb0
    a0 = s0 + 0x20;                                             // 0x0017f638: addiu $a0, $s0, 0x20
    func_0017e9d8();  // 0x17e958                                // 0x0017f63c: jal 0x17e958
    ...
    *(float*)((s0) + 0x38) = FPU_F0;  // Store float            // 0x0017f660: swc1 $f0, 0x38($s0)
    func_0017ea60();  // 0x17e9d8                                // 0x0017f664: jal 0x17e9d8
