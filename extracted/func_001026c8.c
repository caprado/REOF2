void func_001026c8() {
    ...
    func_001022e8();  // 0x1022b8                                // 0x001026e0: jal 0x1022b8
...
label_0x102700:
    ...
    func_00102328();  // 0x1022e8                                // 0x00102714: jal 0x1022e8
    ...
    func_00102328();  // 0x1022e8                                // 0x0010273c: jal 0x1022e8
    a0 = 0x431;                                                 // 0x0010274c: addiu $a0, $zero, 0x431
    func_00102328();  // 0x1022e8                                // 0x00102758: jal 0x1022e8
    a0 = 0x432;                                                 // 0x00102764: addiu $a0, $zero, 0x432
    func_00102328();  // 0x1022e8                                // 0x0010276c: jal 0x1022e8
    a0 = 0x434;                                                 // 0x00102778: addiu $a0, $zero, 0x434
    func_00102328();  // 0x1022e8                                // 0x00102780: jal 0x1022e8
    a0 = 0x435;                                                 // 0x0010278c: addiu $a0, $zero, 0x435
    func_00102328();  // 0x1022e8                                // 0x00102794: jal 0x1022e8
    a0 = 0x436;                                                 // 0x001027a0: addiu $a0, $zero, 0x436
    func_00102328();  // 0x1022e8                                // 0x001027a8: jal 0x1022e8
    a0 = 0x437;                                                 // 0x001027b4: addiu $a0, $zero, 0x437
    func_00102328();  // 0x1022e8                                // 0x001027bc: jal 0x1022e8
    /* nop */                                                   // 0x001027c4: nop 
label_0x1027c8:
    v0 = *(uint16_t*)(s0);                                      // 0x001027c8: lhu $v0, 0($s0)
    a0 = s1 + 0x420;                                            // 0x001027cc: addiu $a0, $s1, 0x420
    a0 = a0 & 0xffff;                                           // 0x001027d0: andi $a0, $a0, 0xffff
    func_00102328();  // 0x1022e8                                // 0x001027dc: jal 0x1022e8
