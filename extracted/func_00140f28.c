void func_00140f28() {
    ...
    func_00107c70();  // 107c70                                // 0x00140f88: jal 0x107c70
    s3 = s4 + 0x84;                                             // 0x00140f8c: addiu $s3, $s4, 0x84
    func_00138fb8();  // 138fb8                                // 0x00140f90: jal 0x138fb8
    ...
    func_0011b570();  // 11b570                                // 0x00140fb8: jal 0x11b570
    ...
    func_00116508();  // 116508                                // 0x00140fcc: jal 0x116508
...
label_0x140ff8:
    ...
    func_00138c38();  // 138c38                                // 0x00141020: jal 0x138c38
    ...
    func_00116508();  // 116508                                // 0x00141034: jal 0x116508
...
label_0x141060:
    ...
    func_00138e38();  // 138e38                                // 0x00141070: jal 0x138e38
    ...
    func_00138e48();  // 138e48                                // 0x00141084: jal 0x138e48
    a0 = 3;                                                     // 0x0014108c: addiu $a0, $zero, 3
    func_00139120();  // 139120                                // 0x0014109c: jal 0x139120
label_0x1410a4:
