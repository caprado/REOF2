void func_0015f530() {
    ...
    func_0015f5a0();  // 15f5a0                                // 0x0015f54c: jal 0x15f5a0
    /* nop */                                                   // 0x0015f550: nop 
    a2 = 0x26 << 16;                                            // 0x0015f554: lui $a2, 0x26
    a2 = a2 + -0x2240;                                          // 0x0015f558: addiu $a2, $a2, -0x2240
    a1 = 0x4000;                                                // 0x0015f55c: addiu $a1, $zero, 0x4000
    func_0015f5c0();  // 15f5c0                                // 0x0015f560: jal 0x15f5c0
    func_0015f690();  // 15f690                                // 0x0015f568: jal 0x15f690
    ...
    func_0015f628();  // 15f628                                // 0x0015f57c: jal 0x15f628
    func_0015f690();  // 15f690                                // 0x0015f584: jal 0x15f690
