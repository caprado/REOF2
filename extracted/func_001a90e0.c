void func_001a90e0() {
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001a90f8: jal 0x10a4d8
    ...
    func_001283d0();  // 1283d0                                // 0x001a9110: jal 0x1283d0
    a3 = a3 + 0x4f80;                                           // 0x001a9114: addiu $a3, $a3, 0x4f80
label_0x1a9118:
    func_001287d8();  // 1287d8                                // 0x001a9118: jal 0x1287d8
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001a9144: jal 0x10a4d8
    ...
    func_001283d0();  // 1283d0                                // 0x001a915c: jal 0x1283d0
    a3 = a3 + 0x4e50;                                           // 0x001a9160: addiu $a3, $a3, 0x4e50
label_0x1a9164:
    func_001287d8();  // 1287d8                                // 0x001a9164: jal 0x1287d8
    ...
    func_00107c70();  // 107c70                                // 0x001a918c: jal 0x107c70
    ...
    *(uint32_t*)((gp) + -0x63e8) = v0;                          // 0x001a91ac: sw $v0, -0x63e8($gp)
    ...
    func_001a98a0();  // 1a98a0                                // 0x001a91d4: jal 0x1a98a0
