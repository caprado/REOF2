void func_00167d50() {
    ...
    func_00169b10();  // 0x169af0                                // 0x00167d88: jal 0x169af0
    if (v0 == 0) goto label_0x167db0;                           // 0x00167d90: beqz $v0, 0x167db0
    a1 = 0xff00 << 16;                                          // 0x00167d98: lui $a1, 0xff00
    func_00169940();  // 0x1698d0                                // 0x00167d9c: jal 0x1698d0
...
label_0x167db0:
    ...
    *(uint32_t*)(s7) = 0;                                       // 0x00167db8: sw $zero, 0($s7)
    func_00175f80();  // 0x175ed0                                // 0x00167dc4: jal 0x175ed0
    ...
    func_00169ba0();  // 0x169b88                                // 0x00167dec: jal 0x169b88
    ...
    func_0015b7b0();  // 0x15b740                                // 0x00167e38: jal 0x15b740
...
label_0x167e54:
    *(uint32_t*)(s7) = s0;                                      // 0x00167e54: sw $s0, 0($s7)
    ...
    func_00169bc8();  // 0x169ba0                                // 0x00167e6c: jal 0x169ba0
