...
label_0x16c008:
    ...
    func_001752e8();  // 1752e8                                // 0x0016c01c: jal 0x1752e8
    if (v0 == 0) goto label_0x16c070;                           // 0x0016c024: beqz $v0, 0x16c070
    func_0016c0f8();  // 16c0f8                                // 0x0016c02c: jal 0x16c0f8
    /* nop */                                                   // 0x0016c030: nop 
...
label_0x16c048:
    func_0016c088();  // 16c088                                // 0x0016c048: jal 0x16c088
    /* nop */                                                   // 0x0016c04c: nop 
    func_0016c440();  // 16c440                                // 0x0016c050: jal 0x16c440
    func_0016c110();  // 16c110                                // 0x0016c05c: jal 0x16c110
    func_0016c378();  // 16c378                                // 0x0016c064: jal 0x16c378
label_0x16c070:
