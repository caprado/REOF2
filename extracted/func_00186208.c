void func_00186208() {
    ...
    func_00188530();  // 188530                                // 0x0018624c: jal 0x188530
...
label_0x186268:
    ...
    func_00182670();  // 182670                                // 0x00186288: jal 0x182670
    ...
    func_0010ab20();  // 10ab20                                // 0x001862a0: jal 0x10ab20
...
label_0x1862bc:
    func_0010ac68();  // 10ac68                                // 0x001862c0: jal 0x10ac68
    func_0010b460();  // 10b460                                // 0x001862cc: jal 0x10b460
    ...
    func_0010ac68();  // 10ac68                                // 0x001862f0: jal 0x10ac68
...
label_0x186338:
    func_00184320();  // 184320                                // 0x00186338: jal 0x184320
    /* nop */                                                   // 0x0018633c: nop 
...
label_0x186370:
    ...
    func_00182f70();  // 182f70                                // 0x0018637c: jal 0x182f70
    ...
    func_0010ab20();  // 10ab20                                // 0x001863a8: jal 0x10ab20
    ...
    func_00182f70();  // 182f70                                // 0x001863c0: jal 0x182f70
...
label_0x1863f8:
    ...
    func_0010ab20();  // 10ab20                                // 0x0018640c: jal 0x10ab20
...
label_0x186470:
    func_00182bd0();  // 182bd0                                // 0x00186478: jal 0x182bd0
...
label_0x1864b0:
    ...
    func_00187390();  // 187390                                // 0x001864c0: jal 0x187390
...
label_0x186584:
    ...
    func_00182388();  // 182388                                // 0x001865a0: jal 0x182388
    ...
    *(uint32_t*)((s1) + 0x10) = v1;                             // 0x001865f8: sw $v1, 0x10($s1)
    func_0010ac68();  // 10ac68                                // 0x001865fc: jal 0x10ac68
    *(uint16_t*)((s1) + 0x14) = v0;                             // 0x00186600: sh $v0, 0x14($s1)
    t1 = 0x23 << 16;                                            // 0x00186604: lui $t1, 0x23
    func_0010ab20();  // 10ab20                                // 0x0018660c: jal 0x10ab20
...
label_0x186628:
    ...
    func_0010ab20();  // 10ab20                                // 0x00186630: jal 0x10ab20
...
label_0x186680:
    ...
    func_00182bd0();  // 182bd0                                // 0x00186694: jal 0x182bd0
