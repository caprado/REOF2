void func_00108498() {
    ...
    func_00107ed8();  // 107ed8                                // 0x001084d4: jal 0x107ed8
label_0x1084e0:
    ...
    func_00108250();  // 108250                                // 0x001084fc: jal 0x108250
    ...
    *(uint32_t*)(s0) = 0;                                       // 0x00108510: sw $zero, 0($s0)
    ...
    func_00108288();  // 108288                                // 0x00108528: jal 0x108288
...
label_0x108544:
    ...
    func_00108288();  // 108288                                // 0x00108554: jal 0x108288
    func_00107ea8();  // 107ea8                                // 0x00108564: jal 0x107ea8
label_0x10856c:
