void func_001315d8() {
    ...
    /* nop */                                                   // 0x0013161c: nop 
label_0x131620:
    func_001315b0();  // 0x131588                                // 0x00131620: jal 0x131588
    /* nop */                                                   // 0x00131624: nop 
    func_001315d8();  // 0x1315b0                                // 0x00131628: jal 0x1315b0
    ...
    func_00131bb8();  // 0x131af8                                // 0x00131640: jal 0x131af8
...
label_0x13164c:
    ...
    func_0012c378();  // 0x12c340                                // 0x00131654: jal 0x12c340
    *(uint32_t*)((s1) + 0xc) = 0;                               // 0x00131658: sw $zero, 0xc($s1)
    ...
    func_0012c878();  // 0x12c818                                // 0x00131668: jal 0x12c818
    ...
    *(uint32_t*)((s1) + 8) = 0;                                 // 0x0013167c: sw $zero, 8($s1)
    func_00130468();  // 0x130458                                // 0x00131684: jal 0x130458
    func_00130138();  // 0x1300e0                                // 0x0013168c: jal 0x1300e0
label_0x131694:
    a0 = *(int32_t*)((s1) + 0x94);                              // 0x00131694: lw $a0, 0x94($s1)
    if (a0 == 0) goto label_0x1316a8;                           // 0x00131698: beqz $a0, 0x1316a8
    /* nop */                                                   // 0x0013169c: nop 
    func_0013c9c8();  // 0x13c978                                // 0x001316a0: jal 0x13c978
    *(uint32_t*)((s1) + 0x94) = 0;                              // 0x001316a4: sw $zero, 0x94($s1)
label_0x1316a8:
    func_001261b8();  // 0x1261a0                                // 0x001316a8: jal 0x1261a0
    /* nop */                                                   // 0x001316ac: nop 
...
label_0x131760:
    ...
    func_00122608();  // 0x1225b0                                // 0x0013176c: jal 0x1225b0
    *(uint32_t*)((s1) + 0x74) = 0;                              // 0x00131770: sw $zero, 0x74($s1)
    func_00107d30();  // 0x107c70                                // 0x0013177c: jal 0x107c70
...
label_0x1317d0:
    ...
    func_00131808();  // 0x1315d8                                // 0x001317dc: jal 0x1315d8
