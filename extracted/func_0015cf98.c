...
label_0x15cfc8:
    ...
    func_001634a8();  // 0x163410                                // 0x0015cfcc: jal 0x163410
...
label_0x15d034:
    ...
    *(uint32_t*)(s2) = 0;                                       // 0x0015d078: sw $zero, 0($s2)
    /* nop */                                                   // 0x0015d07c: nop 
label_0x15d080:
    func_0015d180();  // 0x15d130                                // 0x0015d080: jal 0x15d130
    ...
    func_0015e338();  // 0x15e260                                // 0x0015d0bc: jal 0x15e260
    local_18 = t1;                                              // 0x0015d0c0: sw $t1, 0x18($sp)
    func_0015d218();  // 0x15d180                                // 0x0015d0c4: jal 0x15d180
