...
label_0x1d4f84:
    ...
    func_001d4140();  // 1d4140                                // 0x001d4f8c: jal 0x1d4140
...
label_0x1d4fa4:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001d4fac: jal 0x10a4d8
    ...
    func_0010a860();  // 10a860                                // 0x001d4fbc: jal 0x10a860
    ...
    func_001d3390();  // 1d3390                                // 0x001d4fd4: jal 0x1d3390
...
label_0x1d5018:
    ...
    func_001d5410();  // 1d5410                                // 0x001d5024: jal 0x1d5410
    ...
    func_001aa960();  // 1aa960                                // 0x001d503c: jal 0x1aa960
