void func_0019f390() {
    ...
    func_001ba3c0();  // 0x1ba360                                // 0x0019f398: jal 0x1ba360
    /* nop */                                                   // 0x0019f39c: nop 
    func_0018d530();  // 0x18d4c0                                // 0x0019f3a0: jal 0x18d4c0
    /* nop */                                                   // 0x0019f3a4: nop 
    func_001a8a50();  // 0x1a8990                                // 0x0019f3a8: jal 0x1a8990
    /* nop */                                                   // 0x0019f3ac: nop 
    ...
    func_0018d4c0();  // 0x18d2f0                                // 0x0019f3d4: jal 0x18d2f0
    *(uint32_t*)((gp) + -0x6450) = v0;                          // 0x0019f3d8: sw $v0, -0x6450($gp)
    func_0018dc30();  // 0x18dba0                                // 0x0019f3dc: jal 0x18dba0
    /* nop */                                                   // 0x0019f3e0: nop 
    func_001a0760();  // 0x1a05c0                                // 0x0019f3e4: jal 0x1a05c0
    /* nop */                                                   // 0x0019f3e8: nop 
    ...
    func_001ba360();  // 0x1ba310                                // 0x0019f3fc: jal 0x1ba310
