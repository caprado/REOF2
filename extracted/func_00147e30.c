void func_00147e30() {
    ...
    *(uint32_t*)(s0) = 0;                                       // 0x00147e64: sw $zero, 0($s0)
    ...
    func_001484f8();  // 1484f8                                // 0x00147e70: jal 0x1484f8
...
label_0x147e80:
    ...
    func_00116508();  // 116508                                // 0x00147e8c: jal 0x116508
...
label_0x147e9c:
    func_00116508();  // 116508                                // 0x00147e9c: jal 0x116508
...
label_0x147ec0:
    func_00145900();  // 145900                                // 0x00147ec0: jal 0x145900
...
label_0x147ef8:
    ...
    /* nop */                                                   // 0x00147f14: nop 
    func_001482c8();  // 1482c8                                // 0x00147f18: jal 0x1482c8
    ...
    *(uint32_t*)((s0) + 0xb8) = 0;                              // 0x00147f3c: sw $zero, 0xb8($s0)
    func_00148108();  // 148108                                // 0x00147f40: jal 0x148108
    ...
    *(uint32_t*)((s0) + 0xb8) = v1;                             // 0x00147f58: sw $v1, 0xb8($s0)
    ...
    func_00148108();  // 148108                                // 0x00147f64: jal 0x148108
    ...
    *(uint32_t*)((s0) + 0xbc) = v1;                             // 0x00147f7c: sw $v1, 0xbc($s0)
    ...
    func_00148108();  // 148108                                // 0x00147f88: jal 0x148108
