void func_001635a8() {
    ...
    func_001633e0();  // 0x1633c0                                // 0x001635d4: jal 0x1633c0
    /* nop */                                                   // 0x001635d8: nop 
    func_001638b0();  // 0x1637f0                                // 0x001635e0: jal 0x1637f0
    if (v0 != s2) goto label_0x1635f4;                          // 0x001635e8: bne $v0, $s2, 0x1635f4
    *(uint32_t*)((s1) + 0x118) = 0;                             // 0x001635f0: sw $zero, 0x118($s1)
label_0x1635f4:
    func_001633f8();  // 0x1633e0                                // 0x001635f4: jal 0x1633e0
    /* nop */                                                   // 0x001635f8: nop 
label_0x1635fc:
    func_00163670();  // 0x163648                                // 0x001635fc: jal 0x163648
    func_00174ff8();  // 0x174fb8                                // 0x00163604: jal 0x174fb8
