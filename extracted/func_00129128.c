void func_00129128() {
    ...
    func_00130278();  // 130278                                // 0x00129148: jal 0x130278
    ...
    /* nop */                                                   // 0x00129158: nop 
    func_00130408();  // 130408                                // 0x0012915c: jal 0x130408
    a0 = *(int32_t*)((s0) + 4);                                 // 0x00129160: lw $a0, 4($s0)
label_0x129164:
    func_001261a0();  // 1261a0                                // 0x00129164: jal 0x1261a0
    /* nop */                                                   // 0x00129168: nop 
    ...
    *(uint8_t*)((s0) + 1) = v0;                                 // 0x001291a0: sb $v0, 1($s0)
    ...
    /* nop */                                                   // 0x001291ac: nop 
label_0x1291b0:
    func_00130468();  // 130468                                // 0x001291b0: jal 0x130468
    a0 = *(int32_t*)((s0) + 4);                                 // 0x001291b4: lw $a0, 4($s0)
    a0 = *(int32_t*)((s0) + 4);                                 // 0x001291b8: lw $a0, 4($s0)
    func_00130be0();  // 130be0                                // 0x001291bc: jal 0x130be0
    a0 = *(int32_t*)((s0) + 4);                                 // 0x001291c4: lw $a0, 4($s0)
    func_00130ae8();  // 130ae8                                // 0x001291c8: jal 0x130ae8
