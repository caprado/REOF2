void func_00128d88() {
    ...
    func_00128268();  // 0x1281b8                                // 0x00128db4: jal 0x1281b8
    func_00128cd0();  // 0x128c40                                // 0x00128dbc: jal 0x128c40
    /* nop */                                                   // 0x00128dc0: nop 
    if (s0 == 0) goto label_0x128df4;                           // 0x00128dd0: beqz $s0, 0x128df4
    func_00128d88();  // 0x128cd0                                // 0x00128dd8: jal 0x128cd0
    /* nop */                                                   // 0x00128ddc: nop 
    if (v0 >= 0) goto label_0x128df8;                           // 0x00128de0: bgez $v0, 0x128df8
    func_001290c8();  // 0x129010                                // 0x00128dec: jal 0x129010
label_0x128df4:
label_0x128df8:
    a0 = 1;                                                     // 0x00128dfc: addiu $a0, $zero, 1
    a1 = 1;                                                     // 0x00128e00: addiu $a1, $zero, 1
    func_00128268();  // 0x1281b8                                // 0x00128e04: jal 0x1281b8
