...
label_0x171374:
    *(uint32_t*)((a1) + 0x2c) = v0;                             // 0x00171374: sw $v0, 0x2c($a1)
    ...
    func_001738d0();  // 0x1738c0                                // 0x00171398: jal 0x1738c0
