void func_001137b0() {
    ...
    func_001123b0();  // 0x1123a0                                // 0x001137c4: jal 0x1123a0
    if (s1 != 0) goto label_0x1137f8;                           // 0x001137d0: bnez $s1, 0x1137f8
    s2 = *(int32_t*)((s0) + 8);                                 // 0x001137d4: lw $s2, 8($s0)
    func_00114e28();  // 0x114dc0                                // 0x001137d8: jal 0x114dc0
...
label_0x1137f8:
    ...
    *(uint32_t*)((s0) + 8) = s1;                                // 0x001137fc: sw $s1, 8($s0)
    func_00114e28();  // 0x114dc0                                // 0x00113800: jal 0x114dc0
    ...
    *(uint32_t*)((s0) + 0xc) = v0;                              // 0x00113828: sw $v0, 0xc($s0)
    func_00114e90();  // 0x114e28                                // 0x0011382c: jal 0x114e28
