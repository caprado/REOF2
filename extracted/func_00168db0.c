void func_00168db0() {
    ...
    func_00155db0();  // 0x155b20                                // 0x00168de8: jal 0x155b20
    *(uint32_t*)((s1) + 0x90) = s0;                             // 0x00168df0: sw $s0, 0x90($s1)
    func_00169058();  // 0x168ff0                                // 0x00168df4: jal 0x168ff0
    func_00169640();  // 0x169610                                // 0x00168dfc: jal 0x169610
    func_00168e68();  // 0x168e28                                // 0x00168e04: jal 0x168e28
