void func_00169728() {
    ...
    func_001756f8();  // 1756f8                                // 0x00169788: jal 0x1756f8
    a1 = *(int32_t*)((s1) + 4);                                 // 0x0016978c: lw $a1, 4($s1)
    func_001663d0();  // 1663d0                                // 0x00169790: jal 0x1663d0
    a0 = s0 + 0x1bc;                                            // 0x00169794: addiu $a0, $s0, 0x1bc
    func_001697e8();  // 1697e8                                // 0x00169798: jal 0x1697e8
...
label_0x1697a8:
    ...
    func_00177170();  // 177170                                // 0x001697cc: jal 0x177170
