void func_0011c0a0() {
    ...
    func_0010b2a0();  // 10b2a0                                // 0x0011c0e4: jal 0x10b2a0
    ...
    func_001176a8();  // 1176a8                                // 0x0011c118: jal 0x1176a8
