void func_001cf880() {
    ...
    func_001cfc90();  // 1cfc90                                // 0x001cf88c: jal 0x1cfc90
    ...
    *(float*)((s0) + 0x74) = FPU_F1;  // Store float            // 0x001cf8a4: swc1 $f1, 0x74($s0)
    func_001d00f0();  // 1d00f0                                // 0x001cf8a8: jal 0x1d00f0
...
label_0x1cf900:
    func_001d0990();  // 1d0990                                // 0x001cf900: jal 0x1d0990
    /* nop */                                                   // 0x001cf904: nop 
...
label_0x1cf940:
    ...
    func_001cfc90();  // 1cfc90                                // 0x001cf964: jal 0x1cfc90
    ...
    *(uint32_t*)((s0) + 0x70) = 0;                              // 0x001cf974: sw $zero, 0x70($s0)
    ...
    func_001cc140();  // 1cc140                                // 0x001cf988: jal 0x1cc140
    a0 = g_0032be54;  // Global at 0x0032be54                   // 0x001cf98c: lw $a0, -0x41ac($at)
    func_001cc120();  // 1cc120                                // 0x001cf990: jal 0x1cc120
    /* nop */                                                   // 0x001cf994: nop 
...
label_0x1cf9b8:
    func_001cc370();  // 1cc370                                // 0x001cf9b8: jal 0x1cc370
    /* nop */                                                   // 0x001cf9bc: nop 
...
label_0x1cf9d0:
    ...
    /* nop */                                                   // 0x001cf9dc: nop 
label_0x1cf9e0:
    func_001ce600();  // 1ce600                                // 0x001cf9e0: jal 0x1ce600
