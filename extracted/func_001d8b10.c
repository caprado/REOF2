void func_001d8b10() {
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001d8b50: jal 0x10a4d8
    s0 = sp + 0x50;                                             // 0x001d8b58: addiu $s0, $sp, 0x50
    a2 = 1;                                                     // 0x001d8b64: addiu $a2, $zero, 1
    func_001d33e0();  // 0x1d3390                                // 0x001d8b68: jal 0x1d3390
    ...
    func_001d87d0();  // 0x1d87a0                                // 0x001d8b8c: jal 0x1d87a0
label_0x1d8b94:
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001d8ba4: jal 0x10a4d8
    a2 = 1;                                                     // 0x001d8bb4: addiu $a2, $zero, 1
    func_001d33e0();  // 0x1d3390                                // 0x001d8bb8: jal 0x1d3390
...
label_0x1d8be4:
    ...
    func_001d87d0();  // 0x1d87a0                                // 0x001d8c28: jal 0x1d87a0
label_0x1d8c30:
