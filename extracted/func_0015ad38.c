void func_0015ad38() {
    ...
    func_0015ae80();  // 0x15ae08                                // 0x0015ad60: jal 0x15ae08
...
label_0x15ad88:
    ...
    /* nop */                                                   // 0x0015ada4: nop 
label_0x15ada8:
    func_0015aea8();  // 0x15ae80                                // 0x0015ada8: jal 0x15ae80
    /* nop */                                                   // 0x0015adac: nop 
    func_0015aec8();  // 0x15aea8                                // 0x0015adb0: jal 0x15aea8
    func_0015b0d0();  // 0x15b020                                // 0x0015adbc: jal 0x15b020
    v0 = 0x25 << 16;                                            // 0x0015adc4: lui $v0, 0x25
    func_00158af0();  // 0x158ad0                                // 0x0015adc8: jal 0x158ad0
    s0 = g_00256440;  // Global at 0x00256440                   // 0x0015adcc: lw $s0, 0x6440($v0)
    func_0015af18();  // 0x15aec8                                // 0x0015add0: jal 0x15aec8
    a0 = s0 + 0x6e0;                                            // 0x0015add4: addiu $a0, $s0, 0x6e0
    func_0015afe8();  // 0x15afa0                                // 0x0015add8: jal 0x15afa0
    /* nop */                                                   // 0x0015addc: nop 
    func_0015b020();  // 0x15b018                                // 0x0015ade0: jal 0x15b018
    func_0015b4c8();  // 0x15b498                                // 0x0015ade8: jal 0x15b498
    /* nop */                                                   // 0x0015adec: nop 
label_0x15adf8:
