void func_001860e0() {
    ...
    func_00184048();  // 184048                                // 0x00186108: jal 0x184048
    ...
    func_0010ab20();  // 10ab20                                // 0x00186124: jal 0x10ab20
    ...
    func_0010ac68();  // 10ac68                                // 0x00186144: jal 0x10ac68
    a0 = v0 + a0;                                               // 0x00186148: addu $a0, $v0, $a0
    goto label_0x1861d0;                                        // 0x0018614c: b 0x1861d0
    /* nop */                                                   // 0x00186150: nop 
label_0x186154:
    func_00183fa0();  // 183fa0                                // 0x00186154: jal 0x183fa0
    if (v0 != 0) goto label_0x1861e8;                           // 0x0018615c: bnez $v0, 0x1861e8
    func_00184320();  // 184320                                // 0x00186174: jal 0x184320
...
label_0x1861a8:
    ...
    func_0010ac68();  // 10ac68                                // 0x001861bc: jal 0x10ac68
    func_0010a860();  // 10a860                                // 0x001861c8: jal 0x10a860
label_0x1861d0:
    if (s3 == 0) goto label_0x1861e0;                           // 0x001861d0: beqz $s3, 0x1861e0
    func_0010ac68();  // 10ac68                                // 0x001861d8: jal 0x10ac68
label_0x1861e0:
label_0x1861e8:
