void func_001cd0b0() {
    ...
    func_001cd050();  // 0x1ccff0                                // 0x001cd0d0: jal 0x1ccff0
...
label_0x1cd0f0:
    ...
    func_001ce780();  // 0x1ce750                                // 0x001cd128: jal 0x1ce750
    ...
    thunk_func_001cffd0();  // 0x1ce8a0                          // 0x001cd13c: jal 0x1ce8a0
label_0x1cd144:
    thunk_func_001cffa0();  // 0x1ce810                          // 0x001cd144: jal 0x1ce810
    s4 = v0 & 0xff;                                             // 0x001cd14c: andi $s4, $v0, 0xff
    thunk_func_001cffa0();  // 0x1ce810                          // 0x001cd150: jal 0x1ce810
...
label_0x1cd180:
    ...
    func_001cd0b0();  // 0x1cd050                                // 0x001cd1b4: jal 0x1cd050
    ...
    func_001ce600();  // 0x1ce550                                // 0x001cd1cc: jal 0x1ce550
    a0 = s5 & 0xff;                                             // 0x001cd1d0: andi $a0, $s5, 0xff
    thunk_func_001cfd80();  // 0x1ce780                          // 0x001cd1d4: jal 0x1ce780
...
label_0x1cd1f8:
    func_001ce780();  // 0x1ce750                                // 0x001cd1f8: jal 0x1ce750
...
label_0x1cd274:
    ...
    thunk_func_001cffa0();  // 0x1ce810                          // 0x001cd284: jal 0x1ce810
    /* nop */                                                   // 0x001cd288: nop 
    s4 = v0 & 0xff;                                             // 0x001cd28c: andi $s4, $v0, 0xff
    thunk_func_001cffa0();  // 0x1ce810                          // 0x001cd290: jal 0x1ce810
    thunk_func_001cfeb0();  // 0x1ce800                          // 0x001cd298: jal 0x1ce800
    ...
    func_001cdfc0();  // 0x1cdf70                                // 0x001cd2b4: jal 0x1cdf70
...
label_0x1cd2f8:
    ...
    func_001ce700();  // 0x1ce6f0                                // 0x001cd304: jal 0x1ce6f0
    a0 = 0x32 << 16;                                            // 0x001cd30c: lui $a0, 0x32
    a0 = a0 + 0x3710;                                           // 0x001cd314: addiu $a0, $a0, 0x3710
    thunk_func_001cfdf0();  // 0x1ce7b0                          // 0x001cd318: jal 0x1ce7b0
    thunk_func_001cffd0();  // 0x1ce8a0                          // 0x001cd324: jal 0x1ce8a0
    goto label_0x1cd380;                                        // 0x001cd32c: b 0x1cd380
    /* nop */                                                   // 0x001cd330: nop 
label_0x1cd334:
    thunk_func_001cffa0();  // 0x1ce810                          // 0x001cd334: jal 0x1ce810
    s4 = v0 & 0xff;                                             // 0x001cd33c: andi $s4, $v0, 0xff
    thunk_func_001cffa0();  // 0x1ce810                          // 0x001cd340: jal 0x1ce810
    ...
    func_001ce700();  // 0x1ce6f0                                // 0x001cd358: jal 0x1ce6f0
    /* nop */                                                   // 0x001cd35c: nop 
    a0 = 0x32 << 16;                                            // 0x001cd360: lui $a0, 0x32
    a0 = a0 + 0x3710;                                           // 0x001cd368: addiu $a0, $a0, 0x3710
    thunk_func_001cfdf0();  // 0x1ce7b0                          // 0x001cd36c: jal 0x1ce7b0
    thunk_func_001cffd0();  // 0x1ce8a0                          // 0x001cd378: jal 0x1ce8a0
label_0x1cd380:
label_0x1cd384:
    func_001ce8a0();  // 0x1ce830                                // 0x001cd384: jal 0x1ce830
...
label_0x1cd3c4:
    ...
    func_001cdfc0();  // 0x1cdf70                                // 0x001cd3d4: jal 0x1cdf70
...
label_0x1cd458:
    ...
    func_001cdfc0();  // 0x1cdf70                                // 0x001cd468: jal 0x1cdf70
...
label_0x1cd4a4:
    ...
    /* nop */                                                   // 0x001cd4a8: nop 
label_0x1cd4ac:
    func_001cdfc0();  // 0x1cdf70                                // 0x001cd4b0: jal 0x1cdf70
...
label_0x1cd4f4:
label_0x1cd4f8:
    func_001ce780();  // 0x1ce750                                // 0x001cd4f8: jal 0x1ce750
    /* nop */                                                   // 0x001cd4fc: nop 
label_0x1cd500:
