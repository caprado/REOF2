...
label_0x1c8578:
    ...
    *(uint32_t*)(s3) = v0;                                      // 0x001c8590: sw $v0, 0($s3)
    ...
    func_001c7780();  // 1c7780                                // 0x001c8598: jal 0x1c7780
