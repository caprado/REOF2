void func_0016f0f8() {
    ...
    func_0016f360();  // 0x16f318                                // 0x0016f12c: jal 0x16f318
    a1 = *(int32_t*)((s0) + 0x28);                              // 0x0016f130: lw $a1, 0x28($s0)
label_0x16f134:
    a2 = sp + 4;                                                // 0x0016f13c: addiu $a2, $sp, 4
    func_0016f318();  // 0x16f1a0                                // 0x0016f140: jal 0x16f1a0
    ...
    func_00107b68();  // 0x107ab8                                // 0x0016f164: jal 0x107ab8
    ...
    *(uint32_t*)((v1) + 4) = v0;                                // 0x0016f178: sw $v0, 4($v1)
    /* nop */                                                   // 0x0016f17c: nop 
label_0x16f180:
    func_0016f360();  // 0x16f318                                // 0x0016f180: jal 0x16f318
