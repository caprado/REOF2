...
label_0x1d91e8:
    ...
    func_001aeef0();  // 0x1aee20                                // 0x001d91f4: jal 0x1aee20
    s5 = s5 + 8;                                                // 0x001d91f8: addiu $s5, $s5, 8
    func_001d36b0();  // 0x1d3600                                // 0x001d9200: jal 0x1d3600
    func_001d3d20();  // 0x1d3cb0                                // 0x001d9208: jal 0x1d3cb0
