void func_001442d8() {
    ...
    func_00145898();  // 0x145818                                // 0x00144308: jal 0x145818
    *(uint32_t*)((s0) + 0x134) = 0;                             // 0x0014430c: sw $zero, 0x134($s0)
    func_00145598();  // 0x145478                                // 0x00144314: jal 0x145478
    ...
    func_00148530();  // 0x1484f8                                // 0x00144338: jal 0x1484f8
    goto label_0x1443e0;                                        // 0x00144340: b 0x1443e0
    v0 = 2;                                                     // 0x00144344: addiu $v0, $zero, 2
label_0x144348:
    func_001456a8();  // 0x145598                                // 0x00144348: jal 0x145598
    a1 = 0x20;                                                  // 0x0014434c: addiu $a1, $zero, 0x20
    func_00145900();  // 0x145898                                // 0x00144350: jal 0x145898
    func_001441c0();  // 0x1440b0                                // 0x0014435c: jal 0x1440b0
    *(uint32_t*)(s4) = a2;                                      // 0x00144368: sw $a2, 0($s4)
    ...
    func_00148588();  // 0x148530                                // 0x0014437c: jal 0x148530
