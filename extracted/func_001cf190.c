...
label_0x1cf1ac:
    func_0011c0a0();  // 11c0a0                                // 0x001cf1ac: jal 0x11c0a0
    ...
    func_001ce990();  // 1ce990                                // 0x001cf1c0: jal 0x1ce990
    /* nop */                                                   // 0x001cf1c4: nop 
label_0x1cf1c8:
...
label_0x1cf214:
    ...
    func_001cebd0();  // 1cebd0                                // 0x001cf224: jal 0x1cebd0
    goto label_0x1cf24c;                                        // 0x001cf22c: b 0x1cf24c
    /* nop */                                                   // 0x001cf230: nop 
label_0x1cf234:
    a0 = *(int32_t*)((gp) + -0x6578);                           // 0x001cf234: lw $a0, -0x6578($gp)
    func_001cebd0();  // 1cebd0                                // 0x001cf244: jal 0x1cebd0
label_0x1cf24c:
...
label_0x1cf250:
    ...
    func_001cebd0();  // 1cebd0                                // 0x001cf260: jal 0x1cebd0
    a0 = *(int32_t*)((gp) + -0x656c);                           // 0x001cf268: lw $a0, -0x656c($gp)
    func_001cebd0();  // 1cebd0                                // 0x001cf278: jal 0x1cebd0
    func_001cf5f0();  // 1cf5f0                                // 0x001cf280: jal 0x1cf5f0
    /* nop */                                                   // 0x001cf284: nop 
...
label_0x1cf294:
    ...
    func_001cebd0();  // 1cebd0                                // 0x001cf2a4: jal 0x1cebd0
    a0 = *(int32_t*)((gp) + -0x655c);                           // 0x001cf2ac: lw $a0, -0x655c($gp)
    func_001cebd0();  // 1cebd0                                // 0x001cf2bc: jal 0x1cebd0
    ...
    func_001cebd0();  // 1cebd0                                // 0x001cf2d8: jal 0x1cebd0
...
label_0x1cf304:
    ...
    func_001cebd0();  // 1cebd0                                // 0x001cf314: jal 0x1cebd0
...
label_0x1cf324:
    ...
    func_001cebd0();  // 1cebd0                                // 0x001cf334: jal 0x1cebd0
...
label_0x1cf3c8:
    ...
    func_001cebd0();  // 1cebd0                                // 0x001cf3d8: jal 0x1cebd0
    a0 = *(int32_t*)((gp) + -0x656c);                           // 0x001cf3e0: lw $a0, -0x656c($gp)
    func_001cebd0();  // 1cebd0                                // 0x001cf3f0: jal 0x1cebd0
    func_001cf5f0();  // 1cf5f0                                // 0x001cf3f8: jal 0x1cf5f0
    /* nop */                                                   // 0x001cf3fc: nop 
