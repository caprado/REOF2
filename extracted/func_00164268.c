void func_00164268() {
    ...
    func_00130220();  // 0x1301e0                                // 0x001642c4: jal 0x1301e0
    t0 = 0xf << 16;                                             // 0x001642cc: lui $t0, 0xf
    func_001301a8();  // 0x130138                                // 0x001642e0: jal 0x130138
    ...
    func_00130220();  // 0x1301e0                                // 0x00164334: jal 0x1301e0
    func_001301a8();  // 0x130138                                // 0x0016434c: jal 0x130138
    ...
    func_00130408();  // 0x1303a0                                // 0x001643a4: jal 0x1303a0
    ...
    func_00130458();  // 0x130408                                // 0x001643cc: jal 0x130408
    ...
    *(uint32_t*)(a2) = v0;                                      // 0x00164410: sw $v0, 0($a2)
    ...
    func_0010b2a0();  // 0x10b0e8                                // 0x00164448: jal 0x10b0e8
