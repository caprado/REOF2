void func_001868b0() {
    ...
    func_0010ae00();  // 0x10ac68                                // 0x0018691c: jal 0x10ac68
    func_0010b4b0();  // 0x10b460                                // 0x00186928: jal 0x10b460
    a1 = 0x2f;                                                  // 0x0018692c: addiu $a1, $zero, 0x2f
    a0 = v0 + 1;                                                // 0x00186930: addiu $a0, $v0, 1
    func_0010ae00();  // 0x10ac68                                // 0x00186934: jal 0x10ac68
    func_001822d0();  // 0x182278                                // 0x0018693c: jal 0x182278
...
label_0x186958:
    func_00182278();  // 0x182208                                // 0x00186958: jal 0x182208
...
label_0x186974:
    ...
    func_00184770();  // 0x184320                                // 0x00186988: jal 0x184320
    ...
    func_00184770();  // 0x184320                                // 0x001869b0: jal 0x184320
