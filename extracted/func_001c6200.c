void func_001c6200() {
    ...
    func_001c1980();  // 1c1980                                // 0x001c6240: jal 0x1c1980
    /* nop */                                                   // 0x001c6244: nop 
    func_001b4fd0();  // 1b4fd0                                // 0x001c624c: jal 0x1b4fd0
    a0 = 0x14;                                                  // 0x001c6250: addiu $a0, $zero, 0x14
    v0 = 0x8080 << 16;                                          // 0x001c6254: lui $v0, 0x8080
    func_001b5050();  // 1b5050                                // 0x001c6258: jal 0x1b5050
...
label_0x1c6274:
    ...
    func_0010ac68();  // 10ac68                                // 0x001c627c: jal 0x10ac68
label_0x1c6284:
    a1 = 0x24 << 16;                                            // 0x001c6284: lui $a1, 0x24
    func_0010b4b0();  // 10b4b0                                // 0x001c628c: jal 0x10b4b0
    ...
    *(uint8_t*)(s6) = 0;                                        // 0x001c62a8: sb $zero, 0($s6)
    ...
    func_0010ac68();  // 10ac68                                // 0x001c62d0: jal 0x10ac68
...
label_0x1c6314:
    ...
    *(uint8_t*)(s6) = 0;                                        // 0x001c6338: sb $zero, 0($s6)
    ...
    func_001c24f0();  // 1c24f0                                // 0x001c635c: jal 0x1c24f0
...
label_0x1c63cc:
    func_0010b4b0();  // 10b4b0                                // 0x001c63d0: jal 0x10b4b0
...
label_0x1c63ec:
    func_0010a860();  // 10a860                                // 0x001c63ec: jal 0x10a860
...
label_0x1c6434:
    ...
    func_001c1980();  // 1c1980                                // 0x001c6454: jal 0x1c1980
    a0 = 0x1f;                                                  // 0x001c6458: addiu $a0, $zero, 0x1f
    goto label_0x1c64ac;                                        // 0x001c645c: b 0x1c64ac
label_0x1c6464:
    func_001c1980();  // 1c1980                                // 0x001c6464: jal 0x1c1980
    /* nop */                                                   // 0x001c6468: nop 
...
label_0x1c6474:
    ...
    func_001c2110();  // 1c2110                                // 0x001c648c: jal 0x1c2110
    goto label_0x1c64ac;                                        // 0x001c6494: b 0x1c64ac
    s5 = s5 + 0x16;                                             // 0x001c6498: addiu $s5, $s5, 0x16
label_0x1c649c:
    func_001c1ff0();  // 1c1ff0                                // 0x001c64a0: jal 0x1c1ff0
