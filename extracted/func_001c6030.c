void func_001c6030() {
    ...
    func_001b4ff0();  // 0x1b4fd0                                // 0x001c6048: jal 0x1b4fd0
    a0 = 0x14;                                                  // 0x001c604c: addiu $a0, $zero, 0x14
    v0 = 0x8080 << 16;                                          // 0x001c6050: lui $v0, 0x8080
    func_001b5060();  // 0x1b5050                                // 0x001c6054: jal 0x1b5050
    ...
    func_001c19e0();  // 0x1c1980                                // 0x001c6068: jal 0x1c1980
    s1 = v0 + 0x50;                                             // 0x001c606c: addiu $s1, $v0, 0x50
    goto label_0x1c6090;                                        // 0x001c6070: b 0x1c6090
label_0x1c6078:
    func_001b5010();  // 0x1b4ff0                                // 0x001c6078: jal 0x1b4ff0
    func_001b52d0();  // 0x1b5090                                // 0x001c6080: jal 0x1b5090
