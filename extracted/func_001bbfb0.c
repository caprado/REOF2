void func_001bbfb0() {
    ...
    func_001bc2a0();  // 0x1bc200                                // 0x001bbfe0: jal 0x1bc200
    /* nop */                                                   // 0x001bbfe4: nop 
    goto label_0x1bc178;                                        // 0x001bbfe8: b 0x1bc178
label_0x1bbff0:
    func_001d3d20();  // 0x1d3cb0                                // 0x001bbff4: jal 0x1d3cb0
    ...
    /* nop */                                                   // 0x001bc008: nop 
    func_001ae910();  // 0x1ae8d0                                // 0x001bc00c: jal 0x1ae8d0
    /* nop */                                                   // 0x001bc010: nop 
    a0 = 0xd;                                                   // 0x001bc014: addiu $a0, $zero, 0xd
    func_001aefe0();  // 0x1aefd0                                // 0x001bc018: jal 0x1aefd0
    a0 = 0x5f;                                                  // 0x001bc020: addiu $a0, $zero, 0x5f
    func_001aefe0();  // 0x1aefd0                                // 0x001bc024: jal 0x1aefd0
    a1 = 5;                                                     // 0x001bc028: addiu $a1, $zero, 5
    a0 = 0x60;                                                  // 0x001bc02c: addiu $a0, $zero, 0x60
    func_001aefe0();  // 0x1aefd0                                // 0x001bc030: jal 0x1aefd0
    a0 = 0x63;                                                  // 0x001bc038: addiu $a0, $zero, 0x63
    func_001aefe0();  // 0x1aefd0                                // 0x001bc03c: jal 0x1aefd0
    a0 = 0x6c;                                                  // 0x001bc044: addiu $a0, $zero, 0x6c
    func_001aefe0();  // 0x1aefd0                                // 0x001bc048: jal 0x1aefd0
    a0 = 1;                                                     // 0x001bc050: addiu $a0, $zero, 1
    func_0019d450();  // 0x19d440                                // 0x001bc054: jal 0x19d440
    a1 = sp + 0x4c;                                             // 0x001bc058: addiu $a1, $sp, 0x4c
    a1 = local_4c;                                              // 0x001bc05c: lw $a1, 0x4c($sp)
    func_001aefe0();  // 0x1aefd0                                // 0x001bc060: jal 0x1aefd0
    a0 = 4;                                                     // 0x001bc064: addiu $a0, $zero, 4
    a0 = 4;                                                     // 0x001bc068: addiu $a0, $zero, 4
    func_001aeb00();  // 0x1aea70                                // 0x001bc06c: jal 0x1aea70
    ...
    func_001ab530();  // 0x1ab230                                // 0x001bc088: jal 0x1ab230
    ...
    /* nop */                                                   // 0x001bc098: nop 
    func_001c1f70();  // 0x1c1f20                                // 0x001bc09c: jal 0x1c1f20
...
label_0x1bc0b8:
    ...
    func_001b4ff0();  // 0x1b4fd0                                // 0x001bc0d0: jal 0x1b4fd0
    s0 = s0 + v0;                                               // 0x001bc0d4: addu $s0, $s0, $v0
    func_001b5050();  // 0x1b5040                                // 0x001bc0d8: jal 0x1b5040
    v0 = 0x8080 << 16;                                          // 0x001bc0e0: lui $v0, 0x8080
    func_001b5060();  // 0x1b5050                                // 0x001bc0e4: jal 0x1b5050
...
label_0x1bc108:
    func_001c1f70();  // 0x1c1f20                                // 0x001bc108: jal 0x1c1f20
...
label_0x1bc12c:
    func_001b6220();  // 0x1b6150                                // 0x001bc12c: jal 0x1b6150
    /* nop */                                                   // 0x001bc130: nop 
...
label_0x1bc150:
    func_001b5010();  // 0x1b4ff0                                // 0x001bc150: jal 0x1b4ff0
    func_001b52d0();  // 0x1b5090                                // 0x001bc158: jal 0x1b5090
