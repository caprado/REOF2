void func_00112418() {
    ...
    func_00118730();  // 118730                                // 0x00112434: jal 0x118730
...
label_0x11245c:
    ...
    func_00118d70();  // 118d70                                // 0x0011246c: jal 0x118d70
...
label_0x112480:
    func_001189b8();  // 1189b8                                // 0x00112480: jal 0x1189b8
    a0 = s1 + -9;                                               // 0x00112488: addiu $a0, $s1, -9
    func_00103788();  // 103788                                // 0x0011248c: jal 0x103788
