void func_00129590() {
    ...
    func_001281b8();  // 1281b8                                // 0x001295b4: jal 0x1281b8
    ...
    func_00127d90();  // 127d90                                // 0x001295c8: jal 0x127d90
    /* nop */                                                   // 0x001295cc: nop 
...
label_0x1295f8:
    ...
    func_00127d90();  // 127d90                                // 0x00129604: jal 0x127d90
    ...
    /* nop */                                                   // 0x00129614: nop 
label_0x129618:
    func_001303a0();  // 1303a0                                // 0x00129618: jal 0x1303a0
    /* nop */                                                   // 0x0012961c: nop 
    *(uint8_t*)((s0) + 3) = s1;                                 // 0x00129620: sb $s1, 3($s0)
    ...
    func_001281b8();  // 1281b8                                // 0x00129634: jal 0x1281b8
