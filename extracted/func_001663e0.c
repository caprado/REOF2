void func_001663e0() {
    ...
    func_00166540();  // 166540                                // 0x00166414: jal 0x166540
    ...
    /* mfhi $t0 */                                              // 0x00166440
    func_00166580();  // 166580                                // 0x00166444: jal 0x166580
    /* nop */                                                   // 0x00166448: nop 
    a3 = 1;                                                     // 0x00166458: addiu $a3, $zero, 1
    t0 = 0x800;                                                 // 0x0016645c: addiu $t0, $zero, 0x800
    func_00166580();  // 166580                                // 0x00166460: jal 0x166580
    a3 = 2;                                                     // 0x00166474: addiu $a3, $zero, 2
    func_00166580();  // 166580                                // 0x0016647c: jal 0x166580
...
label_0x1664a0:
    func_001698d0();  // 1698d0                                // 0x001664a0: jal 0x1698d0
    a1 = a1 | 0x40a;                                            // 0x001664a4: ori $a1, $a1, 0x40a
    goto label_0x166520;                                        // 0x001664a8: b 0x166520
label_0x1664b0:
    t0 = 3;                                                     // 0x001664b0: addiu $t0, $zero, 3
    func_00166748();  // 166748                                // 0x001664bc: jal 0x166748
    func_00166800();  // 166800                                // 0x001664d0: jal 0x166800
    a3 = 4;                                                     // 0x001664d4: addiu $a3, $zero, 4
    t0 = 5;                                                     // 0x001664e0: addiu $t0, $zero, 5
    func_00166748();  // 166748                                // 0x001664e8: jal 0x166748
    func_00166800();  // 166800                                // 0x001664fc: jal 0x166800
    a3 = 6;                                                     // 0x00166500: addiu $a3, $zero, 6
    func_00166928();  // 166928                                // 0x00166510: jal 0x166928
