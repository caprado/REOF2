void func_0016c4b0() {
    ...
    *(uint32_t*)(s2) = 0;                                       // 0x0016c4e0: sw $zero, 0($s2)
    func_00166d88();  // 0x166ca8                                // 0x0016c4e4: jal 0x166ca8
    ...
    func_0016cab0();  // 0x16c958                                // 0x0016c504: jal 0x16c958
...
label_0x16c540:
    ...
    *(uint32_t*)(s2) = v1;                                      // 0x0016c554: sw $v1, 0($s2)
    ...
    func_00167160();  // 0x1670f0                                // 0x0016c564: jal 0x1670f0
    a3 = sp + 0x28;                                             // 0x0016c568: addiu $a3, $sp, 0x28
    a1 = local_20;                                              // 0x0016c56c: lw $a1, 0x20($sp)
    func_0016c868();  // 0x16c6c0                                // 0x0016c574: jal 0x16c6c0
...
label_0x16c5a8:
    ...
    func_0016cc18();  // 0x16cab0                                // 0x0016c5bc: jal 0x16cab0
    local_28 = v1;                                              // 0x0016c5c0: sw $v1, 0x28($sp)
    a3 = local_28;                                              // 0x0016c5c8: lw $a3, 0x28($sp)
    func_001671c8();  // 0x167160                                // 0x0016c5d4: jal 0x167160
...
label_0x16c5dc:
    ...
    /* nop */                                                   // 0x0016c5e4: nop 
    func_00158310();  // 0x158278                                // 0x0016c5e8: jal 0x158278
    /* nop */                                                   // 0x0016c5ec: nop 
...
label_0x16c654:
    func_0016cab0();  // 0x16c958                                // 0x0016c654: jal 0x16c958
...
label_0x16c674:
    func_0016c958();  // 0x16c8d0                                // 0x0016c674: jal 0x16c8d0
    goto label_0x16c6a4;                                        // 0x0016c67c: b 0x16c6a4
    /* nop */                                                   // 0x0016c684: nop 
label_0x16c688:
    v0 = local_24;                                              // 0x0016c688: lw $v0, 0x24($sp)
label_0x16c690:
    func_0016c8d0();  // 0x16c868                                // 0x0016c690: jal 0x16c868
label_0x16c698:
