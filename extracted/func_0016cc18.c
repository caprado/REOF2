void func_0016cc18() {
    ...
    *(uint32_t*)(s5) = 0;                                       // 0x0016cc54: sw $zero, 0($s5)
    ...
    func_00171d38();  // 0x171cd8                                // 0x0016cc60: jal 0x171cd8
    *(uint32_t*)((s4) + 0x20) = 0;                              // 0x0016cc64: sw $zero, 0x20($s4)
    ...
    func_0016d308();  // 0x16d2f0                                // 0x0016cc70: jal 0x16d2f0
    ...
    *(uint32_t*)((s4) + 0x20) = v1;                             // 0x0016cc80: sw $v1, 0x20($s4)
    func_00170230();  // 0x170220                                // 0x0016cc84: jal 0x170220
    goto label_0x16ce48;                                        // 0x0016cc8c: b 0x16ce48
    /* nop */                                                   // 0x0016cc94: nop 
label_0x16cc98:
    func_0016c958();  // 0x16c8d0                                // 0x0016cc98: jal 0x16c8d0
    ...
    func_00167898();  // 0x1672a8                                // 0x0016ccbc: jal 0x1672a8
    ...
    func_00170250();  // 0x170240                                // 0x0016ccdc: jal 0x170240
...
label_0x16ce18:
    ...
    func_0016f438();  // 0x16f360                                // 0x0016ce34: jal 0x16f360
