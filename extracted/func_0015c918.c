void func_0015c918() {
    ...
    /* nop */                                                   // 0x0015c974: nop 
label_0x15c978:
    func_0015cdc8();  // 0x15cd60                                // 0x0015c978: jal 0x15cd60
    /* nop */                                                   // 0x0015c97c: nop 
    v1 = 1;                                                     // 0x0015c980: addiu $v1, $zero, 1
    if (v0 != v1) goto label_0x15cc90;                          // 0x0015c984: bne $v0, $v1, 0x15cc90
    func_0015e348();  // 0x15e338                                // 0x0015c98c: jal 0x15e338
    /* nop */                                                   // 0x0015c990: nop 
...
label_0x15c9e0:
    ...
    func_0015e7e0();  // 0x15e7b0                                // 0x0015c9e8: jal 0x15e7b0
    ...
    /* nop */                                                   // 0x0015c9fc: nop 
label_0x15ca00:
    func_0015cd60();  // 0x15ccb8                                // 0x0015ca00: jal 0x15ccb8
...
label_0x15ca3c:
    ...
    *(uint32_t*)((s0) + 0x40) = s3;                             // 0x0015cabc: sw $s3, 0x40($s0)
    ...
    /* nop */                                                   // 0x0015cacc: nop 
label_0x15cad0:
    func_0015c6e0();  // 0x15c580                                // 0x0015cad0: jal 0x15c580
    ...
    func_0015b948();  // 0x15b860                                // 0x0015caf0: jal 0x15b860
    t2 = sp + 0x14;                                             // 0x0015caf4: addiu $t2, $sp, 0x14
    a2 = *(int32_t*)((s1) + 4);                                 // 0x0015cafc: lw $a2, 4($s1)
    func_0015c888();  // 0x15c728                                // 0x0015cb04: jal 0x15c728
    a3 = *(int32_t*)((s1) + 8);                                 // 0x0015cb08: lw $a3, 8($s1)
    func_0015ccb8();  // 0x15c918                                // 0x0015cb0c: jal 0x15c918
...
label_0x15cb28:
    func_0013f0e8();  // 0x13f020                                // 0x0015cb2c: jal 0x13f020
...
label_0x15cb48:
    ...
    *(uint32_t*)((s0) + 8) = 0;                                 // 0x0015cb78: sw $zero, 8($s0)
    func_00175630();  // 0x1755b0                                // 0x0015cb80: jal 0x1755b0
    ...
    *(uint8_t*)((s0) + 0x73) = 0;                               // 0x0015cba8: sb $zero, 0x73($s0)
    func_00163f80();  // 0x163f78                                // 0x0015cbac: jal 0x163f78
    *(uint32_t*)((s0) + 0x5c) = 0;                              // 0x0015cbb0: sw $zero, 0x5c($s0)
    func_00163f98();  // 0x163f88                                // 0x0015cbb8: jal 0x163f88
    ...
    *(uint32_t*)((s0) + 0x44) = v0;                             // 0x0015cbd4: sw $v0, 0x44($s0)
    func_0015f2c8();  // 0x15f270                                // 0x0015cbd8: jal 0x15f270
    func_0013c978();  // 0x13c870                                // 0x0015cbe0: jal 0x13c870
    ...
    *(uint32_t*)((s0) + 0x4c) = v0;                             // 0x0015cbec: sw $v0, 0x4c($s0)
    func_0013c9d0();  // 0x13c9c8                                // 0x0015cbf4: jal 0x13c9c8
    a1 = *(int32_t*)((s0) + 0x44);                              // 0x0015cbf8: lw $a1, 0x44($s0)
    func_0015ce90();  // 0x15cdc8                                // 0x0015cbfc: jal 0x15cdc8
    ...
    func_00160838();  // 0x160820                                // 0x0015cc18: jal 0x160820
    ...
    *(uint32_t*)((s0) + 0xa8) = v0;                             // 0x0015cc24: sw $v0, 0xa8($s0)
    ...
    /* nop */                                                   // 0x0015cc34: nop 
    func_00161238();  // 0x1611a8                                // 0x0015cc3c: jal 0x1611a8
    a1 = *(int32_t*)((s0) + 0x2c);                              // 0x0015cc40: lw $a1, 0x2c($s0)
    func_00161608();  // 0x1615a8                                // 0x0015cc44: jal 0x1615a8
    func_00161698();  // 0x161638                                // 0x0015cc50: jal 0x161638
...
label_0x15cc68:
    func_001634a8();  // 0x163410                                // 0x0015cc68: jal 0x163410
    /* nop */                                                   // 0x0015cc6c: nop 
label_0x15cc70:
    func_0015cf98();  // 0x15ce90                                // 0x0015cc70: jal 0x15ce90
    goto label_0x15cc90;                                        // 0x0015cc78: b 0x15cc90
label_0x15cc80:
    func_001616b8();  // 0x161698                                // 0x0015cc80: jal 0x161698
