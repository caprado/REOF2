...
label_0x1739f8:
    ...
    *(uint32_t*)(a0) = v0;                                      // 0x001739fc: sw $v0, 0($a0)
    ...
    /* nop */                                                   // 0x00173a08: nop 
    func_00173b68();  // 0x173af8                                // 0x00173a10: jal 0x173af8
    a1 = sp + 0x50;                                             // 0x00173a14: addiu $a1, $sp, 0x50
    s3 = local_64;                                              // 0x00173a18: lw $s3, 0x64($sp)
label_0x173a1c:
    func_00168c48();  // 0x168c38                                // 0x00173a1c: jal 0x168c38
    a0 = s0 + 0x78;                                             // 0x00173a20: addiu $a0, $s0, 0x78
    func_001666e0();  // 0x1666a0                                // 0x00173a24: jal 0x1666a0
    func_00173730();  // 0x173708                                // 0x00173a2c: jal 0x173708
    ...
    func_00155db0();  // 0x155b20                                // 0x00173a48: jal 0x155b20
    func_00173460();  // 0x173270                                // 0x00173a54: jal 0x173270
