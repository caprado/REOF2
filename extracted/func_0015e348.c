...
label_0x15e398:
    ...
    func_00163180();  // 0x163140                                // 0x0015e3ac: jal 0x163140
    ...
    *(uint32_t*)((s0) + 8) = v0;                                // 0x0015e3c4: sw $v0, 8($s0)
    ...
    func_0012a028();  // 0x129ea8                                // 0x0015e3d4: jal 0x129ea8
    /* nop */                                                   // 0x0015e3d8: nop 
    func_0013f518();  // 0x13f4b8                                // 0x0015e3dc: jal 0x13f4b8
    /* nop */                                                   // 0x0015e3e0: nop 
    func_0013efd0();  // 0x13ef80                                // 0x0015e3e4: jal 0x13ef80
    /* nop */                                                   // 0x0015e3e8: nop 
    func_0013fd30();  // 0x13fce0                                // 0x0015e3ec: jal 0x13fce0
    /* nop */                                                   // 0x0015e3f0: nop 
    func_001640d8();  // 0x1640c8                                // 0x0015e3f4: jal 0x1640c8
    /* nop */                                                   // 0x0015e3f8: nop 
    if (v0 == 0) goto label_0x15e418;                           // 0x0015e3fc: beqz $v0, 0x15e418
    a0 = -0x65;                                                 // 0x0015e400: addiu $a0, $zero, -0x65
    func_0015e7e0();  // 0x15e7b0                                // 0x0015e404: jal 0x15e7b0
    /* nop */                                                   // 0x0015e408: nop 
    a0 = 0x22 << 16;                                            // 0x0015e40c: lui $a0, 0x22
    func_001634a8();  // 0x163410                                // 0x0015e410: jal 0x163410
    a0 = &str_00227710;  // "ERR20010421A : mwPlyInitSfdFx"     // 0x0015e414: addiu $a0, $a0, 0x7710
label_0x15e418:
    func_0015e5c8();  // 0x15e520                                // 0x0015e418: jal 0x15e520
    ...
    func_001115a0();  // 0x111560                                // 0x0015e438: jal 0x111560
    /* FPU: mul.s $f12, $f0, $f12 */                            // 0x0015e43c: mul.s $f12, $f0, $f12
    a1 = 0 | 0xff80;                                            // 0x0015e440: ori $a1, $zero, 0xff80
    func_001119f0();  // 0x111998                                // 0x0015e448: jal 0x111998
    func_001120e8();  // 0x112048                                // 0x0015e450: jal 0x112048
    func_0015e8a8();  // 0x15e800                                // 0x0015e458: jal 0x15e800
    ...
    func_001634a8();  // 0x163410                                // 0x0015e46c: jal 0x163410
    /* nop */                                                   // 0x0015e470: nop 
label_0x15e474:
    v0 = 0x21 << 16;                                            // 0x0015e474: lui $v0, 0x21
    v1 = 1;                                                     // 0x0015e478: addiu $v1, $zero, 1
    func_0015e690();  // 0x15e658                                // 0x0015e480: jal 0x15e658
    g_00214454 = v1;  // Global at 0x00214454                   // 0x0015e484: sw $v1, 0x4454($v0)
    func_0013d2d8();  // 0x13d258                                // 0x0015e488: jal 0x13d258
    /* nop */                                                   // 0x0015e48c: nop 
    a0 = 0x16 << 16;                                            // 0x0015e490: lui $a0, 0x16
    func_0013d1b8();  // 0x13d190                                // 0x0015e498: jal 0x13d190
    a0 = a0 + -0x1cb8;                                          // 0x0015e49c: addiu $a0, $a0, -0x1cb8
    func_001607e8();  // 0x1607c0                                // 0x0015e4a0: jal 0x1607c0
    /* nop */                                                   // 0x0015e4a4: nop 
    func_0015e520();  // 0x15e4d8                                // 0x0015e4a8: jal 0x15e4d8
