...
label_0x1c73d4:
    func_00128e28();  // 0x128d88                                // 0x001c73d8: jal 0x128d88
    /* nop */                                                   // 0x001c73e4: nop 
    if (v0 == 0) goto label_0x1c73d4;                           // 0x001c73e8: beqz $v0, 0x1c73d4
    /* nop */                                                   // 0x001c73ec: nop 
    func_00129968();  // 0x1298c8                                // 0x001c73f0: jal 0x1298c8
    func_001294a0();  // 0x129460                                // 0x001c7400: jal 0x129460
label_0x1c7408:
    func_00129a38();  // 0x129a08                                // 0x001c7408: jal 0x129a08
    v1 = 3;                                                     // 0x001c7410: addiu $v1, $zero, 3
    /* nop */                                                   // 0x001c7414: nop 
    /* nop */                                                   // 0x001c7418: nop 
    if (v0 != v1) goto label_0x1c7408;                          // 0x001c741c: bne $v0, $v1, 0x1c7408
    /* nop */                                                   // 0x001c7420: nop 
    func_001290c8();  // 0x129010                                // 0x001c7424: jal 0x129010
    v0 = 1;                                                     // 0x001c742c: addiu $v0, $zero, 1
    func_001c0d00();  // 0x1c0c00                                // 0x001c7434: jal 0x1c0c00
