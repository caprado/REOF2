void func_0019f420() {
    ...
    thunk_func_001a0a20();  // 0x18dab0                          // 0x0019f43c: jal 0x18dab0
    func_0018db10();  // 0x18db00                                // 0x0019f448: jal 0x18db00
    a1 = 0x4000;                                                // 0x0019f454: addiu $a1, $zero, 0x4000
    func_00189b70();  // 0x189b20                                // 0x0019f458: jal 0x189b20
...
label_0x19f464:
    ...
    func_00113630();  // 0x113448                                // 0x0019f484: jal 0x113448
    t3 = 0x40;                                                  // 0x0019f488: addiu $t3, $zero, 0x40
    iFlushCache();  // 0x114560                                 // 0x0019f48c: jal 0x114560
    a0 = sp + 0x40;                                             // 0x0019f494: addiu $a0, $sp, 0x40
    func_001137b0();  // 0x113630                                // 0x0019f498: jal 0x113630
    func_00113448();  // 0x113130                                // 0x0019f4a4: jal 0x113130
    ...
    thunk_func_001a0a10();  // 0x18daf0                          // 0x0019f4bc: jal 0x18daf0
