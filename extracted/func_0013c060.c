void func_0013c060() {
    ...
    func_00107c70();  // 107c70                                // 0x0013c0a8: jal 0x107c70
...
label_0x13c0d0:
    ...
    func_0013bb40();  // 13bb40                                // 0x0013c0f4: jal 0x13bb40
    ...
    func_00137ec8();  // 137ec8                                // 0x0013c108: jal 0x137ec8
    /* nop */                                                   // 0x0013c10c: nop 
    a1 = 1;                                                     // 0x0013c110: addiu $a1, $zero, 1
    func_001381d8();  // 1381d8                                // 0x0013c114: jal 0x1381d8
    a0 = 0x6601;                                                // 0x0013c11c: addiu $a0, $zero, 0x6601
    func_00137ec8();  // 137ec8                                // 0x0013c120: jal 0x137ec8
    ...
    func_00116508();  // 116508                                // 0x0013c148: jal 0x116508
...
label_0x13c158:
    *(uint32_t*)(s2) = s0;                                      // 0x0013c158: sw $s0, 0($s2)
    func_0013b1e8();  // 13b1e8                                // 0x0013c15c: jal 0x13b1e8
    ...
    *(uint32_t*)((s2) + 4) = v0;                                // 0x0013c174: sw $v0, 4($s2)
    ...
    func_00116508();  // 116508                                // 0x0013c188: jal 0x116508
    /* nop */                                                   // 0x0013c18c: nop 
label_0x13c190:
    func_00137ec8();  // 137ec8                                // 0x0013c190: jal 0x137ec8
    a0 = 0x6800;                                                // 0x0013c194: addiu $a0, $zero, 0x6800
    func_00138240();  // 138240                                // 0x0013c198: jal 0x138240
    func_00137ec8();  // 137ec8                                // 0x0013c1a0: jal 0x137ec8
    a0 = 0x6801;                                                // 0x0013c1a4: addiu $a0, $zero, 0x6801
    func_00137ec8();  // 137ec8                                // 0x0013c1a8: jal 0x137ec8
    ...
    func_001381d8();  // 1381d8                                // 0x0013c1b8: jal 0x1381d8
    func_00137ec8();  // 137ec8                                // 0x0013c1c0: jal 0x137ec8
...
label_0x13c1d8:
    ...
    func_00116508();  // 116508                                // 0x0013c1ec: jal 0x116508
...
label_0x13c1f4:
    ...
    func_00116508();  // 116508                                // 0x0013c210: jal 0x116508
