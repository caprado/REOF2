...
label_0x1aa4d8:
    ...
    func_0010ae00();  // 0x10ac68                                // 0x001aa52c: jal 0x10ac68
    a0 = sp + 0xa0;                                             // 0x001aa530: addiu $a0, $sp, 0xa0
    a0 = sp + 0xa0;                                             // 0x001aa534: addiu $a0, $sp, 0xa0
    func_0010b4b0();  // 0x10b460                                // 0x001aa538: jal 0x10b460
...
label_0x1aa54c:
    ...
    func_0010a990();  // 0x10a860                                // 0x001aa550: jal 0x10a860
    a1 = a1 + 0x58e8;                                           // 0x001aa554: addiu $a1, $a1, 0x58e8
    a0 = sp + 0xa0;                                             // 0x001aa558: addiu $a0, $sp, 0xa0
    func_001a9b80();  // 0x1a9b30                                // 0x001aa560: jal 0x1a9b30
...
label_0x1aa578:
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001aa594: jal 0x10a4d8
    a1 = &str_002358f0;  // "%s%s.NBD"                          // 0x001aa598: addiu $a1, $a1, 0x58f0
    a0 = sp + 0xa0;                                             // 0x001aa59c: addiu $a0, $sp, 0xa0
    func_001a9b80();  // 0x1a9b30                                // 0x001aa5a0: jal 0x1a9b30
...
label_0x1aa61c:
    ...
    func_001aeef0();  // 0x1aee20                                // 0x001aa624: jal 0x1aee20
    func_001d3a90();  // 0x1d3a30                                // 0x001aa630: jal 0x1d3a30
...
label_0x1aa648:
    ...
    /* nop */                                                   // 0x001aa650: nop 
    func_0018db40();  // 0x18db10                                // 0x001aa654: jal 0x18db10
    /* nop */                                                   // 0x001aa658: nop 
    ...
    func_001d6250();  // 0x1d61c0                                // 0x001aa684: jal 0x1d61c0
    func_0018db40();  // 0x18db10                                // 0x001aa68c: jal 0x18db10
    /* nop */                                                   // 0x001aa690: nop 
label_0x1aa694:
label_0x1aa698:
