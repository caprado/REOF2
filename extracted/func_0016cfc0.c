...
label_0x16d054:
    ...
    func_00175958();  // 0x175910                                // 0x0016d058: jal 0x175910
    a1 = a1 | 0xffff;                                           // 0x0016d05c: ori $a1, $a1, 0xffff
    a0 = s1 + 0x44;                                             // 0x0016d060: addiu $a0, $s1, 0x44
    func_00175958();  // 0x175910                                // 0x0016d064: jal 0x175910
