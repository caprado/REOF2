void func_0016e338() {
    ...
    func_001752f8();  // 0x1752e8                                // 0x0016e364: jal 0x1752e8
    ...
    func_001752f8();  // 0x1752e8                                // 0x0016e378: jal 0x1752e8
...
label_0x16e390:
    ...
    func_0016e5a0();  // 0x16e550                                // 0x0016e39c: jal 0x16e550
    ...
    func_0016e5f0();  // 0x16e5a0                                // 0x0016e3b0: jal 0x16e5a0
    if (v0 != 0) goto label_0x16e3f8;                           // 0x0016e3b8: bnez $v0, 0x16e3f8
    func_0016e678();  // 0x16e5f0                                // 0x0016e3c4: jal 0x16e5f0
    if (v0 != 0) goto label_0x16e3f8;                           // 0x0016e3cc: bnez $v0, 0x16e3f8
    func_0016e488();  // 0x16e428                                // 0x0016e3d4: jal 0x16e428
    /* bnezl $v0, 0x16e3f8 */                                   // 0x0016e3dc: bnezl $v0, 0x16e3f8
    func_0016e7f0();  // 0x16e678                                // 0x0016e3e8: jal 0x16e678
    s2 = ((unsigned)0 < (unsigned)v0) ? 1 : 0;                  // 0x0016e3f0: sltu $s2, $zero, $v0
label_0x16e3f4:
label_0x16e3f8:
    func_0016e550();  // 0x16e488                                // 0x0016e3fc: jal 0x16e488
label_0x16e408:
