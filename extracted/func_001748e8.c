void func_001748e8() {
    ...
    func_00169b10();  // 0x169af0                                // 0x00174914: jal 0x169af0
    *(uint32_t*)(s1) = 0;                                       // 0x00174918: sw $zero, 0($s1)
    ...
    func_00169940();  // 0x1698d0                                // 0x0017492c: jal 0x1698d0
    a1 = a1 | 0x156;                                            // 0x00174930: ori $a1, $a1, 0x156
    goto label_0x174970;                                        // 0x00174934: b 0x174970
    /* nop */                                                   // 0x0017493c: nop 
label_0x174940:
    func_001748e8();  // 0x174878                                // 0x00174940: jal 0x174878
    ...
    func_001749e0();  // 0x174988                                // 0x00174960: jal 0x174988
