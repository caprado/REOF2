void func_00111998() {
    ...
    func_00111738();  // 0x111678                                // 0x001119b0: jal 0x111678
    s0 = sp + 0x20;                                             // 0x001119b8: addiu $s0, $sp, 0x20
    a0 = sp + 0x68;                                             // 0x001119bc: addiu $a0, $sp, 0x68
    func_00111738();  // 0x111678                                // 0x001119c0: jal 0x111678
    func_00111998();  // 0x111738                                // 0x001119d0: jal 0x111738
    a2 = sp + 0x40;                                             // 0x001119d4: addiu $a2, $sp, 0x40
    func_00111678();  // 0x1115a0                                // 0x001119d8: jal 0x1115a0
