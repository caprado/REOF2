void func_001b9b00() {
    ...
    func_001ac990();  // 1ac990                                // 0x001b9b10: jal 0x1ac990
    /* nop */                                                   // 0x001b9b14: nop 
    func_001adbe0();  // 1adbe0                                // 0x001b9b18: jal 0x1adbe0
    /* nop */                                                   // 0x001b9b1c: nop 
...
label_0x1b9b28:
    ...
    func_001ac990();  // 1ac990                                // 0x001b9b40: jal 0x1ac990
    s0 = v0 + v1;                                               // 0x001b9b44: addu $s0, $v0, $v1
    func_001adbe0();  // 1adbe0                                // 0x001b9b48: jal 0x1adbe0
    /* nop */                                                   // 0x001b9b4c: nop 
    ...
    /* nop */                                                   // 0x001b9bbc: nop 
label_0x1b9bc0:
    func_001b9c10();  // 1b9c10                                // 0x001b9bc0: jal 0x1b9c10
label_0x1b9bc8:
    a1 = *(int16_t*)((s0) + 2);                                 // 0x001b9bc8: lh $a1, 2($s0)
    a0 = 1;                                                     // 0x001b9bcc: addiu $a0, $zero, 1
    func_001ad420();  // 1ad420                                // 0x001b9bd0: jal 0x1ad420
