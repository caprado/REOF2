...
label_0x195078:
    ...
    func_00189ad0();  // 0x1899f8                                // 0x00195084: jal 0x1899f8
    ...
    func_001910b0();  // 0x191030                                // 0x00195098: jal 0x191030
    ...
    func_001910b0();  // 0x191030                                // 0x001950ac: jal 0x191030
    a0 = sp + 0xa0;                                             // 0x001950b4: addiu $a0, $sp, 0xa0
    func_001918f0();  // 0x191860                                // 0x001950bc: jal 0x191860
    ...
    *(float*)(s0) = FPU_F0;  // Store float                     // 0x001950e4: swc1 $f0, 0($s0)
    func_00198aa0();  // 0x1989a0                                // 0x001950e8: jal 0x1989a0
    ...
    func_00198930();  // 0x198910                                // 0x00195138: jal 0x198910
    ...
    func_00198970();  // 0x198930                                // 0x00195148: jal 0x198930
    ...
    func_001989a0();  // 0x198970                                // 0x00195158: jal 0x198970
    ...
    func_00194000();  // 0x193f40                                // 0x00195168: jal 0x193f40
...
label_0x195200:
    ...
    func_001918f0();  // 0x191860                                // 0x0019521c: jal 0x191860
    ...
    *(float*)(s0) = FPU_F0;  // Store float                     // 0x0019523c: swc1 $f0, 0($s0)
    func_00198aa0();  // 0x1989a0                                // 0x00195240: jal 0x1989a0
    ...
    func_00194000();  // 0x193f40                                // 0x001952b8: jal 0x193f40
...
label_0x195350:
    ...
    func_00193f40();  // 0x193e90                                // 0x00195364: jal 0x193e90
