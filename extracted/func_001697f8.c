...
label_0x169820:
    ...
    func_00173708();  // 0x173668                                // 0x0016982c: jal 0x173668
    /* nop */                                                   // 0x00169830: nop 
label_0x169838:
    ...
    func_00175710();  // 0x175708                                // 0x0016984c: jal 0x175708
    func_001663e0();  // 0x1663d8                                // 0x00169854: jal 0x1663d8
    a0 = s0 + 0xc;                                              // 0x00169858: addiu $a0, $s0, 0xc
    func_001772a0();  // 0x177208                                // 0x0016985c: jal 0x177208
    a0 = s0 + 0x10;                                             // 0x00169860: addiu $a0, $s0, 0x10
    func_00169b88();  // 0x169b80                                // 0x00169864: jal 0x169b80
    func_00169b78();  // 0x169b60                                // 0x0016986c: jal 0x169b60
    /* nop */                                                   // 0x00169870: nop 
    func_00169b40();  // 0x169b28                                // 0x00169874: jal 0x169b28
    /* nop */                                                   // 0x00169878: nop 
