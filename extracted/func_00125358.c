void func_00125358() {
    ...
    func_00134c58();  // 134c58                                // 0x0012537c: jal 0x134c58
...
label_0x1253c0:
    ...
    func_00134d38();  // 134d38                                // 0x001253c8: jal 0x134d38
    a0 = *(int32_t*)((s0) + 8);                                 // 0x001253cc: lw $a0, 8($s0)
    func_00134c58();  // 134c58                                // 0x001253d0: jal 0x134c58
    ...
    func_001251d8();  // 1251d8                                // 0x001253e8: jal 0x1251d8
    /* nop */                                                   // 0x001253ec: nop 
    func_00134d08();  // 134d08                                // 0x001253f0: jal 0x134d08
