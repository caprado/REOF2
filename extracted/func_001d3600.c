...
label_0x1d362c:
    ...
    *(uint32_t*)(s0) = v0;                                      // 0x001d3634: sw $v0, 0($s0)
    ...
    /* nop */                                                   // 0x001d3658: nop 
    *(uint32_t*)((s0) + 4) = s1;                                // 0x001d365c: sw $s1, 4($s0)
    v0 = local_34;                                              // 0x001d3660: lw $v0, 0x34($sp)
    *(uint16_t*)((s0) + 8) = v0;                                // 0x001d3664: sh $v0, 8($s0)
    v0 = local_38;                                              // 0x001d3668: lw $v0, 0x38($sp)
    *(uint16_t*)((s0) + 0xa) = v0;                              // 0x001d366c: sh $v0, 0xa($s0)
    v0 = local_44;                                              // 0x001d3670: lw $v0, 0x44($sp)
    *(uint16_t*)((s0) + 0xc) = v0;                              // 0x001d3674: sh $v0, 0xc($s0)
    *(uint16_t*)((s0) + 0xe) = v1;                              // 0x001d3678: sh $v1, 0xe($s0)
label_0x1d367c:
...
label_0x1d3690:
    ...
    /* FPU: xori.b $w0, $w0, 0xb0 */                            // 0x001d3698: xori.b $w0, $w0, 0xb0
    return;                                                     // 0x001d369c: jr $ra
    sp = sp + 0x80;                                             // 0x001d36a0: addiu $sp, $sp, 0x80
}