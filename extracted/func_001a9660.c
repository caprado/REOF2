void func_001a9660() {
    ...
    func_001a9030();  // 0x1a8fc0                                // 0x001a9690: jal 0x1a8fc0
    a0 = 9;                                                     // 0x001a9694: addiu $a0, $zero, 9
    if (s3 != 0) goto label_0x1a96b4;                           // 0x001a9698: bnez $s3, 0x1a96b4
    func_001a9660();  // 0x1a94b0                                // 0x001a96a4: jal 0x1a94b0
...
label_0x1a9710:
    ...
    /* nop */                                                   // 0x001a9718: nop 
    func_001af5c0();  // 0x1af560                                // 0x001a971c: jal 0x1af560
    /* nop */                                                   // 0x001a9720: nop 
label_0x1a9724:
    a0 = *(int32_t*)((gp) + -0x63e4);                           // 0x001a9724: lw $a0, -0x63e4($gp)
label_0x1a9728:
    func_00129a38();  // 0x129a08                                // 0x001a9728: jal 0x129a08
    /* nop */                                                   // 0x001a972c: nop 
    v1 = 3;                                                     // 0x001a9730: addiu $v1, $zero, 3
    if (v0 != v1) goto label_0x1a9710;                          // 0x001a9734: bne $v0, $v1, 0x1a9710
    /* nop */                                                   // 0x001a9738: nop 
    func_001290c8();  // 0x129010                                // 0x001a973c: jal 0x129010
