void func_00145818() {
    ...
    func_00144f18();  // 144f18                                // 0x00145828: jal 0x144f18
    ...
    func_00145598();  // 145598                                // 0x00145850: jal 0x145598
    goto label_0x145868;                                        // 0x00145858: b 0x145868
    s1 = 1;                                                     // 0x0014585c: addiu $s1, $zero, 1
label_0x145860:
    func_00145598();  // 145598                                // 0x00145860: jal 0x145598
    a1 = 8;                                                     // 0x00145864: addiu $a1, $zero, 8
label_0x145868:
    func_00145478();  // 145478                                // 0x0014586c: jal 0x145478
