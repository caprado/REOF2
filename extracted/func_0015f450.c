void func_0015f450() {
    ...
    func_0015f5c0();  // 0x15f5a0                                // 0x0015f4d4: jal 0x15f5a0
    /* nop */                                                   // 0x0015f4d8: nop 
    a2 = 0x26 << 16;                                            // 0x0015f4dc: lui $a2, 0x26
    a2 = a2 + -0x6240;                                          // 0x0015f4e0: addiu $a2, $a2, -0x6240
    a1 = 0x4000;                                                // 0x0015f4e4: addiu $a1, $zero, 0x4000
    func_0015f628();  // 0x15f5c0                                // 0x0015f4e8: jal 0x15f5c0
    func_0015f6d8();  // 0x15f690                                // 0x0015f4f0: jal 0x15f690
    ...
    func_0015f690();  // 0x15f628                                // 0x0015f504: jal 0x15f628
    func_0015f6d8();  // 0x15f690                                // 0x0015f50c: jal 0x15f690
