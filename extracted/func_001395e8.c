void func_001395e8() {
    ...
    /* nop */                                                   // 0x0013960c: nop 
label_0x139610:
    func_0013a770();  // 0x13a6c0                                // 0x00139610: jal 0x13a6c0
    ...
    func_00139fb0();  // 0x139f08                                // 0x00139630: jal 0x139f08
    /* nop */                                                   // 0x00139634: nop 
    func_00137fb0();  // 0x137ec8                                // 0x00139638: jal 0x137ec8
    a0 = 0 | 0x8200;                                            // 0x0013963c: ori $a0, $zero, 0x8200
    func_00100e38();  // 0x100d98                                // 0x00139640: jal 0x100d98
    func_00137fb0();  // 0x137ec8                                // 0x00139648: jal 0x137ec8
    a0 = 0 | 0x8201;                                            // 0x0013964c: ori $a0, $zero, 0x8201
    func_00139390();  // 0x1392e8                                // 0x00139654: jal 0x1392e8
    ...
    func_00116598();  // 0x116508                                // 0x00139678: jal 0x116508
...
label_0x13968c:
    func_001392e8();  // 0x1392b8                                // 0x0013968c: jal 0x1392b8
    /* nop */                                                   // 0x00139690: nop 
