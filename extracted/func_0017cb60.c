void func_0017cb60() {
    ...
    func_00107d30();  // 0x107c70                                // 0x0017cb7c: jal 0x107c70
    v1 = 8;                                                     // 0x0017cb84: addiu $v1, $zero, 8
    g_002158a4 = v1;  // Global at 0x002158a4                   // 0x0017cb88: sw $v1, 4($s0)
    func_0017ced8();  // 0x17cec8                                // 0x0017cb8c: jal 0x17cec8
    a0 = 1;                                                     // 0x0017cb90: addiu $a0, $zero, 1
    func_00148ec0();  // 0x148e88                                // 0x0017cb94: jal 0x148e88
    /* nop */                                                   // 0x0017cb98: nop 
    ...
    func_0017d408();  // 0x17d400                                // 0x0017cbcc: jal 0x17d400
    /* nop */                                                   // 0x0017cbd0: nop 
    func_0017a340();  // 0x17a338                                // 0x0017cbd4: jal 0x17a338
    /* nop */                                                   // 0x0017cbd8: nop 
    func_0017d348();  // 0x17d310                                // 0x0017cbdc: jal 0x17d310
    /* nop */                                                   // 0x0017cbe0: nop 
    func_00148ec8();  // 0x148ec0                                // 0x0017cbe4: jal 0x148ec0
    /* nop */                                                   // 0x0017cbe8: nop 
