void func_00105660() {
    ...
    func_00105660();  // 0x1055a8                                // 0x00105680: jal 0x1055a8
    if (s1 == 0) goto label_0x105724;                           // 0x0010568c: beqz $s1, 0x105724
    func_001054d8();  // 0x1053e0                                // 0x00105694: jal 0x1053e0
    /* nop */                                                   // 0x00105698: nop 
    ...
    func_00108e78();  // 0x108e18                                // 0x001056b0: jal 0x108e18
...
label_0x1056f0:
    ...
    *(uint32_t*)((s0) + 0x1c) = s0;                             // 0x0010570c: sw $s0, 0x1c($s0)
    func_001061f8();  // 0x105d48                                // 0x00105718: jal 0x105d48
