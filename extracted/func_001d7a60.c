void func_001d7a60() {
    ...
    func_001d3c20();  // 1d3c20                                // 0x001d7a98: jal 0x1d3c20
    a0 = v0 + 0x2100;                                           // 0x001d7a9c: addiu $a0, $v0, 0x2100
    a0 = 0x15;                                                  // 0x001d7aa0: addiu $a0, $zero, 0x15
    func_001aefd0();  // 1aefd0                                // 0x001d7aa4: jal 0x1aefd0
    a0 = 1;                                                     // 0x001d7aac: addiu $a0, $zero, 1
    func_001aefd0();  // 1aefd0                                // 0x001d7ab0: jal 0x1aefd0
    a0 = 0x12;                                                  // 0x001d7ab8: addiu $a0, $zero, 0x12
    func_001aefd0();  // 1aefd0                                // 0x001d7abc: jal 0x1aefd0
    a0 = 0x62;                                                  // 0x001d7ac4: addiu $a0, $zero, 0x62
    func_001aefd0();  // 1aefd0                                // 0x001d7ac8: jal 0x1aefd0
    a0 = 0xc;                                                   // 0x001d7ad0: addiu $a0, $zero, 0xc
    func_001aefd0();  // 1aefd0                                // 0x001d7ad4: jal 0x1aefd0
    a0 = 0x66;                                                  // 0x001d7adc: addiu $a0, $zero, 0x66
    func_001aefd0();  // 1aefd0                                // 0x001d7ae0: jal 0x1aefd0
    a1 = 1;                                                     // 0x001d7ae4: addiu $a1, $zero, 1
    a0 = 2;                                                     // 0x001d7ae8: addiu $a0, $zero, 2
    func_001aefd0();  // 1aefd0                                // 0x001d7aec: jal 0x1aefd0
    ...
    func_001b2780();  // 1b2780                                // 0x001d7b0c: jal 0x1b2780
    ...
    func_001d4db0();  // 1d4db0                                // 0x001d7b40: jal 0x1d4db0
...
label_0x1d7b48:
    ...
    func_00107c70();  // 107c70                                // 0x001d7b88: jal 0x107c70
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001d7bcc: jal 0x10a4d8
    a0 = sp + 0x60;                                             // 0x001d7bd4: addiu $a0, $sp, 0x60
    a2 = 1;                                                     // 0x001d7bdc: addiu $a2, $zero, 1
    func_001d3390();  // 1d3390                                // 0x001d7be0: jal 0x1d3390
...
label_0x1d7c24:
    ...
    func_00107ab8();  // 107ab8                                // 0x001d7c44: jal 0x107ab8
    ...
    func_00107ab8();  // 107ab8                                // 0x001d7c7c: jal 0x107ab8
    ...
    /* nop */                                                   // 0x001d7ccc: nop 
label_0x1d7cd0:
    func_001b0430();  // 1b0430                                // 0x001d7cd0: jal 0x1b0430
    /* nop */                                                   // 0x001d7cd4: nop 
    func_001aeef0();  // 1aeef0                                // 0x001d7cd8: jal 0x1aeef0
    ...
    func_001b3260();  // 1b3260                                // 0x001d7d04: jal 0x1b3260
...
label_0x1d7d30:
    ...
    func_001ba2a0();  // 1ba2a0                                // 0x001d7d68: jal 0x1ba2a0
...
label_0x1d7d90:
    func_001aeef0();  // 1aeef0                                // 0x001d7d90: jal 0x1aeef0
    /* nop */                                                   // 0x001d7d94: nop 
label_0x1d7d98:
    ...
    func_00107ab8();  // 107ab8                                // 0x001d7db0: jal 0x107ab8
