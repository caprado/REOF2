void func_00110fd0() {
    ...
    func_00111f90();  // 111f90                                // 0x00110ff0: jal 0x111f90
    /* nop */                                                   // 0x00110ff4: nop 
    func_00111a58();  // 111a58                                // 0x00111000: jal 0x111a58
    /* nop */                                                   // 0x00111004: nop 
    func_00111a58();  // 111a58                                // 0x00111010: jal 0x111a58
    /* nop */                                                   // 0x00111014: nop 
    v0 = 0xffff << 16;                                          // 0x0011101c: lui $v0, 0xffff
    s0 = s0 & v0;                                               // 0x00111024: and $s0, $s0, $v0
    func_00111f90();  // 111f90                                // 0x00111030: jal 0x111f90
    a1 = 0 | 0x83e0;                                            // 0x00111038: ori $a1, $zero, 0x83e0
    if (s0 >= 0) goto label_0x111054;                           // 0x00111040: bgez $s0, 0x111054
    /* nop */                                                   // 0x00111044: nop 
    func_00111998();  // 111998                                // 0x0011104c: jal 0x111998
    /* nop */                                                   // 0x00111050: nop 
label_0x111054:
    func_00111998();  // 111998                                // 0x0011105c: jal 0x111998
    /* nop */                                                   // 0x00111060: nop 
