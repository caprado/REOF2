...
label_0x13b018:
    ...
    func_0013bb40();  // 13bb40                                // 0x0013b038: jal 0x13bb40
    func_00137ec8();  // 137ec8                                // 0x0013b040: jal 0x137ec8
    a0 = 0x4400;                                                // 0x0013b044: addiu $a0, $zero, 0x4400
    func_001381d8();  // 1381d8                                // 0x0013b04c: jal 0x1381d8
    a1 = 1;                                                     // 0x0013b050: addiu $a1, $zero, 1
    a0 = 0x4401;                                                // 0x0013b054: addiu $a0, $zero, 0x4401
    func_00137ec8();  // 137ec8                                // 0x0013b058: jal 0x137ec8
    ...
    func_00116508();  // 116508                                // 0x0013b084: jal 0x116508
...
label_0x13b0a0:
    ...
    func_00116508();  // 116508                                // 0x0013b0c4: jal 0x116508
...
label_0x13b0e0:
    ...
    func_00116508();  // 116508                                // 0x0013b0fc: jal 0x116508
...
label_0x13b108:
    ...
    /* nop */                                                   // 0x0013b114: nop 
label_0x13b118:
    func_00137ec8();  // 137ec8                                // 0x0013b118: jal 0x137ec8
    a0 = 0x4600;                                                // 0x0013b11c: addiu $a0, $zero, 0x4600
    func_001380a8();  // 1380a8                                // 0x0013b128: jal 0x1380a8
    func_00137ec8();  // 137ec8                                // 0x0013b130: jal 0x137ec8
    a0 = 0x4601;                                                // 0x0013b134: addiu $a0, $zero, 0x4601
    func_00137ec8();  // 137ec8                                // 0x0013b138: jal 0x137ec8
    a0 = 0x4600;                                                // 0x0013b13c: addiu $a0, $zero, 0x4600
    func_001380a8();  // 1380a8                                // 0x0013b148: jal 0x1380a8
    a2 = 2;                                                     // 0x0013b14c: addiu $a2, $zero, 2
    a0 = 0x4601;                                                // 0x0013b150: addiu $a0, $zero, 0x4601
    func_00137ec8();  // 137ec8                                // 0x0013b154: jal 0x137ec8
    if (s1 >= 0) goto label_0x13b190;                           // 0x0013b15c: bgez $s1, 0x13b190
    a1 = 0x22 << 16;                                            // 0x0013b160: lui $a1, 0x22
    func_0013ac88();  // 13ac88                                // 0x0013b168: jal 0x13ac88
    a1 = &str_002257e8;  // "E0092707:sceClose fail.(htCiGetFileSize)" // 0x0013b16c: addiu $a1, $a1, 0x57e8
    func_00137ec8();  // 137ec8                                // 0x0013b170: jal 0x137ec8
    a0 = 0x4500;                                                // 0x0013b174: addiu $a0, $zero, 0x4500
    func_00138240();  // 138240                                // 0x0013b178: jal 0x138240
    func_00137ec8();  // 137ec8                                // 0x0013b180: jal 0x137ec8
    a0 = 0x4501;                                                // 0x0013b184: addiu $a0, $zero, 0x4501
    goto label_0x13b1d4;                                        // 0x0013b188: b 0x13b1d4
label_0x13b190:
    func_00137ec8();  // 137ec8                                // 0x0013b190: jal 0x137ec8
    a0 = 0x5000;                                                // 0x0013b194: addiu $a0, $zero, 0x5000
    func_00138240();  // 138240                                // 0x0013b198: jal 0x138240
    a0 = 0x5001;                                                // 0x0013b1a0: addiu $a0, $zero, 0x5001
    func_00137ec8();  // 137ec8                                // 0x0013b1a4: jal 0x137ec8
...
label_0x13b1c0:
    func_0013ac88();  // 13ac88                                // 0x0013b1c0: jal 0x13ac88
    /* nop */                                                   // 0x0013b1c4: nop 
