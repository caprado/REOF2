void func_001bd490() {
    ...
    func_001bddd0();  // 0x1bdd90                                // 0x001bd4ac: jal 0x1bdd90
    a0 = sp + 0x40;                                             // 0x001bd4b0: addiu $a0, $sp, 0x40
    a0 = sp + 0x40;                                             // 0x001bd4b4: addiu $a0, $sp, 0x40
    a1 = 1;                                                     // 0x001bd4b8: addiu $a1, $zero, 1
    func_001189b8();  // 0x118730                                // 0x001bd4bc: jal 0x118730
    if (v0 < 0) goto label_0x1bd5b4;                            // 0x001bd4c4: bltz $v0, 0x1bd5b4
    func_00118d70();  // 0x118b38                                // 0x001bd4d4: jal 0x118b38
    a2 = 2;                                                     // 0x001bd4d8: addiu $a2, $zero, 2
    func_00118d70();  // 0x118b38                                // 0x001bd4e8: jal 0x118b38
    a1 = *(int32_t*)((s0) + 0xc);                               // 0x001bd4f0: lw $a1, 0xc($s0)
    func_00118fd0();  // 0x118d70                                // 0x001bd4f8: jal 0x118d70
    func_00118b38();  // 0x1189b8                                // 0x001bd500: jal 0x1189b8
...
label_0x1bd520:
    ...
    *(uint32_t*)((s0) + 0x3c) = v0;                             // 0x001bd52c: sw $v0, 0x3c($s0)
    ...
    func_001bddd0();  // 0x1bdd90                                // 0x001bd534: jal 0x1bdd90
    a0 = sp + 0x40;                                             // 0x001bd538: addiu $a0, $sp, 0x40
    a0 = sp + 0x40;                                             // 0x001bd53c: addiu $a0, $sp, 0x40
    a1 = 1;                                                     // 0x001bd540: addiu $a1, $zero, 1
    func_001189b8();  // 0x118730                                // 0x001bd544: jal 0x118730
    if (v0 >= 0) goto label_0x1bd568;                           // 0x001bd54c: bgez $v0, 0x1bd568
    func_001bd3d0();  // 0x1bd340                                // 0x001bd558: jal 0x1bd340
    goto label_0x1bd5b8;                                        // 0x001bd560: b 0x1bd5b8
label_0x1bd568:
    func_00118d70();  // 0x118b38                                // 0x001bd570: jal 0x118b38
    a2 = 2;                                                     // 0x001bd574: addiu $a2, $zero, 2
    func_00118d70();  // 0x118b38                                // 0x001bd584: jal 0x118b38
    a1 = *(int32_t*)((s0) + 0x3c);                              // 0x001bd58c: lw $a1, 0x3c($s0)
    func_00118fd0();  // 0x118d70                                // 0x001bd594: jal 0x118d70
    func_00118b38();  // 0x1189b8                                // 0x001bd59c: jal 0x1189b8
