void func_00180270() {
    ...
    func_00180560();  // 0x180340                                // 0x00180288: jal 0x180340
    ...
    /* nop */                                                   // 0x001802ac: nop 
    func_00180630();  // 0x1805d8                                // 0x001802b0: jal 0x1805d8
    if (v0 < 0) goto label_0x180328;                            // 0x001802b8: bltz $v0, 0x180328
    v0 = -1;                                                    // 0x001802bc: addiu $v0, $zero, -1
label_0x1802c0:
    func_00180700();  // 0x180698                                // 0x001802c0: jal 0x180698
    ...
    func_00107b68();  // 0x107ab8                                // 0x001802ec: jal 0x107ab8
    ...
    func_00180848();  // 0x180760                                // 0x00180310: jal 0x180760
