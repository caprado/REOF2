void func_001d7470() {
    ...
    *(uint8_t*)(s1) = v0;                                       // 0x001d7540: sb $v0, 0($s1)
    ...
    func_001b2780();  // 1b2780                                // 0x001d7548: jal 0x1b2780
    ...
    *(uint32_t*)((s2) + 0x808) = v0;                            // 0x001d7550: sw $v0, 0x808($s2)
    ...
    func_001d4f30();  // 1d4f30                                // 0x001d7564: jal 0x1d4f30
