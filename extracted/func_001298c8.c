void func_001298c8() {
    ...
    func_00127d90();  // 127d90                                // 0x001298e0: jal 0x127d90
...
label_0x1298f0:
    ...
    /* nop */                                                   // 0x00129904: nop 
    func_00130ca8();  // 130ca8                                // 0x00129908: jal 0x130ca8
    a0 = *(int32_t*)((s0) + 4);                                 // 0x0012990c: lw $a0, 4($s0)
    func_00130278();  // 130278                                // 0x00129910: jal 0x130278
...
label_0x129924:
    func_00130b00();  // 130b00                                // 0x00129924: jal 0x130b00
