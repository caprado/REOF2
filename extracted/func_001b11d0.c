...
label_0x1b11f8:
    ...
    /* nop */                                                   // 0x001b1228: nop 
    func_0018c490();  // 0x18c350                                // 0x001b122c: jal 0x18c350
    /* nop */                                                   // 0x001b1230: nop 
    v0 = *(int32_t*)((s2) + 0x808);                             // 0x001b1234: lw $v0, 0x808($s2)
    v0 = v0 + s0;                                               // 0x001b1238: addu $v0, $v0, $s0
    func_001b0df0();  // 0x1b0db0                                // 0x001b123c: jal 0x1b0db0
...
label_0x1b1254:
    ...
    func_001b1870();  // 0x1b17c0                                // 0x001b1264: jal 0x1b17c0
    /* nop */                                                   // 0x001b1268: nop 
    a0 = *(int32_t*)((s2) + 0x80c);                             // 0x001b126c: lw $a0, 0x80c($s2)
    if (a0 == 0) goto label_0x1b128c;                           // 0x001b1270: beqz $a0, 0x1b128c
    /* nop */                                                   // 0x001b1274: nop 
    func_00192350();  // 0x192330                                // 0x001b1278: jal 0x192330
    /* nop */                                                   // 0x001b127c: nop 
    func_001b0ec0();  // 0x1b0e80                                // 0x001b1280: jal 0x1b0e80
