void func_001aeb00() {
    ...
    func_001a9030();  // 0x1a8fc0                                // 0x001aeb0c: jal 0x1a8fc0
    ...
    func_001d64a0();  // 0x1d6440                                // 0x001aeb24: jal 0x1d6440
    /* nop */                                                   // 0x001aeb28: nop 
label_0x1aeb2c:
    func_001d34a0();  // 0x1d3430                                // 0x001aeb2c: jal 0x1d3430
    /* nop */                                                   // 0x001aeb30: nop 
    func_001b16a0();  // 0x1b1620                                // 0x001aeb34: jal 0x1b1620
    /* nop */                                                   // 0x001aeb38: nop 
    func_001b1e30();  // 0x1b1df0                                // 0x001aeb3c: jal 0x1b1df0
    /* nop */                                                   // 0x001aeb40: nop 
    func_001b1700();  // 0x1b16a0                                // 0x001aeb44: jal 0x1b16a0
    /* nop */                                                   // 0x001aeb48: nop 
    a0 = 2;                                                     // 0x001aeb4c: addiu $a0, $zero, 2
    func_001a9030();  // 0x1a8fc0                                // 0x001aeb50: jal 0x1a8fc0
    if (v0 == 0) goto label_0x1aeb68;                           // 0x001aeb58: beqz $v0, 0x1aeb68
    /* nop */                                                   // 0x001aeb5c: nop 
    func_005be900();  // 0x5be900                               // 0x001aeb60: jal 0x5be900
    /* nop */                                                   // 0x001aeb64: nop 
label_0x1aeb68:
    func_001aebe0();  // 0x1aeb80                                // 0x001aeb68: jal 0x1aeb80
    /* nop */                                                   // 0x001aeb6c: nop 
