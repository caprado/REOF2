void func_00162e60() {
    ...
    func_001630e0();  // 1630e0                                // 0x00162e90: jal 0x1630e0
    /* beqzl $v0, 0x162f60 */                                   // 0x00162e98: beqzl $v0, 0x162f60
    func_001629e0();  // 1629e0                                // 0x00162ea0: jal 0x1629e0
    /* nop */                                                   // 0x00162ea4: nop 
    ...
    *(uint32_t*)((s2) + 0x10) = s4;                             // 0x00162ebc: sw $s4, 0x10($s2)
    func_00162aa8();  // 162aa8                                // 0x00162ec0: jal 0x162aa8
    ...
    func_0013f568();  // 13f568                                // 0x00162ee4: jal 0x13f568
...
label_0x162f08:
    *(uint32_t*)((s2) + 0xc) = s1;                              // 0x00162f08: sw $s1, 0xc($s2)
    func_00162b10();  // 162b10                                // 0x00162f0c: jal 0x162b10
