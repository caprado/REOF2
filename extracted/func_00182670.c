void func_00182670() {
    ...
    func_0010af38();  // 0x10ae00                                // 0x00182694: jal 0x10ae00
...
label_0x1826b0:
    ...
    func_0010ae00();  // 0x10ac68                                // 0x001826c0: jal 0x10ac68
    ...
    *(uint8_t*)((s1) + 1) = v1;                                 // 0x001826ec: sb $v1, 1($s1)
    func_00182628();  // 0x182508                                // 0x001826f0: jal 0x182508
    a1 = s2 + -0x6088;                                          // 0x001826f4: addiu $a1, $s2, -0x6088
    goto label_0x182710;                                        // 0x001826f8: b 0x182710
label_0x182700:
    func_00182628();  // 0x182508                                // 0x00182704: jal 0x182508
...
label_0x182710:
    ...
    /* nop */                                                   // 0x0018271c: nop 
label_0x182720:
    func_0010ac68();  // 0x10ab20                                // 0x00182720: jal 0x10ab20
...
label_0x18273c:
    func_0010ac68();  // 0x10ab20                                // 0x00182740: jal 0x10ab20
    ...
    func_0010af38();  // 0x10ae00                                // 0x00182750: jal 0x10ae00
    v0 = v0 + s1;                                               // 0x00182758: addu $v0, $v0, $s1
    *(uint8_t*)((v0) + -1) = 0;                                 // 0x00182760: sb $zero, -1($v0)
    func_0010b4b0();  // 0x10b460                                // 0x00182764: jal 0x10b460
...
label_0x182780:
    func_0010a990();  // 0x10a860                                // 0x00182780: jal 0x10a860
    s0 = s2 + -0x6088;                                          // 0x00182788: addiu $s0, $s2, -0x6088
    func_0010a990();  // 0x10a860                                // 0x00182790: jal 0x10a860
label_0x1827a0:
    func_00182628();  // 0x182508                                // 0x001827a0: jal 0x182508
    /* nop */                                                   // 0x001827a4: nop 
    if (s0 != 0) goto label_0x182720;                           // 0x001827ac: bnez $s0, 0x182720
label_0x1827b4:
    a1 = s2 + -0x6088;                                          // 0x001827b4: addiu $a1, $s2, -0x6088
    func_0010ac68();  // 0x10ab20                                // 0x001827b8: jal 0x10ab20
    if (v0 == 0) goto label_0x1827d4;                           // 0x001827c0: beqz $v0, 0x1827d4
    func_0010b4b0();  // 0x10b460                                // 0x001827c8: jal 0x10b460
