void func_00150b90() {
    ...
    func_00111f90();  // 111f90                                // 0x00150bc0: jal 0x111f90
    ...
    func_00111998();  // 111998                                // 0x00150bdc: jal 0x111998
    s0 = *(int32_t*)((s2) + 0x2c8);                             // 0x00150be8: lw $s0, 0x2c8($s2)
label_0x150bec:
    func_00111f90();  // 111f90                                // 0x00150bec: jal 0x111f90
    if (s0 >= 0) goto label_0x150c0c;                           // 0x00150bf4: bgez $s0, 0x150c0c
    /* nop */                                                   // 0x00150bf8: nop 
    a1 = 0 | 0x83e0;                                            // 0x00150bfc: ori $a1, $zero, 0x83e0
    func_00111998();  // 111998                                // 0x00150c04: jal 0x111998
label_0x150c0c:
    func_00111ce0();  // 111ce0                                // 0x00150c10: jal 0x111ce0
...
label_0x150c30:
    ...
    func_00111f90();  // 111f90                                // 0x00150c58: jal 0x111f90
    if (s0 >= 0) goto label_0x150c78;                           // 0x00150c60: bgez $s0, 0x150c78
    /* nop */                                                   // 0x00150c64: nop 
    a1 = 0 | 0x83e0;                                            // 0x00150c68: ori $a1, $zero, 0x83e0
    func_00111998();  // 111998                                // 0x00150c70: jal 0x111998
label_0x150c78:
    func_00111a58();  // 111a58                                // 0x00150c7c: jal 0x111a58
    func_00111f90();  // 111f90                                // 0x00150c88: jal 0x111f90
    if (s1 >= 0) goto label_0x150ca8;                           // 0x00150c90: bgez $s1, 0x150ca8
    /* nop */                                                   // 0x00150c94: nop 
    a1 = 0 | 0x83e0;                                            // 0x00150c98: ori $a1, $zero, 0x83e0
    func_00111998();  // 111998                                // 0x00150ca0: jal 0x111998
label_0x150ca8:
    goto label_0x150d08;                                        // 0x00150ca8: b 0x150d08
    func_00111f90();  // 111f90                                // 0x00150cb0: jal 0x111f90
    if (s0 >= 0) goto label_0x150cd0;                           // 0x00150cb8: bgez $s0, 0x150cd0
    /* nop */                                                   // 0x00150cbc: nop 
    a1 = 0 | 0x83e0;                                            // 0x00150cc0: ori $a1, $zero, 0x83e0
    func_00111998();  // 111998                                // 0x00150cc8: jal 0x111998
label_0x150cd0:
    func_00111a58();  // 111a58                                // 0x00150cd4: jal 0x111a58
    s0 = *(int32_t*)((s2) + 0x2c8);                             // 0x00150cdc: lw $s0, 0x2c8($s2)
    func_00111f90();  // 111f90                                // 0x00150ce4: jal 0x111f90
    if (s0 >= 0) goto label_0x150d04;                           // 0x00150cec: bgez $s0, 0x150d04
    /* nop */                                                   // 0x00150cf0: nop 
    a1 = 0 | 0x83e0;                                            // 0x00150cf4: ori $a1, $zero, 0x83e0
    func_00111998();  // 111998                                // 0x00150cfc: jal 0x111998
label_0x150d04:
label_0x150d08:
    func_00111ce0();  // 111ce0                                // 0x00150d08: jal 0x111ce0
label_0x150d18:
