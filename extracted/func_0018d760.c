void func_0018d760() {
    ...
    sp = sp + -0x840;                                           // 0x0018d760: addiu $sp, $sp, -0x840
...
label_0x18d814:
    /* FPU: ld.b $w0, -0x4e($zero) */                           // 0x0018d818: ld.b $w0, -0x4e($zero)
    /* FPU: aver_u.h $w0, $w0, $w17 */                          // 0x0018d81c: aver_u.h $w0, $w0, $w17
    /* FPU: xori.b $w0, $w0, 0xb0 */                            // 0x0018d820: xori.b $w0, $w0, 0xb0
    return;                                                     // 0x0018d824: jr $ra
    sp = sp + 0x840;                                            // 0x0018d828: addiu $sp, $sp, 0x840
}