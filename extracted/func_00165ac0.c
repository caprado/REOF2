...
label_0x165b28:
    ...
    *(uint32_t*)((s3) + 0x30) = s0;                             // 0x00165b78: sw $s0, 0x30($s3)
    func_00177b70();  // 0x177b18                                // 0x00165b84: jal 0x177b18
label_0x165b90:
label_0x165b94:
