void func_0013e380() {
    ...
    func_0011b6f8();  // 0x11b6d8                                // 0x0013e3b8: jal 0x11b6d8
    ...
    func_00138e38();  // 0x138dd0                                // 0x0013e3cc: jal 0x138dd0
    s0 = s0 + 0x7a74;                                           // 0x0013e3d0: addiu $s0, $s0, 0x7a74
    g_0020a480 = 0;  // Global at 0x0020a480                    // 0x0013e3d4: sw $zero, 0($s1)
    func_0011b6f8();  // 0x11b6d8                                // 0x0013e3d8: jal 0x11b6d8
    a0 = g_00207a74;  // Global at 0x00207a74                   // 0x0013e3dc: lw $a0, 0($s0)
    func_0013dbe0();  // 0x13db00                                // 0x0013e3e0: jal 0x13db00
    g_00207a74 = 0;  // Global at 0x00207a74                    // 0x0013e3e4: sw $zero, 0($s0)
    func_0013e2a8();  // 0x13e280                                // 0x0013e3e8: jal 0x13e280
    /* nop */                                                   // 0x0013e3ec: nop 
    func_00139120();  // 0x1390a8                                // 0x0013e3f0: jal 0x1390a8
    /* nop */                                                   // 0x0013e3f4: nop 
    func_00141150();  // 0x1410d8                                // 0x0013e3f8: jal 0x1410d8
    /* nop */                                                   // 0x0013e3fc: nop 
