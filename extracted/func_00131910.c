void func_00131910() {
    ...
    func_00130ad8();  // 130ad8                                // 0x00131950: jal 0x130ad8
    a2 = a2 << 0xb;                                             // 0x00131954: sll $a2, $a2, 0xb
    a0 = *(int32_t*)((s0) + 8);                                 // 0x00131958: lw $a0, 8($s0)
    func_00130468();  // 130468                                // 0x0013195c: jal 0x130468
    a1 = 0x19;                                                  // 0x00131960: addiu $a1, $zero, 0x19
    a0 = *(int32_t*)((s0) + 8);                                 // 0x00131964: lw $a0, 8($s0)
    func_00130458();  // 130458                                // 0x0013196c: jal 0x130458
    a0 = *(int32_t*)((s0) + 8);                                 // 0x00131974: lw $a0, 8($s0)
    func_00130280();  // 130280                                // 0x00131978: jal 0x130280
    func_001303a0();  // 1303a0                                // 0x00131980: jal 0x1303a0
    a0 = *(int32_t*)((s0) + 8);                                 // 0x00131984: lw $a0, 8($s0)
    func_001301e0();  // 1301e0                                // 0x00131988: jal 0x1301e0
    a0 = *(int32_t*)((s0) + 8);                                 // 0x0013198c: lw $a0, 8($s0)
    a0 = *(int32_t*)((s0) + 8);                                 // 0x00131990: lw $a0, 8($s0)
    func_00130138();  // 130138                                // 0x001319a0: jal 0x130138
    func_00130318();  // 130318                                // 0x001319a8: jal 0x130318
...
label_0x131a18:
    func_00131af8();  // 131af8                                // 0x00131a18: jal 0x131af8
    /* nop */                                                   // 0x00131a1c: nop 
    func_001261a0();  // 1261a0                                // 0x00131a20: jal 0x1261a0
    /* nop */                                                   // 0x00131a24: nop 
    func_00131820();  // 131820                                // 0x00131a2c: jal 0x131820
...
label_0x131a58:
    ...
    func_001261a0();  // 1261a0                                // 0x00131a64: jal 0x1261a0
    a0 = *(int32_t*)((s0) + 0xc);                               // 0x00131a6c: lw $a0, 0xc($s0)
    func_0012c3a8();  // 12c3a8                                // 0x00131a70: jal 0x12c3a8
    a0 = *(int32_t*)((s0) + 0xc);                               // 0x00131a78: lw $a0, 0xc($s0)
    func_0012c3c0();  // 12c3c0                                // 0x00131a7c: jal 0x12c3c0
    a0 = *(int32_t*)((s0) + 0xc);                               // 0x00131a84: lw $a0, 0xc($s0)
    func_0013e918();  // 13e918                                // 0x00131a88: jal 0x13e918
...
label_0x131acc:
    ...
    *(uint8_t*)((s0) + 0xac) = 0;                               // 0x00131ad0: sb $zero, 0xac($s0)
    func_001227a8();  // 1227a8                                // 0x00131ad4: jal 0x1227a8
    /* nop */                                                   // 0x00131ad8: nop 
...
label_0x131b30:
    ...
    func_001301e0();  // 1301e0                                // 0x00131b64: jal 0x1301e0
    /* nop */                                                   // 0x00131b68: nop 
    ...
    func_0013cc38();  // 13cc38                                // 0x00131b7c: jal 0x13cc38
...
label_0x131ba4:
    ...
    func_00127d90();  // 127d90                                // 0x00131bc8: jal 0x127d90
