void func_001d7590() {
    ...
    func_001d3c30();  // 0x1d3c20                                // 0x001d75c8: jal 0x1d3c20
...
label_0x1d75d8:
    ...
    func_001d3c30();  // 0x1d3c20                                // 0x001d75e0: jal 0x1d3c20
    a0 = v0 + 0x1400;                                           // 0x001d75e4: addiu $a0, $v0, 0x1400
label_0x1d75e8:
    func_001d71b0();  // 0x1d7130                                // 0x001d75e8: jal 0x1d7130
    /* nop */                                                   // 0x001d75ec: nop 
...
label_0x1d7600:
    ...
    func_001b28a0();  // 0x1b2780                                // 0x001d7624: jal 0x1b2780
...
label_0x1d7658:
    ...
    func_001d5f80();  // 0x1d5f60                                // 0x001d766c: jal 0x1d5f60
    v1 = 1;                                                     // 0x001d7674: addiu $v1, $zero, 1
    if (s0 != v1) goto label_0x1d7688;                          // 0x001d7678: bne $s0, $v1, 0x1d7688
    func_001d7590();  // 0x1d7470                                // 0x001d7680: jal 0x1d7470
label_0x1d7688:
