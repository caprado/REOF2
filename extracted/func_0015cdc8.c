void func_0015cdc8() {
    ...
    func_00160820();  // 0x160818                                // 0x0015cde8: jal 0x160818
    a1 = *(int32_t*)((s1) + 0xc);                               // 0x0015cdec: lw $a1, 0xc($s1)
    func_0015d300();  // 0x15d260                                // 0x0015cdf8: jal 0x15d260
    ...
    *(uint32_t*)((s0) + 0xac) = v0;                             // 0x0015ce0c: sw $v0, 0xac($s0)
    func_001615a8();  // 0x161580                                // 0x0015ce14: jal 0x161580
    *(uint32_t*)((s0) + 0xb0) = s2;                             // 0x0015ce18: sw $s2, 0xb0($s0)
    ...
    func_0015d300();  // 0x15d260                                // 0x0015ce28: jal 0x15d260
...
label_0x15ce40:
    func_001634a8();  // 0x163410                                // 0x0015ce40: jal 0x163410
    /* nop */                                                   // 0x0015ce44: nop 
    func_0015d460();  // 0x15d400                                // 0x0015ce48: jal 0x15d400
