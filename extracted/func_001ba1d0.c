...
label_0x1ba1fc:
    func_0019f080();  // 19f080                                // 0x001ba1fc: jal 0x19f080
    a1 = 0x1c0;                                                 // 0x001ba200: addiu $a1, $zero, 0x1c0
    /* nop */                                                   // 0x001ba204: nop 
    /* nop */                                                   // 0x001ba208: nop 
    if (v0 == 0) goto label_0x1ba1f8;                           // 0x001ba20c: beqz $v0, 0x1ba1f8
    /* nop */                                                   // 0x001ba210: nop 
    func_001ba660();  // 1ba660                                // 0x001ba214: jal 0x1ba660
    /* nop */                                                   // 0x001ba218: nop 
    func_001ba960();  // 1ba960                                // 0x001ba21c: jal 0x1ba960
    /* nop */                                                   // 0x001ba220: nop 
    a0 = 0x1c << 16;                                            // 0x001ba224: lui $a0, 0x1c
    func_001b76c0();  // 1b76c0                                // 0x001ba22c: jal 0x1b76c0
...
label_0x1ba244:
    func_001ba2a0();  // 1ba2a0                                // 0x001ba244: jal 0x1ba2a0
    /* nop */                                                   // 0x001ba248: nop 
    ...
    *(uint16_t*)((gp) + -0x6338) = v1;                          // 0x001ba258: sh $v1, -0x6338($gp)
    func_001a8a50();  // 1a8a50                                // 0x001ba25c: jal 0x1a8a50
    *(uint16_t*)((gp) + -0x633c) = v0;                          // 0x001ba260: sh $v0, -0x633c($gp)
    func_00112118();  // 112118                                // 0x001ba264: jal 0x112118
    func_001aee10();  // 1aee10                                // 0x001ba26c: jal 0x1aee10
    *(float*)((gp) + -0x6388) = FPU_F0;  // Store float         // 0x001ba270: swc1 $f0, -0x6388($gp)
    if (v0 == 0) goto label_0x1ba284;                           // 0x001ba274: beqz $v0, 0x1ba284
    /* nop */                                                   // 0x001ba278: nop 
    func_001aed20();  // 1aed20                                // 0x001ba27c: jal 0x1aed20
    /* nop */                                                   // 0x001ba280: nop 
label_0x1ba284:
    func_001b74b0();  // 1b74b0                                // 0x001ba284: jal 0x1b74b0
    /* nop */                                                   // 0x001ba288: nop 
label_0x1ba28c:
label_0x1ba290:
