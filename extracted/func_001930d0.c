...
label_0x1930f0:
    ...
    *(float*)(sp) = FPU_F20;  // Store float                    // 0x0019311c: swc1 $f20, 0($sp)
    ...
    func_0018fc60();  // 0x18fc10                                // 0x00193140: jal 0x18fc10
    /* FPU: mov.s $f14, $f20 */                                 // 0x00193144: mov.s $f14, $f20
    func_0018fbd0();  // 0x18fba0                                // 0x00193148: jal 0x18fba0
    ...
    *(float*)((sp) + 0x84) = FPU_F0;  // Store float            // 0x00193184: swc1 $f0, 0x84($sp)
    ...
    func_001911e0();  // 0x191190                                // 0x0019318c: jal 0x191190
    *(float*)((sp) + 0x88) = FPU_F0;  // Store float            // 0x00193190: swc1 $f0, 0x88($sp)
    func_00191190();  // 0x1910b0                                // 0x00193198: jal 0x1910b0
    a1 = sp + 0x50;                                             // 0x0019319c: addiu $a1, $sp, 0x50
    func_00191190();  // 0x1910b0                                // 0x001931a4: jal 0x1910b0
    ...
    func_00193210();  // 0x1930f0                                // 0x001931c0: jal 0x1930f0
...
label_0x1931c8:
    ...
    func_00193210();  // 0x1930f0                                // 0x001931dc: jal 0x1930f0
