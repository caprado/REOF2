void func_00129ea8() {
    ...
    func_00126190();  // 126190                                // 0x00129ed0: jal 0x126190
    /* nop */                                                   // 0x00129ed4: nop 
    func_001261a0();  // 1261a0                                // 0x00129ed8: jal 0x1261a0
    /* nop */                                                   // 0x00129edc: nop 
    func_0013fce0();  // 13fce0                                // 0x00129ee0: jal 0x13fce0
    /* nop */                                                   // 0x00129ee4: nop 
    func_0013f4b8();  // 13f4b8                                // 0x00129ee8: jal 0x13f4b8
    /* nop */                                                   // 0x00129eec: nop 
    func_0013ef80();  // 13ef80                                // 0x00129ef0: jal 0x13ef80
    /* nop */                                                   // 0x00129ef4: nop 
    func_00127cf8();  // 127cf8                                // 0x00129ef8: jal 0x127cf8
    /* nop */                                                   // 0x00129efc: nop 
    func_0012fd88();  // 12fd88                                // 0x00129f00: jal 0x12fd88
    /* nop */                                                   // 0x00129f04: nop 
    func_0012c608();  // 12c608                                // 0x00129f08: jal 0x12c608
    /* nop */                                                   // 0x00129f0c: nop 
    func_00128008();  // 128008                                // 0x00129f10: jal 0x128008
    /* nop */                                                   // 0x00129f14: nop 
    func_0012c2f0();  // 12c2f0                                // 0x00129f18: jal 0x12c2f0
    /* nop */                                                   // 0x00129f1c: nop 
    func_0013d258();  // 13d258                                // 0x00129f20: jal 0x13d258
    /* nop */                                                   // 0x00129f24: nop 
    func_00141db8();  // 141db8                                // 0x00129f28: jal 0x141db8
    /* nop */                                                   // 0x00129f2c: nop 
    a0 = 0x13 << 16;                                            // 0x00129f30: lui $a0, 0x13
    func_0012c320();  // 12c320                                // 0x00129f38: jal 0x12c320
    a0 = a0 + -0x6240;                                          // 0x00129f3c: addiu $a0, $a0, -0x6240
    a0 = 0x13 << 16;                                            // 0x00129f40: lui $a0, 0x13
    a0 = a0 + -0x6228;                                          // 0x00129f44: addiu $a0, $a0, -0x6228
    func_0013d190();  // 13d190                                // 0x00129f48: jal 0x13d190
    a0 = 0x1f << 16;                                            // 0x00129f50: lui $a0, 0x1f
    a0 = a0 + 0x59c8;                                           // 0x00129f54: addiu $a0, $a0, 0x59c8
    func_00107c70();  // 107c70                                // 0x00129f5c: jal 0x107c70
    a2 = 0xc40;                                                 // 0x00129f60: addiu $a2, $zero, 0xc40
    func_0012b2d0();  // 12b2d0                                // 0x00129f64: jal 0x12b2d0
    /* nop */                                                   // 0x00129f68: nop 
    ...
    func_00141918();  // 141918                                // 0x00129fa4: jal 0x141918
    ...
    func_001417d0();  // 1417d0                                // 0x00129fb8: jal 0x1417d0
...
label_0x129fd8:
    func_001417d0();  // 1417d0                                // 0x00129fd8: jal 0x1417d0
    /* nop */                                                   // 0x00129fdc: nop 
    ...
    func_00132568();  // 132568                                // 0x00129ff4: jal 0x132568
    g_001f59c4 = 0;  // Global at 0x001f59c4                    // 0x00129ff8: sw $zero, 0($v0)
    func_001261b8();  // 1261b8                                // 0x00129ffc: jal 0x1261b8
    /* nop */                                                   // 0x0012a000: nop 
