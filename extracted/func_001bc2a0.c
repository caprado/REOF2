...
void func_001bc2a0() {
    ...
    /* nop */                                                   // 0x001bc2d4: nop 
    func_001b0720();  // 1b0720                                // 0x001bc2d8: jal 0x1b0720
    /* nop */                                                   // 0x001bc2dc: nop 
    ...
    *(uint8_t*)((s0) + 9) = v0;                                 // 0x001bc304: sb $v0, 9($s0)
    ...
    func_001af280();  // 1af280                                // 0x001bc30c: jal 0x1af280
...
label_0x1bc31c:
    ...
    *(uint8_t*)((s0) + 9) = v1;                                 // 0x001bc384: sb $v1, 9($s0)
    func_001bb9e0();  // 1bb9e0                                // 0x001bc388: jal 0x1bb9e0
...
label_0x1bc3b8:
    ...
    *(uint8_t*)((s0) + 9) = v1;                                 // 0x001bc3c8: sb $v1, 9($s0)
    ...
    func_001bb9e0();  // 1bb9e0                                // 0x001bc3e4: jal 0x1bb9e0
...
label_0x1bc414:
    ...
    *(uint8_t*)((s0) + 9) = v1;                                 // 0x001bc41c: sb $v1, 9($s0)
    func_001bc1a0();  // 1bc1a0                                // 0x001bc420: jal 0x1bc1a0
    /* nop */                                                   // 0x001bc424: nop 
...
label_0x1bc470:
    func_001bb9e0();  // 1bb9e0                                // 0x001bc470: jal 0x1bb9e0
    /* nop */                                                   // 0x001bc474: nop 
    ...
    *(uint8_t*)((s0) + 0xa) = v1;                               // 0x001bc48c: sb $v1, 0xa($s0)
    ...
    func_001bb9e0();  // 1bb9e0                                // 0x001bc4ac: jal 0x1bb9e0
    /* nop */                                                   // 0x001bc4b0: nop 
...
label_0x1bc4bc:
    ...
    *(uint8_t*)((s0) + 9) = v1;                                 // 0x001bc4cc: sb $v1, 9($s0)
    func_001bb9e0();  // 1bb9e0                                // 0x001bc4d0: jal 0x1bb9e0
    ...
    *(uint8_t*)((s0) + 0xa) = v1;                               // 0x001bc4f0: sb $v1, 0xa($s0)
    ...
    func_001bb9e0();  // 1bb9e0                                // 0x001bc510: jal 0x1bb9e0
    /* nop */                                                   // 0x001bc514: nop 
...
label_0x1bc520:
    ...
    *(uint8_t*)((s0) + 9) = v1;                                 // 0x001bc530: sb $v1, 9($s0)
    func_001bb9e0();  // 1bb9e0                                // 0x001bc534: jal 0x1bb9e0
    ...
    *(uint8_t*)((s0) + 0xa) = v1;                               // 0x001bc554: sb $v1, 0xa($s0)
    ...
    func_001bb9e0();  // 1bb9e0                                // 0x001bc574: jal 0x1bb9e0
    /* nop */                                                   // 0x001bc578: nop 
...
label_0x1bc584:
    ...
    *(uint8_t*)((s0) + 9) = v1;                                 // 0x001bc590: sb $v1, 9($s0)
    ...
    func_001bc1b0();  // 1bc1b0                                // 0x001bc5a8: jal 0x1bc1b0
    /* nop */                                                   // 0x001bc5ac: nop 
...
label_0x1bc5b8:
    ...
    func_001ba3c0();  // 1ba3c0                                // 0x001bc5cc: jal 0x1ba3c0
    /* nop */                                                   // 0x001bc5d0: nop 
    func_001bbab0();  // 1bbab0                                // 0x001bc5d4: jal 0x1bbab0
    /* nop */                                                   // 0x001bc5d8: nop 
    func_001b7940();  // 1b7940                                // 0x001bc5dc: jal 0x1b7940
    /* nop */                                                   // 0x001bc5e0: nop 
    func_001b7790();  // 1b7790                                // 0x001bc5e4: jal 0x1b7790
    ...
    func_001b0ce0();  // 1b0ce0                                // 0x001bc600: jal 0x1b0ce0
    /* nop */                                                   // 0x001bc604: nop 
...
label_0x1bc690:
    ...
    /* nop */                                                   // 0x001bc6a0: nop 
    func_001bc1b0();  // 1bc1b0                                // 0x001bc6a4: jal 0x1bc1b0
    /* nop */                                                   // 0x001bc6a8: nop 
label_0x1bc6ac:
label_0x1bc6b0:
