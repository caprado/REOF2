void func_001bbed0() {
    ...
    *(uint8_t*)((a0) + 9) = 0;                                  // 0x001bbee4: sb $zero, 9($a0)
    func_001a8fc0();  // 0x1a8e70                                // 0x001bbee8: jal 0x1a8e70
    a1 = 0x1c << 16;                                            // 0x001bbef0: lui $a1, 0x1c
    func_001b78b0();  // 0x1b7890                                // 0x001bbef8: jal 0x1b7890
    a1 = a1 + -0x38c0;                                          // 0x001bbefc: addiu $a1, $a1, -0x38c0
    func_001befe0();  // 0x1bef00                                // 0x001bbf00: jal 0x1bef00
    /* nop */                                                   // 0x001bbf04: nop 
    v0 = 1;                                                     // 0x001bbf08: addiu $v0, $zero, 1
    func_001b3860();  // 0x1b3830                                // 0x001bbf0c: jal 0x1b3830
    *(uint8_t*)((gp) + -0x6350) = v0;                           // 0x001bbf10: sb $v0, -0x6350($gp)
    func_001dad60();  // 0x1dac50                                // 0x001bbf14: jal 0x1dac50
    /* nop */                                                   // 0x001bbf18: nop 
    a0 = 0x14;                                                  // 0x001bbf1c: addiu $a0, $zero, 0x14
    func_001aefe0();  // 0x1aefd0                                // 0x001bbf20: jal 0x1aefd0
