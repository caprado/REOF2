...
label_0x1b31e4:
    ...
    func_0010f580();  // 0x10f528                                // 0x001b31f4: jal 0x10f528
    a0 = a0 + -0x53c0;                                          // 0x001b31f8: addiu $a0, $a0, -0x53c0
    func_001b34f0();  // 0x1b3490                                // 0x001b31fc: jal 0x1b3490
    a0 = 8;                                                     // 0x001b3204: addiu $a0, $zero, 8
    func_001b3710();  // 0x1b36e0                                // 0x001b3208: jal 0x1b36e0
    a1 = 0xc;                                                   // 0x001b320c: addiu $a1, $zero, 0xc
    func_001b3490();  // 0x1b3460                                // 0x001b3214: jal 0x1b3460
    a0 = 0x2b << 16;                                            // 0x001b321c: lui $a0, 0x2b
    func_001b3580();  // 0x1b34f0                                // 0x001b3220: jal 0x1b34f0
    a0 = a0 + -0x53c0;                                          // 0x001b3224: addiu $a0, $a0, -0x53c0
    a0 = 8;                                                     // 0x001b3228: addiu $a0, $zero, 8
    func_001b3710();  // 0x1b36e0                                // 0x001b322c: jal 0x1b36e0
    func_001b34f0();  // 0x1b3490                                // 0x001b3234: jal 0x1b3490
