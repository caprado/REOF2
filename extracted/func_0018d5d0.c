void func_0018d5d0() {
    ...
    func_0011c438();  // 11c438                                // 0x0018d600: jal 0x11c438
    /* nop */                                                   // 0x0018d604: nop 
    if (v0 >= 0) goto label_0x18d660;                           // 0x0018d608: bgez $v0, 0x18d660
    a0 = 0x23 << 16;                                            // 0x0018d60c: lui $a0, 0x23
    func_00108ed8();  // 108ed8                                // 0x0018d614: jal 0x108ed8
...
label_0x18d62c:
    func_0011c438();  // 11c438                                // 0x0018d630: jal 0x11c438
...
label_0x18d644:
    ...
    func_00108ed8();  // 108ed8                                // 0x0018d658: jal 0x108ed8
