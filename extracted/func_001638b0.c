void func_001638b0() {
    ...
    func_001634a8();  // 0x163410                                // 0x001638f8: jal 0x163410
    /* nop */                                                   // 0x001638fc: nop 
label_0x163900:
    *(uint8_t*)((s0) + 0x71) = 0;                               // 0x00163900: sb $zero, 0x71($s0)
label_0x163904:
    func_00174ff8();  // 0x174fb8                                // 0x00163904: jal 0x174fb8
