...
label_0x1655d0:
    func_001698d0();  // 1698d0                                // 0x001655d0: jal 0x1698d0
    /* nop */                                                   // 0x001655d4: nop 
...
label_0x1655e0:
    ...
    *(uint32_t*)((a3) + 0x38) = 0;                              // 0x0016565c: sw $zero, 0x38($a3)
    func_001752e8();  // 1752e8                                // 0x00165660: jal 0x1752e8
    *(uint32_t*)((a3) + 0x40) = 0;                              // 0x00165664: sw $zero, 0x40($a3)
    a1 = 0x40;                                                  // 0x0016566c: addiu $a1, $zero, 0x40
    func_001752e8();  // 1752e8                                // 0x00165674: jal 0x1752e8
    a1 = 0x41;                                                  // 0x00165680: addiu $a1, $zero, 0x41
    func_001752e8();  // 1752e8                                // 0x00165688: jal 0x1752e8
    a1 = 0x42;                                                  // 0x00165690: addiu $a1, $zero, 0x42
    func_001752e8();  // 1752e8                                // 0x0016569c: jal 0x1752e8
    func_00177970();  // 177970                                // 0x001656ac: jal 0x177970
    func_001752e8();  // 1752e8                                // 0x001656b8: jal 0x1752e8
    a1 = 0x48;                                                  // 0x001656bc: addiu $a1, $zero, 0x48
    func_00177a90();  // 177a90                                // 0x001656c4: jal 0x177a90
    func_00177a98();  // 177a98                                // 0x001656d0: jal 0x177a98
    func_00177ab0();  // 177ab0                                // 0x001656dc: jal 0x177ab0
    a1 = sp + 0x10;                                             // 0x001656e0: addiu $a1, $sp, 0x10
    func_00177ac8();  // 177ac8                                // 0x001656e8: jal 0x177ac8
    a1 = sp + 0x20;                                             // 0x001656ec: addiu $a1, $sp, 0x20
    func_00177ae0();  // 177ae0                                // 0x001656f4: jal 0x177ae0
    a1 = sp + 0x30;                                             // 0x001656f8: addiu $a1, $sp, 0x30
    func_001752e8();  // 1752e8                                // 0x00165700: jal 0x1752e8
    a1 = 0x3e;                                                  // 0x00165704: addiu $a1, $zero, 0x3e
    func_00177af8();  // 177af8                                // 0x0016570c: jal 0x177af8
    func_001752e8();  // 1752e8                                // 0x00165718: jal 0x1752e8
    a1 = 0x3d;                                                  // 0x0016571c: addiu $a1, $zero, 0x3d
    func_0017e438();  // 17e438                                // 0x00165720: jal 0x17e438
label_0x165730:
