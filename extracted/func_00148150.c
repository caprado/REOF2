...
label_0x1481ac:
    func_001465c8();  // 0x146310                                // 0x001481ac: jal 0x146310
    ...
    func_00146280();  // 0x1461b0                                // 0x001481c4: jal 0x1461b0
    ...
    func_00145a20();  // 0x145900                                // 0x001481e0: jal 0x145900
    *(uint32_t*)((s0) + 0x138) = s1;                            // 0x001481e4: sw $s1, 0x138($s0)
    ...
    func_00148330();  // 0x1482c8                                // 0x001481f0: jal 0x1482c8
    *(uint32_t*)(s0) = s1;                                      // 0x001481f8: sw $s1, 0($s0)
    ...
    func_001465c8();  // 0x146310                                // 0x00148220: jal 0x146310
    ...
    func_00146280();  // 0x1461b0                                // 0x00148240: jal 0x1461b0
...
label_0x14824c:
    ...
    func_00146310();  // 0x146280                                // 0x00148260: jal 0x146280
    ...
    *(uint32_t*)((s0) + 4) = v0;                                // 0x00148294: sw $v0, 4($s0)
    func_00147d70();  // 0x147ca0                                // 0x00148298: jal 0x147ca0
label_0x1482a0:
label_0x1482a4:
