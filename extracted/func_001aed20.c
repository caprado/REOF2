void func_001aed20() {
    ...
    *(uint16_t*)((gp) + -0x634c) = 0;                           // 0x001aed2c: sh $zero, -0x634c($gp)
    func_001adbe0();  // 1adbe0                                // 0x001aed30: jal 0x1adbe0
    /* nop */                                                   // 0x001aed34: nop 
    func_001ac990();  // 1ac990                                // 0x001aed38: jal 0x1ac990
    /* nop */                                                   // 0x001aed3c: nop 
    func_001ba2a0();  // 1ba2a0                                // 0x001aed40: jal 0x1ba2a0
    a0 = 3;                                                     // 0x001aed44: addiu $a0, $zero, 3
    func_001ba060();  // 1ba060                                // 0x001aed48: jal 0x1ba060
    /* nop */                                                   // 0x001aed4c: nop 
    func_001b77f0();  // 1b77f0                                // 0x001aed50: jal 0x1b77f0
    /* nop */                                                   // 0x001aed54: nop 
    a0 = 2;                                                     // 0x001aed58: addiu $a0, $zero, 2
    func_001a8fc0();  // 1a8fc0                                // 0x001aed5c: jal 0x1a8fc0
    ...
    /* nop */                                                   // 0x001aed88: nop 
label_0x1aed8c:
    func_001aece0();  // 1aece0                                // 0x001aed8c: jal 0x1aece0
    /* nop */                                                   // 0x001aed90: nop 
    func_001aeb00();  // 1aeb00                                // 0x001aed94: jal 0x1aeb00
    /* nop */                                                   // 0x001aed98: nop 
label_0x1aed9c:
    a0 = 3;                                                     // 0x001aed9c: addiu $a0, $zero, 3
label_0x1aeda0:
    func_001a8fc0();  // 1a8fc0                                // 0x001aeda0: jal 0x1a8fc0
    if (v0 == 0) goto label_0x1aedb8;                           // 0x001aeda8: beqz $v0, 0x1aedb8
    /* nop */                                                   // 0x001aedac: nop 
    func_001aeb00();  // 1aeb00                                // 0x001aedb0: jal 0x1aeb00
    /* nop */                                                   // 0x001aedb4: nop 
label_0x1aedb8:
    func_001aeb80();  // 1aeb80                                // 0x001aedb8: jal 0x1aeb80
    /* nop */                                                   // 0x001aedbc: nop 
    func_001a9b20();  // 1a9b20                                // 0x001aedc0: jal 0x1a9b20
    *(uint16_t*)((gp) + -0x6348) = 0;                           // 0x001aedc4: sh $zero, -0x6348($gp)
    func_001b7aa0();  // 1b7aa0                                // 0x001aedc8: jal 0x1b7aa0
    /* nop */                                                   // 0x001aedcc: nop 
    func_001bc6d0();  // 1bc6d0                                // 0x001aedd0: jal 0x1bc6d0
    /* nop */                                                   // 0x001aedd4: nop 
    func_001b7940();  // 1b7940                                // 0x001aedd8: jal 0x1b7940
    /* nop */                                                   // 0x001aeddc: nop 
