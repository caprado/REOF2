...
label_0x128588:
    func_00127d90();  // 127d90                                // 0x00128588: jal 0x127d90
    /* nop */                                                   // 0x0012858c: nop 
    goto label_0x1286f4;                                        // 0x00128590: b 0x1286f4
    v0 = -3;                                                    // 0x00128594: addiu $v0, $zero, -3
label_0x128598:
    func_00128298();  // 128298                                // 0x00128598: jal 0x128298
...
label_0x1285c8:
    ...
    func_00107c70();  // 107c70                                // 0x001285dc: jal 0x107c70
    ...
    *(uint32_t*)(s1) = 0;                                       // 0x001285f8: sw $zero, 0($s1)
    func_00128f00();  // 128f00                                // 0x00128600: jal 0x128f00
    ...
    func_00129ad8();  // 129ad8                                // 0x00128628: jal 0x129ad8
...
label_0x128648:
    ...
    func_00128d88();  // 128d88                                // 0x00128650: jal 0x128d88
...
label_0x128688:
    ...
    *(uint32_t*)((s1) + 0x110) = a0;                            // 0x001286b8: sw $a0, 0x110($s1)
    ...
    func_00129460();  // 129460                                // 0x001286c8: jal 0x129460
    ...
    *(uint32_t*)((s1) + 8) = 0;                                 // 0x001286d8: sw $zero, 8($s1)
    func_00129010();  // 129010                                // 0x001286dc: jal 0x129010
