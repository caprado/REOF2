void func_00133ca0() {
    ...
    /* nop */                                                   // 0x00133ce8: nop 
    func_00130280();  // 0x130278                                // 0x00133cec: jal 0x130278
...
label_0x133d38:
    ...
    func_00127fe8();  // 0x127f60                                // 0x00133d6c: jal 0x127f60
    ...
    func_00127e58();  // 0x127de8                                // 0x00133d7c: jal 0x127de8
    func_00131bb8();  // 0x131af8                                // 0x00133d84: jal 0x131af8
    goto label_0x13405c;                                        // 0x00133d8c: b 0x13405c
    /* nop */                                                   // 0x00133d94: nop 
label_0x133d98:
    func_0012d468();  // 0x12d450                                // 0x00133d98: jal 0x12d450
    func_0012d510();  // 0x12d4f8                                // 0x00133da4: jal 0x12d4f8
...
label_0x133e08:
    func_0012d4b0();  // 0x12d498                                // 0x00133e08: jal 0x12d498
    ...
    /* mflo $a1 */                                              // 0x00133e2c
    func_0012c910();  // 0x12c8d0                                // 0x00133e34: jal 0x12c8d0
    ...
    *(uint32_t*)((s1) + 0x50) = 0;                              // 0x00133e58: sw $zero, 0x50($s1)
    /* nop */                                                   // 0x00133e5c: nop 
label_0x133e60:
    func_0012d5a0();  // 0x12d588                                // 0x00133e60: jal 0x12d588
    ...
    *(uint32_t*)((s1) + 0x50) = a0;                             // 0x00133e98: sw $a0, 0x50($s1)
    ...
    func_001304a8();  // 0x130468                                // 0x00133ea0: jal 0x130468
    *(uint32_t*)((s1) + 0x8c) = v0;                             // 0x00133ea4: sw $v0, 0x8c($s1)
    ...
    func_00130468();  // 0x130458                                // 0x00133eb4: jal 0x130458
label_0x133ebc:
    func_0012d588();  // 0x12d570                                // 0x00133ebc: jal 0x12d570
    func_0012d540();  // 0x12d528                                // 0x00133ec4: jal 0x12d528
    *(uint32_t*)((s1) + 0x90) = v0;                             // 0x00133ed0: sw $v0, 0x90($s1)
    func_0012d418();  // 0x12d408                                // 0x00133ed4: jal 0x12d408
    func_0012d438();  // 0x12d428                                // 0x00133ee0: jal 0x12d428
    func_0012d428();  // 0x12d418                                // 0x00133eec: jal 0x12d418
    a1 = 0x13 << 16;                                            // 0x00133ef4: lui $a1, 0x13
    a1 = a1 + 0x3530;                                           // 0x00133ef8: addiu $a1, $a1, 0x3530
    func_0012d408();  // 0x12d3f8                                // 0x00133f00: jal 0x12d3f8
...
label_0x133f10:
    ...
    func_001304a8();  // 0x130468                                // 0x00133f1c: jal 0x130468
    a1 = a1 | 0xffff;                                           // 0x00133f20: ori $a1, $a1, 0xffff
label_0x133f24:
    func_0012d4e0();  // 0x12d4c8                                // 0x00133f24: jal 0x12d4c8
    func_0012d418();  // 0x12d408                                // 0x00133f30: jal 0x12d408
    func_0012d438();  // 0x12d428                                // 0x00133f3c: jal 0x12d428
    func_0012d428();  // 0x12d418                                // 0x00133f48: jal 0x12d418
    a1 = 0x13 << 16;                                            // 0x00133f50: lui $a1, 0x13
    a1 = a1 + 0x39d0;                                           // 0x00133f54: addiu $a1, $a1, 0x39d0
    func_0012d408();  // 0x12d3f8                                // 0x00133f5c: jal 0x12d3f8
label_0x133f64:
    func_0012d468();  // 0x12d450                                // 0x00133f64: jal 0x12d450
    func_0012d480();  // 0x12d468                                // 0x00133f70: jal 0x12d468
    func_0012d4e0();  // 0x12d4c8                                // 0x00133f7c: jal 0x12d4c8
    func_0012d498();  // 0x12d480                                // 0x00133f88: jal 0x12d480
    a0 = *(int32_t*)((s1) + 0xc);                               // 0x00133f90: lw $a0, 0xc($s1)
    func_0012c550();  // 0x12c4f0                                // 0x00133f94: jal 0x12c4f0
    a0 = *(int32_t*)((s1) + 0xc);                               // 0x00133f9c: lw $a0, 0xc($s1)
    func_0012c4b8();  // 0x12c4a0                                // 0x00133fa0: jal 0x12c4a0
    a0 = *(int32_t*)((s1) + 0xc);                               // 0x00133fa8: lw $a0, 0xc($s1)
    func_0012c4a0();  // 0x12c488                                // 0x00133fac: jal 0x12c488
    a0 = *(int32_t*)((s1) + 0xc);                               // 0x00133fb4: lw $a0, 0xc($s1)
    func_0012c5b8();  // 0x12c598                                // 0x00133fb8: jal 0x12c598
    func_0012d610();  // 0x12d5b8                                // 0x00133fc0: jal 0x12d5b8
    ...
    func_0012c4d0();  // 0x12c4b8                                // 0x00133fd0: jal 0x12c4b8
    a1 = a1 + v0;                                               // 0x00133fd4: addu $a1, $a1, $v0
    a1 = sp + 0x20;                                             // 0x00133fdc: addiu $a1, $sp, 0x20
    func_00132cb8();  // 0x132ca8                                // 0x00133fe0: jal 0x132ca8
    ...
    /* nop */                                                   // 0x00133ff8: nop 
label_0x133ffc:
    func_00132ca8();  // 0x132ca0                                // 0x00133ffc: jal 0x132ca0
label_0x134004:
    func_001339d0();  // 0x133808                                // 0x00134004: jal 0x133808
    a0 = *(int32_t*)((s1) + 0x74);                              // 0x0013400c: lw $a0, 0x74($s1)
    /* beqzl $a0, 0x134024 */                                   // 0x00134010: beqzl $a0, 0x134024
    func_00122b00();  // 0x122ad0                                // 0x00134018: jal 0x122ad0
    func_0012d450();  // 0x12d438                                // 0x00134024: jal 0x12d438
    ...
    func_0012d6f8();  // 0x12d6f0                                // 0x00134034: jal 0x12d6f0
    a0 = *(int32_t*)((s1) + 0xc);                               // 0x0013403c: lw $a0, 0xc($s1)
    func_0012c5d8();  // 0x12c5b8                                // 0x00134040: jal 0x12c5b8
    a0 = *(int32_t*)((s1) + 0xc);                               // 0x00134048: lw $a0, 0xc($s1)
label_0x13404c:
    func_0012c3c0();  // 0x12c3a8                                // 0x0013404c: jal 0x12c3a8
