void func_00180340() {
    ...
    /* nop */                                                   // 0x00180374: nop 
    func_001805d8();  // 1805d8                                // 0x00180378: jal 0x1805d8
    if (v0 < 0) goto label_0x180468;                            // 0x00180380: bltz $v0, 0x180468
label_0x180388:
    func_00180700();  // 180700                                // 0x00180388: jal 0x180700
    ...
    func_001805d8();  // 1805d8                                // 0x001803b0: jal 0x1805d8
...
label_0x1803cc:
    ...
    func_001895d8();  // 1895d8                                // 0x00180430: jal 0x1895d8
...
label_0x180444:
    ...
    func_00180560();  // 180560                                // 0x00180454: jal 0x180560
