...
label_0x1d5f6c:
    ...
    func_001d4140();  // 1d4140                                // 0x001d5fdc: jal 0x1d4140
    ...
    func_0010b460();  // 10b460                                // 0x001d6000: jal 0x10b460
...
label_0x1d6028:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001d6044: jal 0x10a4d8
...
label_0x1d6054:
    ...
    func_0010a4d8();  // 10a4d8                                // 0x001d605c: jal 0x10a4d8
...
label_0x1d6074:
    func_001aa830();  // 1aa830                                // 0x001d6088: jal 0x1aa830
...
label_0x1d6098:
    ...
    /* nop */                                                   // 0x001d60b0: nop 
label_0x1d60b4:
    func_0010ac68();  // 10ac68                                // 0x001d60b4: jal 0x10ac68
    ...
    func_0010a860();  // 10a860                                // 0x001d60cc: jal 0x10a860
...
label_0x1d60dc:
    ...
    func_0010a860();  // 10a860                                // 0x001d60e0: jal 0x10a860
...
label_0x1d60ec:
    ...
    func_001d3390();  // 1d3390                                // 0x001d60f8: jal 0x1d3390
    if (v0 <= 0) goto label_0x1d612c;                           // 0x001d6100: blez $v0, 0x1d612c
    func_001d9490();  // 1d9490                                // 0x001d610c: jal 0x1d9490
    func_001b29e0();  // 1b29e0                                // 0x001d6114: jal 0x1b29e0
    a2 = s7 & 0xff;                                             // 0x001d611c: andi $a2, $s7, 0xff
    func_001d96b0();  // 1d96b0                                // 0x001d6124: jal 0x1d96b0
label_0x1d612c:
    ...
    func_001d3390();  // 1d3390                                // 0x001d6164: jal 0x1d3390
    if (v0 <= 0) goto label_0x1d6184;                           // 0x001d616c: blez $v0, 0x1d6184
    func_001d4c80();  // 1d4c80                                // 0x001d617c: jal 0x1d4c80
