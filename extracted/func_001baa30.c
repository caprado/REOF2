...
label_0x1baacc:
    ...
    func_0010ac68();  // 0x10ab20                                // 0x001baadc: jal 0x10ab20
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001baaf4: jal 0x10a4d8
...
label_0x1bab18:
    func_0010af38();  // 0x10ae00                                // 0x001bab18: jal 0x10ae00
    /* nop */                                                   // 0x001bab1c: nop 
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001bab38: jal 0x10a4d8
...
label_0x1bab48:
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001bab50: jal 0x10a4d8
    a2 = sp + 0xa0;                                             // 0x001bab54: addiu $a2, $sp, 0xa0
    a0 = sp + 0x20;                                             // 0x001bab58: addiu $a0, $sp, 0x20
label_0x1bab5c:
    func_0010c7c0();  // 0x10c4a0                                // 0x001bab5c: jal 0x10c4a0
    a1 = sp + 0xb8;                                             // 0x001bab60: addiu $a1, $sp, 0xb8
    func_0010ae00();  // 0x10ac68                                // 0x001bab68: jal 0x10ac68
    a0 = sp + 0x98;                                             // 0x001bab6c: addiu $a0, $sp, 0x98
    func_0010c7c0();  // 0x10c4a0                                // 0x001bab74: jal 0x10c4a0
    a1 = sp + 0xb8;                                             // 0x001bab78: addiu $a1, $sp, 0xb8
    func_0010ae00();  // 0x10ac68                                // 0x001bab80: jal 0x10ac68
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001bab94: jal 0x10a4d8
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001baba8: jal 0x10a4d8
    ...
    func_0010a570();  // 0x10a4d8                                // 0x001babd0: jal 0x10a4d8
