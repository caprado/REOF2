void func_001b96e0() {
    ...
    func_001b9010();  // 1b9010                                // 0x001b96fc: jal 0x1b9010
...
label_0x1b9780:
    ...
    *(uint16_t*)((s1) + 8) = v0;                                // 0x001b97a4: sh $v0, 8($s1)
    ...
    func_001b8c20();  // 1b8c20                                // 0x001b97c0: jal 0x1b8c20
    ...
    func_001ac590();  // 1ac590                                // 0x001b97e4: jal 0x1ac590
